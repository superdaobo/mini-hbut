...
const maxOld = process.env.NODE_MAX_OLD_SPACE_SIZE || '4096'
...
console.log(
  `[tauri-dev-lowmem] GOMAXPROCS=${process.env.GOMAXPROCS} UV_THREADPOOL_SIZE=${process.env.UV_THREADPOOL_SIZE}`
)
console.log(`[tauri-dev-lowmem] NODE_OPTIONS=${process.env.NODE_OPTIONS}`)
