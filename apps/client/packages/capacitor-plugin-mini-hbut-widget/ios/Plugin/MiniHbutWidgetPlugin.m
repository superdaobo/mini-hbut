...
CAP_PLUGIN(MiniHbutWidgetPlugin, "MiniHbutWidget",
    ...
    CAP_PLUGIN_METHOD(writeElectricity, CAPPluginReturnPromise);
    CAP_PLUGIN_METHOD(writeExam, CAPPluginReturnPromise);
    CAP_PLUGIN_METHOD(writeThemeColor, CAPPluginReturnPromise);
