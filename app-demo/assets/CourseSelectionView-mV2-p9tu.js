import { _ as _export_sfc, a as axiosInstance } from "./app-demo-B5kEWRyP.js";
import { T as TEmptyState } from "./TEmptyState-tL6XUZ4y.js";
import { M as resolveComponent, a as openBlock, c as createElementBlock, b as createBaseVNode, t as toDisplayString, F as Fragment, J as withDirectives, K as vModelText, p as createVNode, k as withCtx, g as renderList, d as createCommentVNode, j as createBlock, n as normalizeClass, w as withModifiers, O as vModelCheckbox, s as Teleport, e as createTextVNode, T as Transition, o as onMounted, l as onBeforeUnmount, r as ref, h as computed } from "./vue-core-C6WYunHF.js";
import "./runtime-bridge-Ds80RevU.js";
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [
    ...
    createBaseVNode("div", _hoisted_10, [
      $setup.centerMode === $setup.ENTRY_MODE_MENU ? (openBlock(), createElementBlock("div", _hoisted_11, [
        createBaseVNode("button", {
          type: "button",
      ...
      ])) : $setup.centerMode === $setup.ENTRY_MODE_SELECTION ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
        ...
        createBaseVNode("div", _hoisted_32, [
          ...
          $setup.tabs.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_34, [
            createVNode(_component_IOSSelect, {
              ...
              return openBlock(), createElementBlock("button", {
                ...
                createBaseVNode("div", _hoisted_49, [
                  ...
                  createBaseVNode("div", {
                    ...
                    }, toDisplayString($setup.selectingCourseId === course.id ? "提交中..." : "选课"), 9, _hoisted_52)) : (openBlock(), createElementBlock("button", {
                      key: 1,
                      class: "action-btn danger",
                      type: "button",
                      disabled: $setup.withdrawingCourseId === course.id,
                      onClick: ($event) => $setup.openWithdrawConfirm(course)
                    }, toDisplayString($setup.withdrawingCourseId === course.id ? "处理中..." : "退课"), 9, _hoisted_53))
                  ])
                ])
              ], 8, _hoisted_38);
            }), 128))
        ...
        createBaseVNode("div", _hoisted_73, [
          $setup.loadingInfo ? (openBlock(), createBlock($setup["TEmptyState"], {
            ...
            $setup.infoSourceMessage ? (openBlock(), createElementBlock("div", _hoisted_74, toDisplayString($setup.infoSourceMessage), 1)) : createCommentVNode("", true),
      ...
      $setup.showDetail && $setup.currentDetailCourse ? (openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", _hoisted_90, [
            createBaseVNode("div", null, [
              createBaseVNode("div", _hoisted_91, toDisplayString($setup.currentDetailCourse.kcmc), 1),
              createBaseVNode("div", _hoisted_92, toDisplayString($setup.currentDetailCourse.jxbmc), 1)
            ]),
            createBaseVNode("button", {
              class: "close-btn",
              type: "button",
          ...
          createBaseVNode("div", _hoisted_93, [
            $setup.currentDetailCourse.isOnline ? (openBlock(), createElementBlock("span", _hoisted_94, "网课")) : createCommentVNode("", true),
            createBaseVNode("span", {
          ...
          createBaseVNode("div", _hoisted_98, [
            ...
            createBaseVNode("div", _hoisted_99, toDisplayString($setup.detailIntro || $setup.normalizeDetailIntro($setup.normalizeDetailSourceText($setup.currentDetailCourse.kcjj), { allowConflictText: $setup.currentDetailCourse.isConflict }) || "暂无课程简介"), 1)
          ]),
          createBaseVNode("div", _hoisted_100, [
            _cache[47] || (_cache[47] = createBaseVNode("h4", null, "教师详情", -1)),
            createBaseVNode("div", _hoisted_101, toDisplayString($setup.detailTeacherText || $setup.currentDetailCourse.teacher || "暂无教师详情"), 1)
          ]),
          $setup.detailLoading ? (openBlock(), createElementBlock("div", _hoisted_102, "正在补充课程简介与教师详情...")) : createCommentVNode("", true)
        ])
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", _hoisted_103, [
            createBaseVNode("div", null, [
              ...
              createBaseVNode("div", _hoisted_104, toDisplayString($setup.pendingSelectCourse?.kcmc || "当前课程"), 1)
            ]),
            createBaseVNode("button", {
              class: "close-btn",
              type: "button",
    ...
    (openBlock(), createBlock(Teleport, { to: "body" }, [
      $setup.showActionConfirmDialog ? (openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", _hoisted_112, toDisplayString($setup.confirmActionType === "withdraw" ? "确认退课" : "确认选课"), 1),
