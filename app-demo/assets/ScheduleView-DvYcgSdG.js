import { t, b as useUiSettings, h as flushUiSettings, j as showToast, v as recordSemesterStartDate, x as readScheduleRenderSnapshot, y as writeScheduleRenderSnapshot, f as fetchWithCache, d as axiosInstance, E as EXTRA_LONG_TTL, D as DEFAULT_SWR_OPTIONS, n as normalizeSemesterList, k as resolveCurrentSemester, z as afterScheduleRefresh, A as writeScheduleLock, B as getCachedScheduleSnapshot, m as useI18n, C as runCloudSyncDownload, F as runCloudSyncUpload, G as getCloudSyncCooldownState, r as readScheduleLockDetail, H as isAutoScheduleLockReason, I as semesterIsNewer, J as probeSemesterSchedule, K as readSemesterStartDates, _ as _export_sfc, M as CLOUD_SYNC_UPDATED_EVENT, N as consumeScheduleSwitchPending, O as clearScheduleLock, P as readScheduleLock, Q as warmupScheduleForStudent } from "./app-demo-CUOWTnz-.js";
import { p as pushDebugLog, i as isTestAccountSession, P as isMobileLike, a as isTauriRuntime, d as invokeNative } from "./runtime-bridge-Dt57BD2i.js";
import { f as formatRelativeTime } from "./time-DFqn0g8e.js";
import { r as ref, v as watch, h as computed, C as nextTick, M as resolveComponent, a as openBlock, c as createElementBlock, b as createBaseVNode, u as unref, t as toDisplayString, p as createVNode, k as withCtx, F as Fragment, f as renderList, d as createCommentVNode, T as Transition, w as withModifiers, g as createTextVNode, n as normalizeClass, j as createBlock, e as normalizeStyle, o as onMounted, l as onBeforeUnmount, s as Teleport, K as withDirectives, L as vModelText, P as vModelSelect, y as defineComponent } from "./vue-core-Dzs4fLAU.js";
import { h as hasBootMetric, m as markBootMetric } from "./debug-tools-XN5ic1q-.js";
...
function parsePeriods(value) {
  ...
  if (typeof value !== "string") return null;
  const text = value.trim().replace(/^第/, "").replace(/节$/, "").replace(/[~～—–]/g, "-").trim();
...
function parseCourse(rawItem, sourceIndex) {
  ...
  if (!isPlainObject(rawItem)) {
    return {
      errors: [
        makeDiag("error", "invalid_course_entry", `第 ${sourceIndex + 1} 条不是合法的课程对象`, void 0, sourceIndex)
      ]
    };
  }
...
const useScheduleImport = (options) => {
  ...
  const parseText = () => {
    ...
    if (!parsed.courses.length) {
      ...
      parseError.value = firstError?.message || t2("schedule.import.error.noCourses");
      stage.value = "input";
      return;
    }
...
const _hoisted_1$a = { class: "schedule-topbar" };
const _hoisted_2$a = ["aria-label"];
const _hoisted_3$a = { class: "topbar-center" };
const _hoisted_4$9 = { class: "topbar-title" };
const _hoisted_5$9 = { class: "topbar-semester" };
const _hoisted_6$8 = { class: "topbar-right" };
const _hoisted_7$8 = { class: "week-selector" };
const _hoisted_8$7 = {
  disabled: "",
  value: 0
};
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$a, [
        ...
        createBaseVNode("div", _hoisted_3$a, [
          createBaseVNode("h1", _hoisted_4$9, toDisplayString(unref(t2)("schedule.topbar.title")), 1),
          createBaseVNode("p", _hoisted_5$9, toDisplayString(__props.semester || unref(t2)("schedule.topbar.loading")), 1)
        ]),
        createBaseVNode("div", _hoisted_6$8, [
          createBaseVNode("div", _hoisted_7$8, [
            createVNode(_component_IOSSelect, {
              ...
              default: withCtx(() => [
                createBaseVNode("option", _hoisted_8$7, toDisplayString(unref(t2)("schedule.topbar.weekPlaceholder")), 1),
                (openBlock(true), createElementBlock(Fragment, null, renderList(__props.totalWeeks, (w) => {
                  return openBlock(), createElementBlock("option", {
                    key: w,
                    value: w
                  }, toDisplayString(unref(t2)("schedule.topbar.weekOption").replace("{n}", String(w))), 9, _hoisted_9$6);
                }), 128))
              ]),
              _: 1
            }, 8, ["model-value"])
...
const ScheduleTopbar = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-121b4cdb"]]);
const _hoisted_1$9 = { class: "drawer-title" };
const _hoisted_2$9 = { class: "drawer-section" };
const _hoisted_3$9 = {
  class: "drawer-subtitle",
  "data-step": "1"
};
const _hoisted_4$8 = { class: "drawer-semester-row" };
const _hoisted_5$8 = {
  disabled: "",
  value: ""
};
...
const _hoisted_8$6 = { class: "drawer-section" };
const _hoisted_9$5 = {
  class: "drawer-subtitle",
  "data-step": "2"
};
const _hoisted_10$5 = ["aria-label"];
const _hoisted_11$5 = ["aria-pressed", "aria-selected", "onClick"];
const _hoisted_12$5 = { class: "drawer-actions" };
const _hoisted_13$5 = { class: "drawer-course-group" };
const _hoisted_14$5 = {
  class: "drawer-subtitle",
  "data-step": "3"
};
const _hoisted_15$5 = { class: "drawer-course-actions" };
const _hoisted_16$5 = ["disabled"];
const _hoisted_17$5 = ["disabled"];
const _hoisted_18$4 = { class: "drawer-sync-group" };
const _hoisted_19$3 = {
  class: "drawer-subtitle",
  "data-step": "4"
};
const _hoisted_20$3 = { class: "drawer-sync-actions" };
const _hoisted_21$3 = ["disabled"];
const _hoisted_22$3 = ["disabled"];
const _hoisted_23$2 = { class: "drawer-sync-actions drawer-sync-actions--json" };
const _hoisted_24$2 = ["disabled"];
const _hoisted_25$2 = ["disabled"];
const _hoisted_26$2 = { class: "drawer-sync-status" };
const _hoisted_27$2 = { class: "drawer-sync-cooldown" };
const _hoisted_28$2 = { class: "drawer-sync-cooldown" };
const _hoisted_29$2 = {
  key: 0,
...
const _hoisted_34$2 = { class: "drawer-tip" };
const _hoisted_35$1 = {
  key: 0,
  class: "export-result"
};
const _hoisted_36$1 = { class: "export-label" };
const _hoisted_37$1 = { class: "export-row" };
          ...
          default: withCtx(() => [
            __props.showMenu ? (openBlock(), createElementBlock("aside", {
              ...
              createBaseVNode("div", _hoisted_2$9, [
                createBaseVNode("div", _hoisted_3$9, toDisplayString(unref(t2)("schedule.drawer.section.semester")), 1),
                createBaseVNode("div", _hoisted_4$8, [
                  createVNode(_component_IOSSelect, {
                    ...
                    default: withCtx(() => [
                      createBaseVNode("option", _hoisted_5$8, toDisplayString(unref(t2)("schedule.drawer.semesterPlaceholder")), 1),
                      (openBlock(true), createElementBlock(Fragment, null, renderList(__props.semesterOptions, (sem) => {
                        return openBlock(), createElementBlock("option", {
                          key: sem,
                          value: sem
                        }, toDisplayString(sem), 9, _hoisted_6$7);
                      }), 128))
                    ]),
                    _: 1
                  }, 8, ["modelValue", "disabled"])
                ]),
                __props.semesterError ? (openBlock(), createElementBlock("div", _hoisted_7$7, toDisplayString(__props.semesterError), 1)) : createCommentVNode("", true)
              ]),
              createBaseVNode("div", _hoisted_8$6, [
                createBaseVNode("div", _hoisted_9$5, toDisplayString(unref(t2)("schedule.drawer.section.style")), 1),
                createBaseVNode("div", {
              ...
              createBaseVNode("div", _hoisted_12$5, [
                createBaseVNode("div", _hoisted_13$5, [
                  createBaseVNode("div", _hoisted_14$5, toDisplayString(unref(t2)("schedule.drawer.section.manage")), 1),
                  createBaseVNode("div", _hoisted_15$5, [
                    createBaseVNode("button", {
                      ...
                      createTextVNode(" " + toDisplayString(unref(t2)("schedule.drawer.addCourse")), 1)
                    ], 8, _hoisted_16$5),
                    createBaseVNode("button", {
                ...
                createBaseVNode("div", _hoisted_18$4, [
                  createBaseVNode("div", _hoisted_19$3, toDisplayString(unref(t2)("schedule.drawer.section.sync")), 1),
                  ...
                  createBaseVNode("div", _hoisted_26$2, [
                    createBaseVNode("span", _hoisted_27$2, toDisplayString(unref(t2)("schedule.drawer.uploadCooldown").replace("{t}", __props.syncUploadCooldownText)), 1),
                    createBaseVNode("span", _hoisted_28$2, toDisplayString(unref(t2)("schedule.drawer.downloadCooldown").replace("{t}", __props.syncDownloadCooldownText)), 1),
                    __props.syncStatusText ? (openBlock(), createElementBlock("span", _hoisted_29$2, toDisplayString(__props.syncStatusText), 1)) : createCommentVNode("", true),
                    __props.customCourseExportLocation ? (openBlock(), createElementBlock("span", _hoisted_30$2, toDisplayString(unref(t2)("schedule.drawer.exportLocation").replace("{t}", __props.customCourseExportLocation)), 1)) : createCommentVNode("", true)
                  ])
                ]),
                createBaseVNode("div", _hoisted_31$2, toDisplayString(unref(t2)("schedule.drawer.section.export")), 1),
                createBaseVNode("button", {
                  class: "drawer-action",
              ...
              createBaseVNode("div", _hoisted_34$2, toDisplayString(unref(t2)("schedule.drawer.exportTip")), 1),
              __props.exportUrl ? (openBlock(), createElementBlock("div", _hoisted_35$1, [
                createBaseVNode("div", _hoisted_36$1, toDisplayString(unref(t2)("schedule.drawer.exportResultLabel")), 1),
                ...
                __props.exportCopied ? (openBlock(), createElementBlock("div", _hoisted_39$1, toDisplayString(unref(t2)("schedule.drawer.copied")), 1)) : createCommentVNode("", true)
              ])) : createCommentVNode("", true),
              __props.exportError ? (openBlock(), createElementBlock("div", _hoisted_40$1, toDisplayString(__props.exportError), 1)) : createCommentVNode("", true)
            ])) : createCommentVNode("", true)
          ]),
          _: 1
        })
...
const ScheduleDrawer = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-10d65324"]]);
const _hoisted_1$8 = {
  key: 0,
...
const _sfc_main$9 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        __props.offline && __props.initialFetchDone && !__props.loading ? (openBlock(), createElementBlock("div", _hoisted_1$8, toDisplayString(__props.offlineBannerText), 1)) : createCommentVNode("", true),
        __props.vacationNotice ? (openBlock(), createElementBlock("div", _hoisted_2$8, toDisplayString(__props.vacationNotice), 1)) : createCommentVNode("", true),
        __props.termStartNotice ? (openBlock(), createElementBlock("div", _hoisted_3$8, toDisplayString(__props.termStartNotice), 1)) : createCommentVNode("", true),
        __props.errorMsg ? (openBlock(), createElementBlock("div", _hoisted_4$7, toDisplayString(__props.errorMsg), 1)) : createCommentVNode("", true),
        ...
        }, toDisplayString(unref(t2)("schedule.banners.jumpToCurrentWeek")), 9, _hoisted_5$7)) : createCommentVNode("", true)
      ], 64);
    };
  }
};
const ScheduleBanners = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-882491aa"]]);
const _hoisted_1$7 = { class: "date-header" };
const _hoisted_2$7 = { class: "month-col" };
const _hoisted_3$7 = { class: "month-num" };
const _hoisted_4$6 = {
  key: 0,
  class: "month-label"
};
const _hoisted_5$6 = { class: "days-row" };
const _hoisted_6$6 = { class: "day-num" };
const _hoisted_7$6 = { class: "day-label" };
const _hoisted_8$5 = { class: "grid-body" };
const _hoisted_9$4 = { class: "time-axis" };
const _hoisted_10$4 = { class: "time-start" };
const _hoisted_11$4 = { class: "period-num" };
const _hoisted_12$4 = { class: "time-end" };
const _hoisted_13$4 = {
  class: "grid-lines",
  "aria-hidden": "true"
};
const _hoisted_14$4 = ["onClick"];
const _hoisted_15$4 = { class: "course-name" };
const _hoisted_16$4 = { class: "course-room" };
const _hoisted_17$4 = {
  key: 0,
            ...
            createBaseVNode("div", _hoisted_1$7, [
              createBaseVNode("div", _hoisted_2$7, [
                createBaseVNode("div", _hoisted_3$7, [
                  ...
                  unref(t2)("schedule.grid.monthSuffix") ? (openBlock(), createElementBlock("span", _hoisted_4$6, toDisplayString(unref(t2)("schedule.grid.monthSuffix")), 1)) : createCommentVNode("", true)
                ])
              ]),
              createBaseVNode("div", _hoisted_5$6, [
                (openBlock(), createElementBlock(Fragment, null, renderList(7, (day) => {
                  return createBaseVNode("div", {
                    ...
                    createBaseVNode("div", _hoisted_6$6, toDisplayString(__props.weekDates[day - 1]?.date || day), 1),
                    createBaseVNode("div", _hoisted_7$6, toDisplayString(__props.weekDates[day - 1]?.dayLabel || ""), 1)
                  ], 2);
                }), 64))
              ])
            ]),
              ...
              createBaseVNode("div", _hoisted_9$4, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(unref(timeSchedule), (t3) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("span", _hoisted_10$4, toDisplayString(t3.start), 1),
                    createBaseVNode("span", _hoisted_11$4, toDisplayString(t3.p), 1),
                    createBaseVNode("span", _hoisted_12$4, toDisplayString(t3.end), 1)
                  ]);
                }), 128))
              ]),
              (openBlock(), createElementBlock("div", {
                  ...
                  return createBaseVNode("div", {
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(__props.getCoursesForDay(day), (course) => {
                      return openBlock(), createElementBlock("div", {
                        ...
                        createBaseVNode("div", _hoisted_15$4, toDisplayString(course.name), 1),
                        createBaseVNode("div", _hoisted_16$4, toDisplayString(course.is_conflict ? unref(t2)("schedule.grid.conflictHint") : course.room_code || course.room), 1),
                        __props.scheduleCourseCardStyle === "class" && !course.is_conflict ? (openBlock(), createElementBlock("div", _hoisted_17$4, toDisplayString(course.teacher || unref(t2)("schedule.grid.noTeacher")), 1)) : createCommentVNode("", true)
                      ], 14, _hoisted_14$4);
                    }), 128))
                  ], 2);
                }), 64))
...
const ScheduleGrid = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-66b26cc4"]]);
const _hoisted_1$6 = { class: "modal-header" };
const _hoisted_2$6 = {
  key: 0,
  class: "modal-body"
};
const _hoisted_3$6 = { class: "conflict-hint" };
const _hoisted_4$5 = ["onClick"];
const _hoisted_5$5 = { class: "conflict-item-title" };
const _hoisted_6$5 = {
  key: 0,
  class: "conflict-tag"
};
const _hoisted_7$5 = { class: "conflict-item-row" };
const _hoisted_8$4 = { class: "conflict-item-row" };
const _hoisted_9$3 = { class: "conflict-item-row" };
const _hoisted_10$3 = {
  key: 1,
  class: "modal-body"
};
...
const _hoisted_12$3 = { class: "label" };
const _hoisted_13$3 = { class: "value" };
const _hoisted_14$3 = { class: "info-row" };
const _hoisted_15$3 = { class: "label" };
const _hoisted_16$3 = { class: "value" };
const _hoisted_17$3 = { class: "info-row" };
const _hoisted_18$3 = { class: "label" };
const _hoisted_19$2 = { class: "value" };
const _hoisted_20$2 = { class: "info-row" };
const _hoisted_21$2 = { class: "label" };
const _hoisted_22$2 = { class: "value" };
const _hoisted_23$1 = { class: "info-row" };
const _hoisted_24$1 = { class: "label" };
const _hoisted_25$1 = { class: "value" };
const _hoisted_26$1 = { class: "info-row" };
const _hoisted_27$1 = { class: "label" };
const _hoisted_28$1 = { class: "value" };
const _hoisted_29$1 = { class: "info-row" };
const _hoisted_30$1 = { class: "label" };
const _hoisted_31$1 = { class: "value" };
const _hoisted_32$1 = {
  key: 1,
  class: "custom-course-actions"
};
const _hoisted_33$1 = { class: "detail-copy-actions" };
const _hoisted_34$1 = {
  key: 2,
        ...
        default: withCtx(() => [
          __props.showDetail ? (openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", {
              ...
              __props.selectedCourse?.is_conflict ? (openBlock(), createElementBlock("div", _hoisted_2$6, [
                createBaseVNode("div", _hoisted_3$6, toDisplayString(unref(t2)("schedule.detail.conflictBannerHint")), 1),
                (openBlock(true), createElementBlock(Fragment, null, renderList(__props.selectedCourse?.conflict_courses || [], (item, idx) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", _hoisted_5$5, [
                      ...
                      item.is_custom ? (openBlock(), createElementBlock("span", _hoisted_6$5, toDisplayString(unref(t2)("schedule.detail.tag.custom")), 1)) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("div", _hoisted_7$5, toDisplayString(unref(t2)("schedule.detail.teacher")) + "：" + toDisplayString(item.teacher || unref(t2)("schedule.detail.teacherNotFilled")), 1),
                    createBaseVNode("div", _hoisted_8$4, toDisplayString(unref(t2)("schedule.detail.location")) + "：" + toDisplayString([item.building, item.room || item.room_code].filter(Boolean).join(" ") || unref(t2)("schedule.detail.locationNotFilled")), 1),
                    createBaseVNode("div", _hoisted_9$3, toDisplayString(unref(t2)("schedule.detail.time")) + "：" + toDisplayString(unref(t2)("schedule.detail.conflictPeriod").replace("{n}", String(item.weekday)).replace("{s}", String(item.period)).replace("{e}", String(unref(getCourseEndPeriod)(item)))), 1)
                  ], 10, _hoisted_4$5);
                }), 128))
              ])) : (openBlock(), createElementBlock("div", _hoisted_10$3, [
                __props.selectedCourse?.is_custom ? (openBlock(), createElementBlock("div", _hoisted_11$3, [
                  createBaseVNode("span", _hoisted_12$3, toDisplayString(unref(t2)("schedule.detail.type")), 1),
                  createBaseVNode("span", _hoisted_13$3, toDisplayString(unref(t2)("schedule.detail.typeCustom")), 1)
                ])) : createCommentVNode("", true),
                createBaseVNode("div", _hoisted_14$3, [
                  createBaseVNode("span", _hoisted_15$3, toDisplayString(unref(t2)("schedule.detail.teacher")), 1),
                  createBaseVNode("span", _hoisted_16$3, toDisplayString(__props.selectedCourse?.teacher), 1)
                ]),
                createBaseVNode("div", _hoisted_17$3, [
                  createBaseVNode("span", _hoisted_18$3, toDisplayString(unref(t2)("schedule.detail.classroom")), 1),
                  createBaseVNode("span", _hoisted_19$2, toDisplayString(__props.selectedCourse?.room) + " (" + toDisplayString(__props.selectedCourse?.building) + ")", 1)
                ]),
                createBaseVNode("div", _hoisted_20$2, [
                  createBaseVNode("span", _hoisted_21$2, toDisplayString(unref(t2)("schedule.detail.time")), 1),
                ...
                createBaseVNode("div", _hoisted_23$1, [
                  createBaseVNode("span", _hoisted_24$1, toDisplayString(unref(t2)("schedule.detail.weeks")), 1),
                  createBaseVNode("span", _hoisted_25$1, toDisplayString(__props.selectedCourse?.weeks_text), 1)
                ]),
                createBaseVNode("div", _hoisted_26$1, [
                  createBaseVNode("span", _hoisted_27$1, toDisplayString(unref(t2)("schedule.detail.credit")), 1),
                  createBaseVNode("span", _hoisted_28$1, toDisplayString(__props.selectedCourse?.credit), 1)
                ]),
                createBaseVNode("div", _hoisted_29$1, [
                  createBaseVNode("span", _hoisted_30$1, toDisplayString(unref(t2)("schedule.detail.classGroup")), 1),
                  createBaseVNode("span", _hoisted_31$1, toDisplayString(__props.selectedCourse?.class_name), 1)
                ]),
                __props.selectedCourse?.is_custom ? (openBlock(), createElementBlock("div", _hoisted_32$1, [
                  createBaseVNode("button", {
              ...
              __props.detailActionError ? (openBlock(), createElementBlock("div", _hoisted_34$1, toDisplayString(__props.detailActionError), 1)) : createCommentVNode("", true)
            ])
          ])) : createCommentVNode("", true)
        ]),
        _: 1
...
const ScheduleCourseDetail = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-6a590e3f"]]);
const _hoisted_1$5 = { class: "course-color-picker" };
const _hoisted_2$5 = { class: "ccp-entry-right" };
const _hoisted_3$5 = { class: "ccp-entry-meta" };
const _hoisted_4$4 = { class: "ccp-preset-grid" };
const _hoisted_5$4 = ["title", "aria-label", "onClick"];
const _hoisted_6$4 = { class: "ccp-custom-body" };
const _hoisted_7$4 = { class: "ccp-preview-row" };
const _hoisted_8$3 = { class: "ccp-hex" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$5, [
        createBaseVNode("button", {
          ...
          createBaseVNode("span", _hoisted_2$5, [
            ...
            createBaseVNode("span", _hoisted_3$5, toDisplayString(presetMatchLabel.value), 1),
                    ...
                    panel.value === "preset" ? (openBlock(), createElementBlock("div", {
                      ...
                      createBaseVNode("div", _hoisted_6$4, [
                        ...
                        createBaseVNode("div", _hoisted_7$4, [
                          ...
                          createBaseVNode("span", _hoisted_8$3, toDisplayString(customPreview.value.toUpperCase()), 1)
                        ])
                      ]),
...
const CourseColorPicker = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-1513f417"]]);
const _hoisted_1$4 = { class: "modal-header" };
const _hoisted_2$4 = { class: "modal-body add-course-body" };
const _hoisted_3$4 = { class: "add-course-semester" };
const _hoisted_4$3 = { class: "add-field" };
const _hoisted_5$3 = ["placeholder"];
const _hoisted_6$3 = { class: "add-field" };
const _hoisted_7$3 = ["placeholder"];
const _hoisted_8$2 = { class: "add-field" };
const _hoisted_9$2 = ["placeholder"];
const _hoisted_10$2 = { class: "add-field" };
const _hoisted_11$2 = ["value"];
const _hoisted_12$2 = { class: "add-row" };
const _hoisted_13$2 = { class: "add-field" };
const _hoisted_14$2 = ["value"];
const _hoisted_15$2 = { class: "add-field" };
const _hoisted_16$2 = ["value"];
const _hoisted_17$2 = { class: "add-field" };
const _hoisted_18$2 = { class: "add-field" };
const _hoisted_19$1 = {
  key: 0,
  class: "drawer-error add-course-error"
};
const _hoisted_20$1 = { class: "add-actions" };
          ...
          __props.showAddCourse ? (openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", {
              ...
              createBaseVNode("div", _hoisted_1$4, [
                createBaseVNode("h3", null, toDisplayString(__props.courseDialogMode === "edit" ? unref(t2)("schedule.addCourse.titleEdit") : unref(t2)("schedule.addCourse.titleAdd")), 1),
                createBaseVNode("button", {
                  class: "close-btn",
                  onClick: _cache[0] || (_cache[0] = ($event) => emit("close"))
                }, "×")
              ...
              createBaseVNode("div", _hoisted_2$4, [
                createBaseVNode("div", _hoisted_3$4, toDisplayString(unref(t2)("schedule.addCourse.semesterLabel").replace("{t}", __props.courseDialogSemester)), 1),
                ...
                createBaseVNode("label", _hoisted_6$3, [
                  ...
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => form.value.teacher = $event),
                    type: "text",
                ...
                createBaseVNode("label", _hoisted_8$2, [
                  ...
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => form.value.room = $event),
                    type: "text",
                ...
                createBaseVNode("div", _hoisted_10$2, [
                  ...
                  createVNode(_component_IOSSelect, {
                    ...
                    "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => form.value.weekday = $event),
                ...
                createBaseVNode("div", _hoisted_12$2, [
                  createBaseVNode("label", _hoisted_13$2, [
                    ...
                    createVNode(_component_IOSSelect, {
                      ...
                      "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => form.value.period = $event),
                      modelModifiers: { number: true }
                    }, {
                      default: withCtx(() => [
                        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(periodOptions), (p) => {
                          return openBlock(), createElementBlock("option", {
                            key: p,
                            value: p
                          }, toDisplayString(unref(t2)("schedule.addCourse.periodOption").replace("{n}", String(p))), 9, _hoisted_14$2);
                        }), 128))
                      ]),
                      _: 1
                    }, 8, ["modelValue"])
                  ...
                  createBaseVNode("label", _hoisted_15$2, [
                    ...
                    createVNode(_component_IOSSelect, {
                      ...
                      "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => form.value.djs = $event),
                      modelModifiers: { number: true }
                    }, {
                      default: withCtx(() => [
                        (openBlock(true), createElementBlock(Fragment, null, renderList(__props.courseSpanOptions, (s) => {
                          return openBlock(), createElementBlock("option", {
                            key: s,
                            value: s
                          }, toDisplayString(unref(t2)("schedule.addCourse.spanOption").replace("{n}", String(s))), 9, _hoisted_16$2);
                        }), 128))
                      ]),
                      _: 1
                    }, 8, ["modelValue"])
                ...
                createBaseVNode("div", _hoisted_18$2, [
                  createVNode(CourseColorPicker, {
                    ...
                    "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => form.value.color = $event)
                  }, null, 8, ["modelValue"])
                ]),
                __props.addCourseError ? (openBlock(), createElementBlock("div", _hoisted_19$1, toDisplayString(__props.addCourseError), 1)) : createCommentVNode("", true)
              ]),
              createBaseVNode("div", _hoisted_20$1, [
                ...
                }, toDisplayString(unref(t2)("schedule.addCourse.cancel")), 9, _hoisted_21$1),
                createBaseVNode("button", {
                  class: "drawer-action",
                  disabled: __props.addingCourse,
                  onClick: _cache[10] || (_cache[10] = ($event) => emit("submit"))
                }, toDisplayString(__props.addingCourse ? __props.courseDialogMode === "edit" ? unref(t2)("schedule.addCourse.submittingEdit") : unref(t2)("schedule.addCourse.submittingAdd") : __props.courseDialogMode === "edit" ? unref(t2)("schedule.addCourse.submitEdit") : unref(t2)("schedule.addCourse.submitAdd")), 9, _hoisted_22$1)
              ])
            ])
          ])) : createCommentVNode("", true)
        ]),
...
const ScheduleAddCourseDialog = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-29d729c7"]]);
...
const _hoisted_19 = { class: "sci-chip accent" };
const _hoisted_20 = {
  key: 0,
  class: "sci-chip warn"
};
...
const _hoisted_25 = { class: "sci-list-tools" };
const _hoisted_26 = {
  key: 0,
  class: "sci-empty"
};
...
const _hoisted_28 = { class: "sci-item-main" };
const _hoisted_29 = ["checked", "disabled", "onChange"];
const _hoisted_30 = { class: "sci-item-text" };
const _hoisted_31 = { class: "sci-item-name" };
const _hoisted_32 = {
  key: 0,
...
const _hoisted_34 = { class: "sci-item-meta" };
const _hoisted_35 = {
  key: 0,
  class: "sci-item-meta"
};
const _hoisted_36 = { class: "sci-item-color" };
const _hoisted_37 = {
  key: 2,
  class: "sci-global-diag"
};
const _hoisted_38 = { class: "sci-week-nav" };
const _hoisted_39 = ["disabled", "aria-label"];
const _hoisted_40 = ["value"];
const _hoisted_41 = ["value"];
const _hoisted_42 = ["disabled", "aria-label"];
              ...
              createBaseVNode("div", {
                ...
                __props.stage === "input" ? (openBlock(), createElementBlock("div", _hoisted_4$2, [
                  ...
                  createBaseVNode("div", _hoisted_16$1, [
                    ...
                    createBaseVNode("span", _hoisted_19, toDisplayString(unref(t2)("schedule.import.summary.importable")) + " " + toDisplayString(__props.summary.importable), 1),
                    __props.summary.duplicate ? (openBlock(), createElementBlock("span", _hoisted_20, toDisplayString(unref(t2)("schedule.import.summary.duplicate")) + " " + toDisplayString(__props.summary.duplicate), 1)) : createCommentVNode("", true),
                    __props.summary.conflict ? (openBlock(), createElementBlock("span", _hoisted_21, toDisplayString(unref(t2)("schedule.import.summary.conflict")) + " " + toDisplayString(__props.summary.conflict), 1)) : createCommentVNode("", true),
                    __props.summary.warning ? (openBlock(), createElementBlock("span", _hoisted_22, toDisplayString(unref(t2)("schedule.import.summary.warning")) + " " + toDisplayString(__props.summary.warning), 1)) : createCommentVNode("", true),
                    __props.summary.error ? (openBlock(), createElementBlock("span", _hoisted_23, toDisplayString(unref(t2)("schedule.import.summary.error")) + " " + toDisplayString(__props.summary.error), 1)) : createCommentVNode("", true)
                  ]),
                  ...
                  __props.previewMode === "list" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    ...
                    !__props.previewCourses.length ? (openBlock(), createElementBlock("div", _hoisted_26, toDisplayString(unref(t2)("schedule.import.empty")), 1)) : (openBlock(), createElementBlock("ul", _hoisted_27, [
                          ...
                          createBaseVNode("label", _hoisted_28, [
                            ...
                            createBaseVNode("span", _hoisted_30, [
                              createBaseVNode("span", _hoisted_31, [
                                ...
                                item.duplicateKind === "exact" ? (openBlock(), createElementBlock("span", _hoisted_32, toDisplayString(unref(t2)("schedule.import.badge.duplicate")), 1)) : item.duplicateKind === "possible" ? (openBlock(), createElementBlock("span", _hoisted_33, toDisplayString(unref(t2)("schedule.import.badge.possibleDuplicate")), 1)) : createCommentVNode("", true)
                              ]),
                              ...
                              item.course.room || item.course.teacher ? (openBlock(), createElementBlock("span", _hoisted_35, toDisplayString(item.course.room || "—") + " · " + toDisplayString(item.course.teacher || "—"), 1)) : createCommentVNode("", true),
                    ...
                    __props.globalDiagnostics.length ? (openBlock(), createElementBlock("div", _hoisted_37, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(__props.globalDiagnostics, (diag, di) => {
                        return openBlock(), createElementBlock("div", {
                          key: `g-${di}`,
                          class: "sci-item-warn"
                        }, toDisplayString(diag.message), 1);
                      }), 128))
                    ])) : createCommentVNode("", true)
                      ...
                      createBaseVNode("select", {
                        ...
                        (openBlock(true), createElementBlock(Fragment, null, renderList(previewWeekOptions.value, (w) => {
                          return openBlock(), createElementBlock("option", {
                            key: w,
                            value: w
                          }, toDisplayString(weekOptionText(w)), 9, _hoisted_41);
                        }), 128))
                      ], 40, _hoisted_40),
                      createBaseVNode("button", {
                        type: "button",
...
const ScheduleCourseImportDialog = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-d02cf403"]]);
                    ...
                    return openBlock(), createElementBlock("section", {
                      ...
                      createBaseVNode("button", {
                        ...
                        createBaseVNode("div", _hoisted_8, [
                          ...
                          createBaseVNode("span", null, toDisplayString(unref(t2)("schedule.manageCourses.courseCount").replace("{n}", String(group.courses.length))), 1)
                        ]),
                        ...
                        (openBlock(true), createElementBlock(Fragment, null, renderList(group.courses, (course) => {
                          return openBlock(), createElementBlock("article", {
                            ...
                            createBaseVNode("div", _hoisted_11, [
                              ...
                              createBaseVNode("div", _hoisted_13, toDisplayString(unref(t2)("schedule.manageCourses.timeMeta").replace("{day}", weekDayLabels.value[(course.weekday || 1) - 1]).replace("{s}", String(course.period)).replace("{e}", String(unref(getCourseEndPeriod)(course)))), 1),
                              createBaseVNode("div", _hoisted_14, toDisplayString(unref(t2)("schedule.manageCourses.weeksMeta").replace("{t}", course.weeks_text)), 1),
                            ...
                            createBaseVNode("div", _hoisted_16, [
                              ...
                              }, toDisplayString(unref(t2)("schedule.manageCourses.edit")), 9, _hoisted_17),
                              createBaseVNode("button", {
                                class: "manage-course-btn delete",
                                onClick: ($event) => emit("delete-course", course)
                              }, toDisplayString(unref(t2)("schedule.manageCourses.delete")), 9, _hoisted_18)
                            ])
                          ]);
                        }), 128))
                      ])) : createCommentVNode("", true)
...
const ScheduleManageCoursesDialog = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-54019da9"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const anyOverlayOpen = computed(() => {
      return menu.showMenu.value || detail.showDetail.value || editor.showAddCourse.value || editor.showManageCourses.value || editor.showWeekPicker.value || importApi.showImportDialog.value || confirmDialog.showConfirmDialog.value;
    });
    const {
      semester,
      semesterDraft,
...
const ScheduleView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-304aa65f"]]);
export {
