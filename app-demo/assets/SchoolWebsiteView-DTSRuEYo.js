const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./school_website_embed-Bg0B_cDZ.js","./runtime-bridge-i9KZPKjs.js","./more-modules-rEERMQm_.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, F as isAndroidLike } from "./runtime-bridge-i9KZPKjs.js";
import { _ as _export_sfc, m as useI18n, o as openExternal } from "./app-demo-DqAlnDLf.js";
import { forceCloseSchoolWebsiteEmbed, resolveSchoolWebsiteEmbedMode, mountSchoolWebsiteEmbed, SCHOOL_WEBSITE_URL, resolveSchoolWebsiteIframeUrl } from "./school_website_embed-Bg0B_cDZ.js";
import { o as onMounted, C as nextTick, l as onBeforeUnmount, a as openBlock, c as createElementBlock, b as createBaseVNode, u as unref, t as toDisplayString, d as createCommentVNode, r as ref, h as computed } from "./vue-core-Dzs4fLAU.js";
...
const _hoisted_9 = { class: "frame-message-actions" };
const _hoisted_10 = {
  key: 2,
    ...
    const remountAfterResume = async (eventDetail = null) => {
      ...
      try {
        const { recoverSchoolWebsiteBridgeOnResume } = await __vitePreload(async () => {
          const { recoverSchoolWebsiteBridgeOnResume: recoverSchoolWebsiteBridgeOnResume2 } = await import("./school_website_embed-Bg0B_cDZ.js");
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("header", _hoisted_2, [
          createBaseVNode("button", {
            ...
            type: "button",
            onClick: handleBack,
            "aria-label": unref(t)("web.backAria")
          }, [..._cache[0] || (_cache[0] = [
            createBaseVNode("span", { class: "material-symbols-outlined" }, "arrow_back", -1)
          ])], 8, _hoisted_3),
          createBaseVNode("div", _hoisted_4, [
            createBaseVNode("span", _hoisted_5, toDisplayString(unref(t)("web.kicker")), 1),
            createBaseVNode("h1", null, toDisplayString(unref(t)("web.title")), 1)
          ]),
          createBaseVNode("button", {
            class: "external-button",
            type: "button",
            onClick: handleOpenExternal,
            "aria-label": unref(t)("web.openExternalAria")
          }, [..._cache[1] || (_cache[1] = [
        ...
        createBaseVNode("div", {
          ...
          loading.value ? (openBlock(), createElementBlock("div", _hoisted_7, [
            _cache[2] || (_cache[2] = createBaseVNode("span", { class: "material-symbols-outlined spinning" }, "progress_activity", -1)),
            createBaseVNode("p", null, toDisplayString(unref(t)("web.loading")), 1)
          ...
          loadError.value ? (openBlock(), createElementBlock("div", _hoisted_8, [
            ...
            createBaseVNode("div", _hoisted_9, [
              ...
              }, toDisplayString(unref(t)("web.retry")), 1),
              createBaseVNode("button", {
                class: "external-open-btn",
                type: "button",
                onClick: handleOpenExternal
              }, toDisplayString(unref(t)("web.openInBrowser")), 1)
            ])
          ])) : loadHint.value ? (openBlock(), createElementBlock("div", _hoisted_10, [
...
const SchoolWebsiteView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dc2dc475"]]);
export {
