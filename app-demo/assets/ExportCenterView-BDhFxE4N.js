...
import { a as isTauriRuntime, c as isCapacitorRuntime, _ as __vitePreload, d as invokeNative } from "./runtime-bridge-BDjl3Bnt.js";
...
import { _ as _export_sfc, m as useI18n, p as tf, f as fetchWithCache, d as axiosInstance, n as normalizeSemesterList, k as resolveCurrentSemester } from "./app-demo-BO0WKfcf.js";
...
import { u as normalizeScheduleEvent, r as resolveSemesterDateRange } from "./eventTypes-D0_IHKV9.js";
  ...
  setup(__props, { emit: __emit }) {
    ...
    const saveByCapacitor = async (fileName, blob) => {
      const { Filesystem, Directory } = await __vitePreload(async () => {
        const { Filesystem: Filesystem2, Directory: Directory2 } = await import("./runtime-bridge-BDjl3Bnt.js").then((n) => n.ad);
      ...
      const { Share } = await __vitePreload(async () => {
        const { Share: Share2 } = await import("./runtime-bridge-BDjl3Bnt.js").then((n) => n.ae);
        return { Share: Share2 };
      }, true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
      await Share.share({
        title: fileName,
