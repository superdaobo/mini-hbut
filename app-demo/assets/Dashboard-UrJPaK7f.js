const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./runtime-bridge-BU9jeOXP.js","./more-modules-CfNfahoc.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, i as isTestAccountSession } from "./runtime-bridge-BU9jeOXP.js";
...
import { a as openBlock, c as createElementBlock, t as toDisplayString, f as normalizeStyle, n as normalizeClass, h as computed, b as createBaseVNode, e as createTextVNode, d as createCommentVNode, F as Fragment, g as renderList, w as withModifiers, j as createBlock, J as withDirectives, K as vModelText, s as Teleport, p as createVNode, k as withCtx, T as Transition, v as watch, r as ref, o as onMounted, l as onBeforeUnmount, C as nextTick } from "./vue-core-DWoFi2CM.js";
import { _ as _sfc_main$2, L as LayoutCollisionFxLayer, r as resolveRelativeCollisionPoint, a as resolveCollisionPalette, c as createLayoutCollisionBurst, b as advanceLayoutCollisionFx, d as resolveLayoutSlotTarget, m as moveLayoutItemToIndex, e as captureLayoutSlotAnchors } from "./layout_collision_fx-7Q3nAaTI.js";
import { j as isModuleAllowed, k as filterAllowedModules } from "./more-modules-CfNfahoc.js";
...
const _hoisted_113 = { class: "quick-entry-editor-panel modal-pop-card w-full max-w-md bg-white rounded-t-3xl p-6 max-h-[80vh] overflow-y-auto" };
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [
    ...
    createBaseVNode("main", _hoisted_5, [
      ...
      createBaseVNode("div", _hoisted_31, [
        ...
        !$props.isLoggedIn ? (openBlock(), createElementBlock("div", _hoisted_33, "登录后可查看今日课程")) : $setup.todayLoading ? (openBlock(), createElementBlock("div", _hoisted_34, "正在加载今日课程...")) : $setup.todayError ? (openBlock(), createElementBlock("div", _hoisted_35, toDisplayString($setup.todayError), 1)) : $setup.todayCourses.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_36, [..._cache[21] || (_cache[21] = [
          createBaseVNode("img", {
            src: _imports_1,
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList($setup.todayCourses, (course, idx) => {
            return openBlock(), createElementBlock("div", {
              ...
              course.endMinutes <= $setup.currentMinutePrecise ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              ...
              ], 64)) : idx === 0 || $setup.todayCourses[idx - 1] && $setup.todayCourses[idx - 1].endMinutes <= $setup.currentMinutePrecise && course.endMinutes > $setup.currentMinutePrecise ? (openBlock(), createElementBlock("div", _hoisted_45, [
                ...
                createBaseVNode("div", _hoisted_49, [
                  createBaseVNode("span", _hoisted_50, toDisplayString(course.startMinutes <= $setup.currentMinutePrecise ? "进行中" : "下一节"), 1),
                ...
                createBaseVNode("div", _hoisted_53, [
                  ...
                  createBaseVNode("div", _hoisted_54, toDisplayString($setup.getCourseCountdown(course)), 1),
                  createBaseVNode("button", {
        ...
        $setup.todayCourses.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_62, [
      ...
      $setup.showHomeSearch ? (openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_79, [
          ...
          createBaseVNode("div", _hoisted_83, [
            !$setup.homeSearchHasQuery ? (openBlock(), createElementBlock("div", _hoisted_84, [
            ...
            ])) : $setup.homeSearchSections.length ? (openBlock(), createElementBlock("div", _hoisted_90, [
        ...
        default: withCtx(() => [
          $setup.showQuickEntryEditor ? (openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", _hoisted_113, [
              ...
              createBaseVNode("p", _hoisted_115, "选择 5 个模块作为快捷入口（已选 " + toDisplayString($setup.draftQuickEntries.length) + "/5）", 1),
              createBaseVNode("div", _hoisted_116, [
                (openBlock(true), createElementBlock(Fragment, null, renderList($setup.editableQuickEntryMeta, (meta, id) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    $setup.draftQuickEntries.includes(id) ? (openBlock(), createElementBlock("div", _hoisted_120, [..._cache[55] || (_cache[55] = [
    ...
    const fetchWeather = async (force = false) => {
      ...
      try {
        const { invokeNative } = await __vitePreload(async () => {
          const { invokeNative: invokeNative2 } = await import("./runtime-bridge-BU9jeOXP.js").then((n) => n.a6);
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", render], ["__scopeId", "data-v-4851cd5c"]]);
export {
