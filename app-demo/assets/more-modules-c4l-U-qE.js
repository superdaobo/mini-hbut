import { i as isTestAccountSession, a as isTauriRuntime, b as isLikelyAndroidUserAgent, _ as __vitePreload, t as toNativeFileSrc, g as getNativeAppVersion, p as pushDebugLog, c as isCapacitorRuntime } from "./runtime-bridge-HjlgKupV.js";
...
const fetchJsonViaCapacitor = async (url, timeoutMs = DEFAULT_REMOTE_JSON_TIMEOUT_MS) => {
  const core = await __vitePreload(() => import("./runtime-bridge-HjlgKupV.js").then((n) => n.a3), true ? [] : void 0, import.meta.url);
...
const invokeNativeBridge = async (command, args, label = "") => {
  const core = await __vitePreload(() => import("./runtime-bridge-HjlgKupV.js").then((n) => n.a9), true ? [] : void 0, import.meta.url);
  try {
...
const safeCapacitorRemoveDir = async (path) => {
  ...
  const { Filesystem, Directory } = await __vitePreload(async () => {
    const { Filesystem: Filesystem2, Directory: Directory2 } = await import("./runtime-bridge-HjlgKupV.js").then((n) => n.ac);
