import { r as ref, v as watch, o as onMounted, l as onBeforeUnmount, a as openBlock, c as createElementBlock, b as createBaseVNode, n as normalizeClass, t as toDisplayString, F as Fragment, J as withDirectives, K as vModelText, O as vModelCheckbox, e as createTextVNode, p as createVNode, k as withCtx, d as createCommentVNode, T as Transition, u as unref, h as computed, R as createStaticVNode, j as createBlock, w as withModifiers, C as nextTick } from "./vue-core-DWoFi2CM.js";
import { _ as _imports_0 } from "./app_icon-BoqTJkLh.js";
import { _ as _export_sfc, u as useAuthStore, U as loadPortalRememberedPassword, V as loadChaoxingRememberedPassword, T as fetchRemoteConfig, W as applyOcrRuntimeConfig, X as getStoredOcrConfig, b as axiosInstance, Y as syncPortalRememberCredential, Z as runExclusiveLogin, s as setCachedData, $ as saveRememberedCredential, a0 as buildHbutAccountKey, a1 as buildChaoxingAccountKey, o as openExternal, i as showToast } from "./app-demo-Bca6_3ab.js";
import { p as pushDebugLog, Q as isTestAccountCredentials, x as saveRememberedUsername, a as isTauriRuntime, d as invokeNative, F as markTestAccountSession, T as TEST_ACCOUNT, R as TEST_ACCOUNT_LOGIN_METHOD, B as seedTestAccountCaches, A as getTestAccountGrades, i as isTestAccountSession, D as clearTestAccountSession } from "./runtime-bridge-BU9jeOXP.js";
import { N as NON_OFFICIAL_DISCLAIMER_ZH, l as NON_OFFICIAL_DISCLAIMER_EN, P as PRIVACY_POLICY_URL, I as ICP_BEIAN_TEXT, m as isSponsorEntryAllowed, i as isViewAllowed, o as ICP_BEIAN_URL } from "./more-modules-CfNfahoc.js";
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        _cache[43] || (_cache[43] = createStaticVNode('<header class="dashboard-header" data-v-de0effed><div class="header-left" data-v-de0effed><img class="logo-img" src="' + _imports_0 + '" alt="HBUT" data-v-de0effed><span class="header-title" data-v-de0effed>Mini-HBUT</span></div><span class="header-pill" data-v-de0effed>我的</span></header>', 1)),
        ...
        _cache[44] || (_cache[44] = createStaticVNode('<section class="status-card" data-v-de0effed><div class="status-left" data-v-de0effed><div class="status-icon-box" data-v-de0effed><span class="material-symbols-outlined status-icon" data-v-de0effed>verified_user</span></div><div class="status-text" data-v-de0effed><span class="status-title" data-v-de0effed>登录状态</span><span class="status-subtitle" data-v-de0effed>静默登录已开启</span></div></div><span class="status-dot" data-v-de0effed></span></section>', 1)),
        ...
        createBaseVNode("section", _hoisted_8, [
          _cache[30] || (_cache[30] = createBaseVNode("h3", { class: "legal-title" }, "关于 Mini-HBUT", -1)),
          createBaseVNode("div", _hoisted_9, [
            ...
            createBaseVNode("button", {
              ...
              createStaticVNode('<span class="privacy-policy-entry__icon" aria-hidden="true" data-v-de0effed><span class="material-symbols-outlined" data-v-de0effed>shield</span></span><span class="privacy-policy-entry__body" data-v-de0effed><span class="privacy-policy-entry__title" data-v-de0effed>隐私政策</span><span class="privacy-policy-entry__desc" data-v-de0effed>在系统浏览器中打开完整政策</span></span><span class="privacy-policy-entry__chev material-symbols-outlined" aria-hidden="true" data-v-de0effed>open_in_new</span>', 3)
            ])])
          ])
        ]),
        createBaseVNode("section", {
          ...
          _cache[33] || (_cache[33] = createBaseVNode("h3", { class: "legal-title" }, "免责声明与隐私政策", -1)),
          ...
          activeLegalTab.value === "disclaimer" ? (openBlock(), createElementBlock("div", _hoisted_13, [..._cache[31] || (_cache[31] = [
          ...
          ])])) : (openBlock(), createElementBlock("div", _hoisted_14, [..._cache[32] || (_cache[32] = [
            createStaticVNode("<p data-v-de0effed>我们仅收集提供服务所必需的数据，并采取合理措施保护数据安全。</p><ul data-v-de0effed><li data-v-de0effed><strong data-v-de0effed>收集内容</strong>：学号、登录会话信息、验证码参数、查询所需的临时授权信息。</li><li data-v-de0effed><strong data-v-de0effed>使用目的</strong>：用于身份验证、成绩/课表/电费等查询与展示。</li><li data-v-de0effed><strong data-v-de0effed>存储方式</strong>：本地会存储加密后的账号凭据与缓存数据；后端仅保存必要的会话与授权信息。</li><li data-v-de0effed><strong data-v-de0effed>数据共享</strong>：不会向无关第三方共享个人信息，除非获得你的明确授权或法律要求。</li><li data-v-de0effed><strong data-v-de0effed>数据保留</strong>：仅在实现功能所需期限内保留，可通过退出登录清理会话。</li></ul><p data-v-de0effed>继续使用即表示你已阅读并同意本隐私政策。</p>", 3)
          ])]))
        ], 512),
          ...
          default: withCtx(() => [
            showOpenSourceModal.value ? (openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", {
                ...
                _cache[36] || (_cache[36] = createBaseVNode("h3", null, [
                  createBaseVNode("span", { class: "material-symbols-outlined opensource-title-icon" }, "menu_book"),
                  createTextVNode(" 开源说明")
                ], -1)),
                _cache[37] || (_cache[37] = createBaseVNode("p", { class: "intro" }, "Mini-HBUT 是一个开源项目，致力于提供更好的校园信息查询体验。", -1)),
                createBaseVNode("div", { class: "section" }, [
                  _cache[35] || (_cache[35] = createBaseVNode("p", { class: "label" }, "项目地址", -1)),
                  createBaseVNode("a", {
                    class: "github-link",
                    onClick: openGithub
                  }, [..._cache[34] || (_cache[34] = [
                ...
                _cache[38] || (_cache[38] = createBaseVNode("div", { class: "section" }, [
                ...
                _cache[39] || (_cache[39] = createBaseVNode("div", { class: "section thanks" }, [
          ...
          default: withCtx(() => [
            showSponsorModal.value && showSponsorEntry.value ? (openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", {
                ...
                _cache[40] || (_cache[40] = createBaseVNode("h3", null, "❤️ 赞助支持", -1)),
                _cache[41] || (_cache[41] = createBaseVNode("p", { class: "intro" }, "如果 Mini-HBUT 对你有帮助，欢迎请作者喝杯咖啡 ☕", -1)),
                ...
                _cache[42] || (_cache[42] = createBaseVNode("p", { class: "sponsor-hint" }, "长按或截图扫码 · 微信赞赏", -1)),
...
const MeView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-de0effed"]]);
export {
  MeView as default
};
