import { r as ref, o as onMounted, l as onBeforeUnmount, v as watch, a as openBlock, c as createElementBlock, S as createStaticVNode, b as createBaseVNode, t as toDisplayString, F as Fragment, g as renderList, j as createBlock, k as withCtx, w as withModifiers, K as withDirectives, P as vModelCheckbox, d as createCommentVNode, p as createVNode, U as vModelSelect, n as normalizeClass, e as createTextVNode, u as unref, h as computed, C as nextTick } from "./vue-core-DPI62iBa.js";
import { _ as _imports_0 } from "./app_icon-BoqTJkLh.js";
import { q as getRuntime, e as platformBridge, a as isTauriRuntime, F as isAndroidLike, v as isIOSLike, d as invokeNative } from "./runtime-bridge-HjlgKupV.js";
import { _ as _export_sfc, c as cloneWorkspaceLayout, a5 as getLastNotifySnapshot, a6 as NOTIFY_SNAPSHOT_EVENT, a as useUiSettings, a7 as getNotificationMonitorSettings, h as buildDefaultWorkspaceLayout, e as flushUiSettings, a8 as runNotificationCheck, a9 as reconcileLocalReminders } from "./app-demo-BxokP0Ga.js";
import { f as fetchDormitoryDataset } from "./static_resource_cache-Nc-nnwFt.js";
import { _ as _sfc_main$1, L as LayoutCollisionFxLayer, d as resolveLayoutSlotTarget, e as captureLayoutSlotAnchors, r as resolveRelativeCollisionPoint, c as createLayoutCollisionBurst, m as moveLayoutItemToIndex, a as resolveCollisionPalette, b as advanceLayoutCollisionFx } from "./layout_collision_fx-C-O1ZrfZ.js";
...
const _hoisted_22 = { class: "notify-type-top" };
const _hoisted_23 = {
  key: 0,
  class: "layout-edit-bar"
};
const _hoisted_24 = { class: "sync-settings-card" };
const _hoisted_25 = { class: "sync-header" };
const _hoisted_26 = { class: "toggle-switch" };
const _hoisted_27 = { class: "sync-interval-row" };
const _hoisted_28 = { class: "sync-features-block" };
const _hoisted_29 = { class: "sync-feature-hint" };
const _hoisted_30 = { class: "action-buttons" };
const _hoisted_31 = ["disabled"];
const _hoisted_32 = ["disabled"];
const _hoisted_33 = { class: "recent-section" };
const _hoisted_34 = { class: "recent-header" };
const _hoisted_35 = { class: "recent-time" };
const _hoisted_36 = {
  key: 0,
  class: "notify-message-card unread"
};
const _hoisted_37 = { class: "notify-msg-left" };
const _hoisted_38 = { class: "notify-msg-body" };
const _hoisted_39 = { class: "notify-msg-head" };
const _hoisted_40 = { class: "notify-msg-time" };
const _hoisted_41 = { class: "notify-msg-text" };
const _hoisted_42 = {
  key: 0,
  class: "notify-detail-list"
};
const _hoisted_43 = { class: "detail-main" };
const _hoisted_44 = { class: "detail-sub" };
const _hoisted_45 = { class: "detail-score" };
const _hoisted_46 = {
  key: 1,
  class: "notify-message-card"
};
const _hoisted_47 = { class: "notify-msg-left" };
const _hoisted_48 = { class: "notify-msg-body" };
const _hoisted_49 = { class: "notify-msg-head" };
const _hoisted_50 = { class: "notify-msg-time" };
const _hoisted_51 = { class: "notify-msg-text" };
const _hoisted_52 = {
  key: 0,
  class: "notify-detail-kv"
};
const _hoisted_53 = { class: "kv-item" };
const _hoisted_54 = {
  key: 2,
  class: "notify-message-card"
};
const _hoisted_55 = { class: "notify-msg-left" };
const _hoisted_56 = { class: "notify-msg-body" };
const _hoisted_57 = { class: "notify-msg-head" };
const _hoisted_58 = { class: "notify-msg-time" };
const _hoisted_59 = { class: "notify-msg-text" };
const _hoisted_60 = { class: "notify-detail-list" };
const _hoisted_61 = { class: "detail-main" };
const _hoisted_62 = {
  key: 0,
  class: "tag-urgent"
};
const _hoisted_63 = { class: "detail-sub" };
...
const _hoisted_68 = { class: "notify-msg-left" };
const _hoisted_69 = { class: "notify-msg-body" };
const _hoisted_70 = { class: "notify-msg-head" };
const _hoisted_71 = { class: "notify-msg-time" };
const _hoisted_72 = { class: "notify-msg-text" };
const _hoisted_73 = {
  key: 0,
...
const _hoisted_75 = { class: "notify-msg-left" };
const _hoisted_76 = { class: "notify-msg-body" };
const _hoisted_77 = { class: "notify-msg-head" };
const _hoisted_78 = { class: "notify-msg-time" };
const _hoisted_79 = { class: "notify-msg-text" };
const _hoisted_80 = {
  key: 0,
...
const _hoisted_85 = { class: "notify-msg-time" };
const _hoisted_86 = { class: "notify-msg-text" };
const _hoisted_87 = {
  key: 0,
  class: "notify-msg-text warn"
};
...
const _hoisted_90 = { class: "status-pill soft" };
const _hoisted_91 = {
  key: 0,
  class: "status-msg"
};
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        _cache[52] || (_cache[52] = createStaticVNode('<header class="dashboard-header" data-v-ebb8f993><div class="header-left" data-v-ebb8f993><img class="logo-img" src="' + _imports_0 + '" alt="HBUT" data-v-ebb8f993><span class="header-title" data-v-ebb8f993>Mini-HBUT</span></div><span class="header-pill" data-v-ebb8f993>通知</span></header>', 1)),
        createBaseVNode("main", _hoisted_2, [
          createBaseVNode("section", _hoisted_3, [
            createBaseVNode("div", _hoisted_4, [
              _cache[14] || (_cache[14] = createBaseVNode("div", { class: "permission-icon-circle" }, [
          ...
          createBaseVNode("section", _hoisted_8, [
            _cache[33] || (_cache[33] = createBaseVNode("h3", { class: "section-heading" }, "通知类型设置", -1)),
            createBaseVNode("div", {
                  ...
                  default: withCtx(() => [
                    card.key === "grades" ? (openBlock(), createElementBlock("div", _hoisted_9, [
                      createBaseVNode("div", _hoisted_10, [
                        _cache[16] || (_cache[16] = createBaseVNode("div", { class: "notify-type-icon icon-accent" }, [
                        ...
                        createBaseVNode("label", {
                          ...
                          _cache[15] || (_cache[15] = createBaseVNode("span", { class: "toggle-track" }, null, -1))
                        ])
                      ]),
                      _cache[17] || (_cache[17] = createBaseVNode("div", { class: "notify-type-body" }, [
                    ...
                    card.key === "exams" ? (openBlock(), createElementBlock("div", _hoisted_11, [
                      ...
                      _cache[20] || (_cache[20] = createBaseVNode("div", { class: "notify-type-body" }, [
                    ...
                    card.key === "electricity" ? (openBlock(), createElementBlock("div", _hoisted_13, [
                      createBaseVNode("div", _hoisted_14, [
                        _cache[22] || (_cache[22] = createBaseVNode("div", { class: "notify-type-icon icon-teal" }, [
                        ...
                        createBaseVNode("label", {
                          ...
                          _cache[21] || (_cache[21] = createBaseVNode("span", { class: "toggle-track" }, null, -1))
                        ])
                      ]),
                      _cache[23] || (_cache[23] = createBaseVNode("div", { class: "notify-type-body" }, [
                    ...
                    card.key === "class_reminder" ? (openBlock(), createElementBlock("div", _hoisted_15, [
                      createBaseVNode("div", _hoisted_16, [
                        _cache[25] || (_cache[25] = createBaseVNode("div", { class: "notify-type-icon icon-sky" }, [
                      ...
                      createBaseVNode("div", _hoisted_17, [
                        _cache[26] || (_cache[26] = createBaseVNode("h4", { class: "notify-type-name" }, "上课提醒", -1)),
                    ...
                    card.key === "school_inbox" ? (openBlock(), createElementBlock("div", _hoisted_19, [
                      createBaseVNode("div", _hoisted_20, [
                        _cache[28] || (_cache[28] = createBaseVNode("div", { class: "notify-type-icon icon-indigo" }, [
                        ...
                        createBaseVNode("label", {
                          ...
                          _cache[27] || (_cache[27] = createBaseVNode("span", { class: "toggle-track" }, null, -1))
                        ])
                      ]),
                      _cache[29] || (_cache[29] = createBaseVNode("div", { class: "notify-type-body" }, [
                        createBaseVNode("h4", { class: "notify-type-name" }, "学校消息"),
                        createBaseVNode("p", { class: "notify-type-desc" }, "教务/学习通消息中心新通知")
                      ], -1))
                    ])) : createCommentVNode("", true),
                    card.key === "chaoxing_inbox" ? (openBlock(), createElementBlock("div", _hoisted_21, [
                      createBaseVNode("div", _hoisted_22, [
                        _cache[31] || (_cache[31] = createBaseVNode("div", { class: "notify-type-icon icon-teal" }, [
                        ...
                        createBaseVNode("label", {
                          ...
                          _cache[30] || (_cache[30] = createBaseVNode("span", { class: "toggle-track" }, null, -1))
                        ])
                      ]),
                      _cache[32] || (_cache[32] = createBaseVNode("div", { class: "notify-type-body" }, [
                        createBaseVNode("h4", { class: "notify-type-name" }, "学习通通知"),
                        createBaseVNode("p", { class: "notify-type-desc" }, "学习通收件箱新消息，与学校消息分开提醒")
                      ], -1))
                    ])) : createCommentVNode("", true)
                  ]),
                  _: 2
            ...
            isNotificationLayoutEditing.value ? (openBlock(), createElementBlock("div", _hoisted_23, [
              createBaseVNode("button", {
          ...
          createBaseVNode("section", _hoisted_24, [
            createBaseVNode("div", _hoisted_25, [
              _cache[35] || (_cache[35] = createBaseVNode("div", { class: "sync-header-left" }, [
              ...
              createBaseVNode("label", _hoisted_26, [
                ...
                _cache[34] || (_cache[34] = createBaseVNode("span", { class: "toggle-track" }, null, -1))
              ])
            ]),
            createBaseVNode("div", _hoisted_27, [
              _cache[37] || (_cache[37] = createBaseVNode("span", { class: "sync-interval-label" }, "检查间隔", -1)),
            ...
            createBaseVNode("div", _hoisted_28, [
              createBaseVNode("p", _hoisted_29, "后台检测状态：" + toDisplayString(bgFeatureStatusText.value), 1)
            ])
          ]),
          createBaseVNode("section", _hoisted_30, [
            ...
            }, toDisplayString(checking.value ? "检查中..." : "立即检查一次"), 9, _hoisted_31),
            createBaseVNode("button", {
              class: "action-btn secondary",
              disabled: sending.value,
              onClick: handleTestNotification
            }, toDisplayString(sending.value ? "发送中..." : "发送测试通知"), 9, _hoisted_32)
          ]),
          createBaseVNode("section", _hoisted_33, [
            createBaseVNode("div", _hoisted_34, [
              _cache[38] || (_cache[38] = createBaseVNode("h3", { class: "section-heading" }, "近期消息", -1)),
              createBaseVNode("span", _hoisted_35, toDisplayString(lastCheckText.value), 1)
            ]),
            gradeItems.value.length ? (openBlock(), createElementBlock("div", _hoisted_36, [
              createBaseVNode("div", _hoisted_37, [
                _cache[39] || (_cache[39] = createBaseVNode("div", { class: "notify-msg-icon icon-accent" }, [
                  createBaseVNode("span", { class: "material-symbols-outlined fill" }, "school")
                ], -1)),
                createBaseVNode("div", _hoisted_38, [
                  createBaseVNode("div", _hoisted_39, [
                    ...
                    createBaseVNode("span", _hoisted_40, toDisplayString(lastCheckText.value), 1)
                  ]),
                  createBaseVNode("p", _hoisted_41, "总成绩 " + toDisplayString(gradeSummary.value?.total || 0) + " 条 · 本次" + toDisplayString(gradeSummary.value?.changed ? "有变化" : "无变化"), 1),
                  gradeItems.value.length ? (openBlock(), createElementBlock("ul", _hoisted_42, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(gradeItems.value.slice(0, 3), (item, idx) => {
                      return openBlock(), createElementBlock("li", {
                        key: `grade-${idx}`,
                        class: "detail-row"
                      }, [
                        createBaseVNode("span", _hoisted_43, toDisplayString(item.course_name || "-"), 1),
                        createBaseVNode("span", _hoisted_44, [
                          createBaseVNode("span", null, toDisplayString(item.term || "未知学期"), 1),
                          createBaseVNode("span", _hoisted_45, toDisplayString(item.final_score || "-"), 1)
                        ])
                      ]);
                    }), 128))
                  ])) : createCommentVNode("", true)
            ...
            classSummary.value?.enabled ? (openBlock(), createElementBlock("div", _hoisted_46, [
              createBaseVNode("div", _hoisted_47, [
                _cache[42] || (_cache[42] = createBaseVNode("div", { class: "notify-msg-icon icon-sky" }, [
                  createBaseVNode("span", { class: "material-symbols-outlined fill" }, "schedule")
                ], -1)),
                createBaseVNode("div", _hoisted_48, [
                  createBaseVNode("div", _hoisted_49, [
                    _cache[40] || (_cache[40] = createBaseVNode("h4", { class: "notify-msg-title" }, "上课提醒", -1)),
                    createBaseVNode("span", _hoisted_50, toDisplayString(classReminderText.value), 1)
                  ]),
                  createBaseVNode("p", _hoisted_51, toDisplayString(nextClassText.value), 1),
                  classSummary.value?.nextCourse?.name ? (openBlock(), createElementBlock("div", _hoisted_52, [
                    createBaseVNode("span", _hoisted_53, [
                      _cache[41] || (_cache[41] = createBaseVNode("span", { class: "material-symbols-outlined mini-icon" }, "alarm", -1)),
            ...
            examItems.value.length ? (openBlock(), createElementBlock("div", _hoisted_54, [
              createBaseVNode("div", _hoisted_55, [
                _cache[44] || (_cache[44] = createBaseVNode("div", { class: "notify-msg-icon icon-orange" }, [
                  createBaseVNode("span", { class: "material-symbols-outlined fill" }, "edit_document")
                ], -1)),
                createBaseVNode("div", _hoisted_56, [
                  createBaseVNode("div", _hoisted_57, [
                    _cache[43] || (_cache[43] = createBaseVNode("h4", { class: "notify-msg-title" }, "考试安排", -1)),
                    createBaseVNode("span", _hoisted_58, toDisplayString(examSummary.value?.tomorrowCount ? "明日有考试" : ""), 1)
                  ]),
                  createBaseVNode("p", _hoisted_59, "近期 " + toDisplayString(examItems.value.length) + " 门 · 明日 " + toDisplayString(examSummary.value?.tomorrowCount || 0) + " 门", 1),
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(examItems.value.slice(0, 3), (item, idx) => {
                      return openBlock(), createElementBlock("li", {
                        ...
                        createBaseVNode("span", _hoisted_61, [
                          ...
                          item.is_tomorrow ? (openBlock(), createElementBlock("small", _hoisted_62, "明日")) : createCommentVNode("", true)
                        ]),
                        createBaseVNode("span", _hoisted_63, [
                          item.exam_date ? (openBlock(), createElementBlock("span", _hoisted_64, toDisplayString(item.exam_date), 1)) : createCommentVNode("", true),
                          item.exam_time ? (openBlock(), createElementBlock("span", _hoisted_65, toDisplayString(formatNotifyExamTime(item.exam_time)), 1)) : createCommentVNode("", true),
                          item.location ? (openBlock(), createElementBlock("span", _hoisted_66, toDisplayString(item.location), 1)) : createCommentVNode("", true)
                        ])
                      ]);
                    }), 128))
                  ])
            ...
            powerSummary.value?.quantity != null ? (openBlock(), createElementBlock("div", _hoisted_67, [
              createBaseVNode("div", _hoisted_68, [
                _cache[46] || (_cache[46] = createBaseVNode("div", { class: "notify-msg-icon icon-teal" }, [
                  createBaseVNode("span", { class: "material-symbols-outlined fill" }, "bolt")
                ], -1)),
                createBaseVNode("div", _hoisted_69, [
                  createBaseVNode("div", _hoisted_70, [
                    _cache[45] || (_cache[45] = createBaseVNode("h4", { class: "notify-msg-title" }, "电费监控", -1)),
                    createBaseVNode("span", _hoisted_71, toDisplayString(powerStatusText.value), 1)
                  ]),
                  createBaseVNode("p", _hoisted_72, "剩余电量：" + toDisplayString(powerQuantityText.value), 1),
                  powerSummary.value?.isDual ? (openBlock(), createElementBlock("p", _hoisted_73, "空调电量：" + toDisplayString(acPowerQuantityText.value), 1)) : createCommentVNode("", true)
                ])
              ])
            ])) : createCommentVNode("", true),
            schoolInboxSummary.value?.enabled ? (openBlock(), createElementBlock("div", _hoisted_74, [
              createBaseVNode("div", _hoisted_75, [
                _cache[47] || (_cache[47] = createBaseVNode("div", { class: "notify-msg-icon icon-indigo" }, [
                  createBaseVNode("span", { class: "material-symbols-outlined fill" }, "mail")
                ], -1)),
                createBaseVNode("div", _hoisted_76, [
                  createBaseVNode("div", _hoisted_77, [
                    ...
                    createBaseVNode("span", _hoisted_78, toDisplayString(lastCheckText.value), 1)
                  ]),
                  ...
                  schoolInboxSummary.value?.error ? (openBlock(), createElementBlock("p", _hoisted_80, toDisplayString(schoolInboxSummary.value.error), 1)) : createCommentVNode("", true)
                ])
              ])
            ])) : createCommentVNode("", true),
            chaoxingInboxSummary.value?.enabled ? (openBlock(), createElementBlock("div", _hoisted_81, [
              createBaseVNode("div", _hoisted_82, [
                _cache[48] || (_cache[48] = createBaseVNode("div", { class: "notify-msg-icon icon-teal" }, [
                  createBaseVNode("span", { class: "material-symbols-outlined fill" }, "mark_email_unread")
                ], -1)),
                createBaseVNode("div", _hoisted_83, [
                  createBaseVNode("div", _hoisted_84, [
                    ...
                    }, toDisplayString(chaoxingInboxSummary.value?.triggered > 0 ? "新学习通通知" : "学习通通知"), 3),
                    createBaseVNode("span", _hoisted_85, toDisplayString(lastCheckText.value), 1)
                  ]),
                  createBaseVNode("p", _hoisted_86, " 共 " + toDisplayString(chaoxingInboxSummary.value?.total || 0) + " 条 · 本次新增 " + toDisplayString(chaoxingInboxSummary.value?.triggered || 0) + " 条 ", 1),
                  chaoxingInboxSummary.value?.error ? (openBlock(), createElementBlock("p", _hoisted_87, toDisplayString(chaoxingInboxSummary.value.error), 1)) : createCommentVNode("", true)
                ])
              ])
            ])) : createCommentVNode("", true),
            _cache[49] || (_cache[49] = createBaseVNode("div", { class: "notify-end-hint" }, "长按卡片进入管理模式", -1))
          ]),
          enableBackground.value ? (openBlock(), createElementBlock("div", _hoisted_88, [
            currentRuntime.value === "tauri" && !unref(isAndroidLike)() && !unref(isIOSLike)() ? (openBlock(), createElementBlock("span", _hoisted_89, "保活：" + toDisplayString(backgroundLockStatusText.value), 1)) : createCommentVNode("", true),
            createBaseVNode("span", _hoisted_90, "调度：" + toDisplayString(bgFeatureStatusText.value), 1)
          ])) : createCommentVNode("", true)
        ]),
        statusMessage.value ? (openBlock(), createElementBlock("p", _hoisted_91, toDisplayString(statusMessage.value), 1)) : createCommentVNode("", true),
        lastError.value ? (openBlock(), createElementBlock("p", _hoisted_92, "错误详情：" + toDisplayString(lastError.value), 1)) : createCommentVNode("", true),
        showBatteryPrompt.value ? (openBlock(), createElementBlock("div", _hoisted_93, [
          createBaseVNode("div", { class: "modal-card" }, [
            _cache[50] || (_cache[50] = createBaseVNode("h3", null, "电池优化提示", -1)),
            _cache[51] || (_cache[51] = createBaseVNode("p", null, "Android 建议将本应用加入后台白名单，避免系统回收后无法按时通知。", -1)),
...
const NotificationView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ebb8f993"]]);
export {
