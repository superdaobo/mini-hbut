...
import { a as isTauriRuntime, c as isCapacitorRuntime, _ as __vitePreload, d as invokeNative } from "./runtime-bridge-BU9jeOXP.js";
import { o as onMounted, a as openBlock, c as createElementBlock, b as createBaseVNode, R as createStaticVNode, t as toDisplayString, F as Fragment, g as renderList, n as normalizeClass, J as withDirectives, O as vModelCheckbox, d as createCommentVNode, e as createTextVNode, h as computed, r as ref, C as nextTick } from "./vue-core-DWoFi2CM.js";
import { _ as _export_sfc, f as fetchWithCache, b as axiosInstance, n as normalizeSemesterList, j as resolveCurrentSemester } from "./app-demo-Bca6_3ab.js";
  ...
  setup(__props, { emit: __emit }) {
    ...
    const saveByCapacitor = async (fileName, blob) => {
      const { Filesystem, Directory } = await __vitePreload(async () => {
        const { Filesystem: Filesystem2, Directory: Directory2 } = await import("./runtime-bridge-BU9jeOXP.js").then((n) => n.ab);
      ...
      const { Share } = await __vitePreload(async () => {
        const { Share: Share2 } = await import("./runtime-bridge-BU9jeOXP.js").then((n) => n.ac);
        return { Share: Share2 };
      }, true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
      await Share.share({
        title: fileName,
