...
import { s as detectRuntime, a as isTauriRuntime, _ as __vitePreload, b as isLikelyAndroidUserAgent, a0 as isLikelyIOSUserAgent, a1 as isTauriDesktopRuntime } from "./runtime-bridge-i9KZPKjs.js";
  ...
  if (canUseTauriEmbeddedWebview()) {
    try {
      const { getCurrentWindow } = await __vitePreload(async () => {
        const { getCurrentWindow: getCurrentWindow2 } = await import("./runtime-bridge-i9KZPKjs.js").then((n) => n.ab);
...
const forceCloseSchoolWebsiteEmbed = async () => {
  ...
  try {
    const { pushDebugLog } = await __vitePreload(async () => {
      const { pushDebugLog: pushDebugLog2 } = await import("./runtime-bridge-i9KZPKjs.js").then((n) => n.a6);
...
const invokeNative = async (command, args) => {
  const core = await __vitePreload(() => import("./runtime-bridge-i9KZPKjs.js").then((n) => n.a9), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
