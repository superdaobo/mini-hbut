const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./school_website_embed-Ule5f9Bg.js","./runtime-bridge-Ds80RevU.js","./more-modules-DDZK9iEH.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, D as isAndroidLike } from "./runtime-bridge-Ds80RevU.js";
import { _ as _export_sfc, o as openExternal } from "./app-demo-B5kEWRyP.js";
import { forceCloseSchoolWebsiteEmbed, resolveSchoolWebsiteEmbedMode, mountSchoolWebsiteEmbed, SCHOOL_WEBSITE_URL, resolveSchoolWebsiteIframeUrl } from "./school_website_embed-Ule5f9Bg.js";
import { o as onMounted, G as nextTick, l as onBeforeUnmount, a as openBlock, c as createElementBlock, b as createBaseVNode, d as createCommentVNode, t as toDisplayString, r as ref, h as computed } from "./vue-core-C6WYunHF.js";
    ...
    const remountAfterResume = async (eventDetail = null) => {
      ...
      try {
        const { recoverSchoolWebsiteBridgeOnResume } = await __vitePreload(async () => {
          const { recoverSchoolWebsiteBridgeOnResume: recoverSchoolWebsiteBridgeOnResume2 } = await import("./school_website_embed-Ule5f9Bg.js");
...
const SchoolWebsiteView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0f1add38"]]);
export {
