import { _ as _export_sfc, u as useLocale, aR as normalizeModuleCenterChannel, aS as buildModuleCenterCards, a7 as fetchRemoteConfig, aT as trackModuleOpen, av as getCloudSyncRuntimeConfig } from "./app-demo-BO0WKfcf.js";
import { T as TStatusBadge } from "./TStatusBadge-1we4woQ_.js";
import { t as resolveModuleChannel, u as fetchModuleCatalog, v as getLocalModuleState, w as fetchModuleManifest, x as deleteModuleState, y as deleteCachedManifestSnapshot, z as prepareModuleBundle, r as resolveModuleHostPreviewSource, d as canUseLocalModuleBridgePreview, e as isLocalModuleBridgePreviewUrl } from "./more-modules-DiLNQOO4.js";
import { a as isTauriRuntime, d as invokeNative } from "./runtime-bridge-BDjl3Bnt.js";
import { o as onMounted, a as openBlock, c as createElementBlock, b as createBaseVNode, t as toDisplayString, u as unref, n as normalizeClass, U as createStaticVNode, F as Fragment, f as renderList, p as createVNode, d as createCommentVNode, r as ref, h as computed } from "./vue-core-Dzs4fLAU.js";
...
const _hoisted_4 = { class: "font-bold text-lg tracking-wide text-gray-800" };
const _hoisted_5 = ["disabled"];
const _hoisted_6 = { class: "px-4 space-y-5 pb-6" };
const _hoisted_7 = { class: "grid grid-cols-2 gap-3" };
const _hoisted_8 = ["data-module-id", "disabled", "onClick"];
const _hoisted_9 = { class: "flex justify-between items-center mb-2" };
const _hoisted_10 = { class: "w-9 h-9 rounded-xl bg-blue-50 flex items-center justify-center text-lg" };
const _hoisted_11 = { class: "min-h-[52px]" };
const _hoisted_12 = { class: "block text-sm font-bold text-gray-800" };
const _hoisted_13 = { class: "text-xs text-gray-500 mt-1 line-clamp-2 leading-relaxed" };
const _hoisted_14 = { class: "mt-2 pt-2 border-t border-gray-100" };
const _hoisted_15 = { class: "text-[11px] text-gray-400" };
const _hoisted_16 = { class: "block text-[11px] text-gray-400 mt-0.5" };
const _hoisted_17 = {
  key: 0,
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("header", _hoisted_2, [
          ...
          createBaseVNode("div", _hoisted_3, [
            _cache[2] || (_cache[2] = createBaseVNode("div", { class: "w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center" }, [
              createBaseVNode("span", { class: "text-lg" }, "🧩")
            ], -1)),
            createBaseVNode("span", _hoisted_4, toDisplayString(unref(t)("more.title")), 1)
          ]),
          createBaseVNode("button", {
            ...
            createStaticVNode('<svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-7744dd4b><path d="M23 4v6h-6" data-v-7744dd4b></path><path d="M1 20v-6h6" data-v-7744dd4b></path><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10" data-v-7744dd4b></path><path d="M20.49 15a9 9 0 0 1-14.85 3.36L1 14" data-v-7744dd4b></path></svg>', 1)
          ])], 10, _hoisted_5)
        ]),
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(moduleCards.value, (item) => {
              return openBlock(), createElementBlock("button", {
                ...
                createBaseVNode("div", _hoisted_9, [
                  createBaseVNode("span", _hoisted_10, toDisplayString(item.icon || "📦"), 1),
                ...
                createBaseVNode("div", _hoisted_11, [
                  createBaseVNode("strong", _hoisted_12, toDisplayString(item.name), 1),
                  createBaseVNode("p", _hoisted_13, toDisplayString(item.description || unref(t)("more.descMissing")), 1)
                ]),
                createBaseVNode("div", _hoisted_14, [
                  createBaseVNode("span", _hoisted_15, toDisplayString(resolveModuleMetaLine(readModuleState(item.id))), 1),
                  createBaseVNode("small", _hoisted_16, toDisplayString(resolveModuleDetailLine(readModuleState(item.id))), 1)
                ])
              ], 8, _hoisted_8);
            }), 128))
          ]),
          moduleError.value ? (openBlock(), createElementBlock("p", _hoisted_17, toDisplayString(moduleError.value), 1)) : createCommentVNode("", true),
          moduleLoading.value ? (openBlock(), createElementBlock("div", _hoisted_18, toDisplayString(unref(t)("more.loading")), 1)) : createCommentVNode("", true)
        ])
      ]);
    };
  }
};
const MoreView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7744dd4b"]]);
export {
  MoreView as default
};
