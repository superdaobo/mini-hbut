import { _ as _export_sfc, b as axiosInstance } from "./app-demo-BxokP0Ga.js";
import { T as TEmptyState } from "./TEmptyState-BDwp3cnC.js";
import { M as resolveComponent, a as openBlock, c as createElementBlock, b as createBaseVNode, t as toDisplayString, F as Fragment, e as createTextVNode, K as withDirectives, L as vModelText, p as createVNode, k as withCtx, g as renderList, d as createCommentVNode, j as createBlock, n as normalizeClass, w as withModifiers, P as vModelCheckbox, s as Teleport, T as Transition, o as onMounted, l as onBeforeUnmount, r as ref, h as computed } from "./vue-core-DPI62iBa.js";
...
const _hoisted_11 = { class: "filter-card glass-card" };
const _hoisted_12 = { class: "filter-header" };
const _hoisted_13 = { class: "filter-actions" };
const _hoisted_14 = ["disabled"];
const _hoisted_15 = { class: "filter-grid compact-grid" };
const _hoisted_16 = { class: "field span-2" };
...
const _hoisted_24 = { class: "filter-grid advanced-grid" };
...
const _hoisted_31 = { class: "batch-card glass-card" };
...
const _hoisted_35 = { class: "result-block" };
const _hoisted_36 = {
  key: 2,
  class: "course-list"
};
const _hoisted_37 = ["onClick"];
const _hoisted_38 = { class: "course-top" };
const _hoisted_39 = { class: "course-name" };
const _hoisted_40 = { class: "course-class" };
const _hoisted_41 = { class: "course-top-right" };
const _hoisted_42 = {
  key: 0,
  class: "meta-chip conflict-meta-pill"
};
const _hoisted_43 = { class: "course-credit" };
const _hoisted_44 = { class: "course-meta-row" };
const _hoisted_45 = { class: "meta-chip teacher-chip" };
const _hoisted_46 = {
  key: 0,
...
const _hoisted_48 = { class: "course-footer-row" };
const _hoisted_49 = { class: "course-meta-row secondary compact" };
const _hoisted_50 = { class: "meta-chip" };
const _hoisted_51 = ["disabled", "onClick"];
const _hoisted_52 = ["disabled", "onClick"];
const _hoisted_53 = { class: "filter-card glass-card" };
const _hoisted_54 = { class: "filter-header" };
const _hoisted_55 = { class: "filter-actions" };
const _hoisted_56 = ["disabled"];
const _hoisted_57 = { class: "filter-grid info-base-grid" };
const _hoisted_58 = { class: "field" };
const _hoisted_59 = ["value"];
const _hoisted_60 = { class: "filter-grid compact-grid" };
const _hoisted_61 = { class: "field span-2" };
const _hoisted_62 = { class: "field" };
const _hoisted_63 = { class: "filter-grid advanced-grid" };
...
const _hoisted_70 = { class: "info-toggle-row" };
const _hoisted_71 = { class: "info-toggle-check" };
const _hoisted_72 = { class: "result-block" };
const _hoisted_73 = {
  key: 0,
  class: "info-source-tip"
};
const _hoisted_74 = { class: "course-list" };
const _hoisted_75 = ["onClick"];
const _hoisted_76 = { class: "course-top" };
const _hoisted_77 = { class: "course-name" };
const _hoisted_78 = { class: "course-class" };
const _hoisted_79 = { class: "course-top-right" };
const _hoisted_80 = { class: "meta-chip success-meta-pill" };
const _hoisted_81 = { class: "course-credit" };
const _hoisted_82 = { class: "course-meta-row" };
const _hoisted_83 = { class: "meta-chip teacher-chip" };
const _hoisted_84 = {
  key: 0,
  class: "meta-chip online-pill"
};
...
const _hoisted_86 = { class: "course-meta-row secondary compact" };
const _hoisted_87 = { class: "meta-chip" };
const _hoisted_88 = { class: "meta-chip" };
const _hoisted_89 = { class: "modal-header" };
const _hoisted_90 = { class: "modal-title" };
const _hoisted_91 = { class: "modal-subtitle" };
const _hoisted_92 = { class: "detail-badges" };
const _hoisted_93 = {
  key: 0,
  class: "meta-chip online-pill"
};
const _hoisted_94 = { class: "detail-grid" };
const _hoisted_95 = { class: "detail-label" };
const _hoisted_96 = { class: "detail-value" };
const _hoisted_97 = { class: "detail-section" };
const _hoisted_98 = { class: "detail-paragraph" };
const _hoisted_99 = { class: "detail-section" };
const _hoisted_100 = { class: "detail-paragraph" };
const _hoisted_101 = {
  key: 0,
  class: "detail-loading"
};
const _hoisted_102 = { class: "modal-header" };
const _hoisted_103 = { class: "modal-subtitle" };
const _hoisted_104 = { class: "child-class-list" };
const _hoisted_105 = ["onClick"];
const _hoisted_106 = { class: "child-class-name" };
const _hoisted_107 = { class: "child-class-meta" };
const _hoisted_108 = { class: "child-class-meta" };
const _hoisted_109 = { class: "confirm-actions" };
const _hoisted_110 = ["disabled"];
const _hoisted_111 = { class: "modal-title" };
const _hoisted_112 = { class: "detail-paragraph" };
const _hoisted_113 = { class: "confirm-actions" };
    ...
    createBaseVNode("div", _hoisted_10, [
      $setup.centerMode === $setup.ENTRY_MODE_MENU ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
        _cache[28] || (_cache[28] = createBaseVNode("div", {
          ...
          createTextVNode(" 🧪 "),
          createBaseVNode("strong", null, "功能提示"),
          createTextVNode("：本功能目前处于测试阶段，可能无法正常使用。如需保证选课完整可靠，请前往教务系统或学习通自行选课。一切选课结果与标准，均以教务系统和学习通为准。 ")
        ], -1)),
        createBaseVNode("div", { class: "entry-grid" }, [
          createBaseVNode("button", {
            type: "button",
        ...
        createBaseVNode("div", _hoisted_11, [
          createBaseVNode("div", _hoisted_12, [
            ...
            createBaseVNode("div", _hoisted_13, [
              ...
              }, toDisplayString($setup.showAdvanced ? "收起筛选" : "展开筛选"), 1),
              createBaseVNode("button", {
                class: "primary-btn",
                type: "button",
          ...
          $setup.showAdvanced ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            createBaseVNode("div", _hoisted_15, [
              createBaseVNode("div", _hoisted_16, [
                _cache[30] || (_cache[30] = createBaseVNode("label", null, "课程名称", -1)),
              ...
              createBaseVNode("div", _hoisted_17, [
                _cache[31] || (_cache[31] = createBaseVNode("label", null, "课程性质", -1)),
              ...
              createBaseVNode("div", _hoisted_19, [
                _cache[32] || (_cache[32] = createBaseVNode("label", null, "课程归属", -1)),
                createVNode(_component_IOSSelect, {
                  ...
                  default: withCtx(() => [
                    (openBlock(true), createElementBlock(Fragment, null, renderList($setup.optionMaps.kcgs, (item) => {
                      return openBlock(), createElementBlock("option", {
                        ...
                        value: item.value
                      }, toDisplayString(item.label), 9, _hoisted_20);
                    }), 128))
                  ]),
                  _: 1
                }, 8, ["modelValue"])
              ...
              createBaseVNode("div", _hoisted_21, [
                _cache[33] || (_cache[33] = createBaseVNode("label", null, "教学模式", -1)),
                createVNode(_component_IOSSelect, {
              ...
              createBaseVNode("div", _hoisted_23, [
                _cache[34] || (_cache[34] = createBaseVNode("label", null, "教师", -1)),
                withDirectives(createBaseVNode("input", {
            ...
            createBaseVNode("div", _hoisted_24, [
              createBaseVNode("div", _hoisted_25, [
                _cache[35] || (_cache[35] = createBaseVNode("label", null, "上课校区", -1)),
                createVNode(_component_IOSSelect, {
              ...
              createBaseVNode("div", _hoisted_27, [
                _cache[36] || (_cache[36] = createBaseVNode("label", null, "课程类别", -1)),
                createVNode(_component_IOSSelect, {
              ...
              createBaseVNode("div", _hoisted_29, [
                _cache[37] || (_cache[37] = createBaseVNode("label", null, "课程类型", -1)),
                createVNode(_component_IOSSelect, {
        ...
        createBaseVNode("div", _hoisted_31, [
          createBaseVNode("div", _hoisted_32, [
            createBaseVNode("div", null, [
              _cache[38] || (_cache[38] = createBaseVNode("h3", null, "选课批次", -1)),
              createBaseVNode("p", null, toDisplayString($setup.cleanMessage($setup.overview?.message) || "从教务系统中选择当前开放的选课批次"), 1)
            ])
          ]),
          $setup.tabs.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_33, [
            createVNode(_component_IOSSelect, {
              ...
              default: withCtx(() => [
                (openBlock(true), createElementBlock(Fragment, null, renderList($setup.tabs, (tab) => {
                  return openBlock(), createElementBlock("option", {
                    key: tab.xkgzid,
                    value: tab.xkgzid
                  }, toDisplayString(tab.xkgzMc || "未命名批次"), 9, _hoisted_34);
                }), 128))
              ]),
              _: 1
            }, 8, ["model-value"])
            ...
            default: withCtx(() => [
              createBaseVNode("p", null, toDisplayString($setup.overviewError || $setup.cleanMessage($setup.overview?.message) || "当前暂无选课批次"), 1)
            ]),
            _: 1
          }))
        ]),
        createBaseVNode("div", _hoisted_35, [
          $setup.loadingOverview || $setup.loadingList ? (openBlock(), createBlock($setup["TEmptyState"], {
            ...
            type: "loading",
            message: "正在同步选课数据..."
          })) : !$setup.canShowList || $setup.courses.length === 0 ? (openBlock(), createBlock($setup["TEmptyState"], {
            key: 1,
            message: $setup.emptyHint
          }, null, 8, ["message"])) : (openBlock(), createElementBlock("div", _hoisted_36, [
            (openBlock(true), createElementBlock(Fragment, null, renderList($setup.courses, (course) => {
              return openBlock(), createElementBlock("button", {
                ...
                createBaseVNode("div", _hoisted_38, [
                  createBaseVNode("div", null, [
                    createBaseVNode("div", _hoisted_39, toDisplayString(course.kcmc || "未命名课程"), 1),
                    createBaseVNode("div", _hoisted_40, toDisplayString(course.jxbmcDisplay || course.jxbmc || "未命名教学班"), 1)
                  ]),
                  createBaseVNode("div", _hoisted_41, [
                    course.isConflict ? (openBlock(), createElementBlock("span", _hoisted_42, "冲突")) : createCommentVNode("", true),
                    createBaseVNode("div", _hoisted_43, toDisplayString(course.xf || "--") + " 学分", 1)
                  ])
                ]),
                createBaseVNode("div", _hoisted_44, [
                  createBaseVNode("span", _hoisted_45, toDisplayString(course.teacher || "待定教师"), 1),
                  course.isOnline ? (openBlock(), createElementBlock("span", _hoisted_46, "网课")) : (openBlock(), createElementBlock("span", _hoisted_47, toDisplayString(course.scheduleText || "未公布时间地点"), 1))
                ]),
                createBaseVNode("div", _hoisted_48, [
                  createBaseVNode("div", _hoisted_49, [
                    createBaseVNode("span", _hoisted_50, "容量 " + toDisplayString(course.capacity.display), 1),
                  ...
                  createBaseVNode("div", {
                    ...
                    }, toDisplayString($setup.selectingCourseId === course.id ? "提交中..." : "选课"), 9, _hoisted_51)) : (openBlock(), createElementBlock("button", {
                      key: 1,
                      class: "action-btn danger",
                      type: "button",
                      disabled: $setup.withdrawingCourseId === course.id,
                      onClick: ($event) => $setup.openWithdrawConfirm(course)
                    }, toDisplayString($setup.withdrawingCourseId === course.id ? "处理中..." : "退课"), 9, _hoisted_52))
                  ])
                ])
              ], 8, _hoisted_37);
            }), 128))
        ...
        createBaseVNode("div", _hoisted_53, [
          createBaseVNode("div", _hoisted_54, [
            ...
            createBaseVNode("div", _hoisted_55, [
              ...
              }, toDisplayString($setup.infoShowAdvanced ? "收起筛选" : "展开筛选"), 1),
              createBaseVNode("button", {
                class: "primary-btn",
                type: "button",
          ...
          createBaseVNode("div", _hoisted_57, [
            createBaseVNode("div", _hoisted_58, [
              _cache[40] || (_cache[40] = createBaseVNode("label", null, "当前学期", -1)),
              createVNode(_component_IOSSelect, {
                ...
                default: withCtx(() => [
                  (openBlock(true), createElementBlock(Fragment, null, renderList($setup.infoOptions.term, (item) => {
                    return openBlock(), createElementBlock("option", {
                      ...
                      value: item.value
                    }, toDisplayString(item.label), 9, _hoisted_59);
                  }), 128))
                ]),
                _: 1
              }, 8, ["modelValue"])
          ...
          $setup.infoShowAdvanced ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            createBaseVNode("div", _hoisted_60, [
              createBaseVNode("div", _hoisted_61, [
                _cache[41] || (_cache[41] = createBaseVNode("label", null, "课程名称", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", _hoisted_62, [
                _cache[42] || (_cache[42] = createBaseVNode("label", null, "授课教师", -1)),
                withDirectives(createBaseVNode("input", {
            ...
            createBaseVNode("div", _hoisted_63, [
              createBaseVNode("div", _hoisted_64, [
                _cache[43] || (_cache[43] = createBaseVNode("label", null, "课程性质", -1)),
                createVNode(_component_IOSSelect, {
                  ...
                  default: withCtx(() => [
                    (openBlock(true), createElementBlock(Fragment, null, renderList($setup.infoOptions.kcxz, (item) => {
                      return openBlock(), createElementBlock("option", {
                        ...
                        value: item.value
                      }, toDisplayString(item.label), 9, _hoisted_65);
                    }), 128))
                  ]),
                  _: 1
                }, 8, ["modelValue"])
              ...
              createBaseVNode("div", _hoisted_66, [
                _cache[44] || (_cache[44] = createBaseVNode("label", null, "课程类型", -1)),
                createVNode(_component_IOSSelect, {
                  ...
                  default: withCtx(() => [
                    (openBlock(true), createElementBlock(Fragment, null, renderList($setup.infoOptions.kclx, (item) => {
                      return openBlock(), createElementBlock("option", {
                        ...
                        value: item.value
                      }, toDisplayString(item.label), 9, _hoisted_67);
                    }), 128))
                  ]),
                  _: 1
                }, 8, ["modelValue"])
              ...
              createBaseVNode("div", _hoisted_68, [
                _cache[45] || (_cache[45] = createBaseVNode("label", null, "选课方式", -1)),
                createVNode(_component_IOSSelect, {
            ...
            createBaseVNode("div", _hoisted_70, [
              createBaseVNode("label", _hoisted_71, [
                ...
                _cache[46] || (_cache[46] = createBaseVNode("span", null, "显示其他选课方式课程（默认仅展示“选课”）", -1))
              ])
            ])
          ], 64)) : createCommentVNode("", true)
        ]),
        createBaseVNode("div", _hoisted_72, [
          $setup.loadingInfo ? (openBlock(), createBlock($setup["TEmptyState"], {
            ...
            type: "loading",
            message: "正在查询已选课程..."
          })) : $setup.filteredInfoCourses.length === 0 ? (openBlock(), createBlock($setup["TEmptyState"], {
            key: 1,
            message: $setup.infoEmptyHint
          }, null, 8, ["message"])) : (openBlock(), createElementBlock(Fragment, { key: 2 }, [
            $setup.infoSourceMessage ? (openBlock(), createElementBlock("div", _hoisted_73, toDisplayString($setup.infoSourceMessage), 1)) : createCommentVNode("", true),
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList($setup.filteredInfoCourses, (course) => {
                return openBlock(), createElementBlock("button", {
                  ...
                  createBaseVNode("div", _hoisted_76, [
                    createBaseVNode("div", null, [
                      createBaseVNode("div", _hoisted_77, toDisplayString(course.kcmc || "未命名课程"), 1),
                      createBaseVNode("div", _hoisted_78, toDisplayString(course.jxbmcDisplay || course.jxbmc || "未命名教学班"), 1)
                    ]),
                    createBaseVNode("div", _hoisted_79, [
                      createBaseVNode("span", _hoisted_80, toDisplayString(course.xkfsText || "选课"), 1),
                      createBaseVNode("div", _hoisted_81, toDisplayString(course.xf || "--") + " 学分", 1)
                    ])
                  ]),
                  createBaseVNode("div", _hoisted_82, [
                    createBaseVNode("span", _hoisted_83, toDisplayString(course.teacher || "待定教师"), 1),
                    course.isOnline ? (openBlock(), createElementBlock("span", _hoisted_84, "网课")) : (openBlock(), createElementBlock("span", _hoisted_85, toDisplayString(course.scheduleText || "未公布时间地点"), 1))
                  ]),
                  createBaseVNode("div", _hoisted_86, [
                    createBaseVNode("span", _hoisted_87, "学期 " + toDisplayString(course.termLabel || "--"), 1),
                    createBaseVNode("span", _hoisted_88, "选课方式 " + toDisplayString(course.xkfsText || "选课"), 1),
                    createBaseVNode("span", {
                      class: normalizeClass(["status-pill", course.statusClass])
                    }, toDisplayString(course.statusLabel), 3)
                  ])
      ...
      $setup.showDetail && $setup.currentDetailCourse ? (openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", _hoisted_89, [
            createBaseVNode("div", null, [
              createBaseVNode("div", _hoisted_90, toDisplayString($setup.currentDetailCourse.kcmc), 1),
              createBaseVNode("div", _hoisted_91, toDisplayString($setup.currentDetailCourse.jxbmc), 1)
            ]),
            createBaseVNode("button", {
              class: "close-btn",
              type: "button",
          ...
          createBaseVNode("div", _hoisted_92, [
            $setup.currentDetailCourse.isOnline ? (openBlock(), createElementBlock("span", _hoisted_93, "网课")) : createCommentVNode("", true),
            createBaseVNode("span", {
          ...
          createBaseVNode("div", _hoisted_94, [
            (openBlock(true), createElementBlock(Fragment, null, renderList($setup.detailFields, (item) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_95, toDisplayString(item.label), 1),
                createBaseVNode("span", _hoisted_96, toDisplayString(item.value), 1)
              ]);
            }), 128))
          ]),
          createBaseVNode("div", _hoisted_97, [
            _cache[47] || (_cache[47] = createBaseVNode("h4", null, "课程简介", -1)),
            createBaseVNode("div", _hoisted_98, toDisplayString($setup.detailIntro || $setup.normalizeDetailIntro($setup.normalizeDetailSourceText($setup.currentDetailCourse.kcjj), { allowConflictText: $setup.currentDetailCourse.isConflict }) || "暂无课程简介"), 1)
          ]),
          createBaseVNode("div", _hoisted_99, [
            _cache[48] || (_cache[48] = createBaseVNode("h4", null, "教师详情", -1)),
            createBaseVNode("div", _hoisted_100, toDisplayString($setup.detailTeacherText || $setup.currentDetailCourse.teacher || "暂无教师详情"), 1)
          ]),
          $setup.detailLoading ? (openBlock(), createElementBlock("div", _hoisted_101, "正在补充课程简介与教师详情...")) : createCommentVNode("", true)
        ])
      ...
      $setup.showChildClassDialog ? (openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", _hoisted_102, [
            createBaseVNode("div", null, [
              _cache[49] || (_cache[49] = createBaseVNode("div", { class: "modal-title" }, "选择子教学班", -1)),
              createBaseVNode("div", _hoisted_103, toDisplayString($setup.pendingSelectCourse?.kcmc || "当前课程"), 1)
            ]),
            createBaseVNode("button", {
              class: "close-btn",
              type: "button",
          ...
          createBaseVNode("div", _hoisted_104, [
            (openBlock(true), createElementBlock(Fragment, null, renderList($setup.childClasses, (item) => {
              return openBlock(), createElementBlock("button", {
                ...
                createBaseVNode("div", _hoisted_106, toDisplayString(item.name || item.id), 1),
                createBaseVNode("div", _hoisted_107, toDisplayString(item.teacher || "待定教师"), 1),
                createBaseVNode("div", _hoisted_108, toDisplayString(item.schedule || "时间地点待公布"), 1)
              ], 10, _hoisted_105);
            }), 128))
          ]),
    ...
    (openBlock(), createBlock(Teleport, { to: "body" }, [
      $setup.showActionConfirmDialog ? (openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", _hoisted_111, toDisplayString($setup.confirmActionType === "withdraw" ? "确认退课" : "确认选课"), 1),
          createBaseVNode("div", _hoisted_112, [
            $setup.confirmActionType === "withdraw" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              createTextVNode(" 确定要退掉“" + toDisplayString($setup.confirmTargetCourse?.kcmc || "当前课程") + "”吗？退课后会立即刷新当前批次列表。 ", 1)
            ], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
              createTextVNode(" 确定要选择“" + toDisplayString($setup.confirmTargetCourse?.kcmc || "当前课程") + "”吗？提交后会按教务系统规则实时校验容量与选课门数限制。 ", 1)
            ], 64))
          ]),
          createBaseVNode("div", _hoisted_113, [
            ...
            createBaseVNode("button", {
              ...
              $setup.confirmActionType === "withdraw" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                createTextVNode(toDisplayString($setup.withdrawingCourseId === $setup.confirmTargetCourse?.id ? "处理中..." : "确认退课"), 1)
              ], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                createTextVNode(toDisplayString($setup.selectingCourseId === $setup.confirmTargetCourse?.id ? "提交中..." : "确认选课"), 1)
              ], 64))
            ], 10, _hoisted_114)
          ])
        ])
...
const CourseSelectionView = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", render], ["__scopeId", "data-v-bc67b57d"]]);
export {
