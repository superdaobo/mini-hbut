import { o as onMounted, a as openBlock, c as createElementBlock, b as createBaseVNode, n as normalizeClass, t as toDisplayString, u as unref, d as createCommentVNode, j as createBlock, k as withCtx, J as withDirectives, P as vShow, F as Fragment, g as renderList, e as createTextVNode, r as ref, h as computed } from "./vue-core-C6WYunHF.js";
import { _ as _export_sfc, f as fetchWithCache, a as axiosInstance, E as EXTRA_LONG_TTL } from "./app-demo-B5kEWRyP.js";
import { f as formatRelativeTime } from "./time-DFqn0g8e.js";
import { a as isTauriRuntime, d as invokeNative } from "./runtime-bridge-Ds80RevU.js";
import { T as TEmptyState } from "./TEmptyState-tL6XUZ4y.js";
...
const _hoisted_7 = { class: "profile-card" };
const _hoisted_8 = { class: "profile-content" };
const _hoisted_9 = { class: "avatar-ring" };
const _hoisted_10 = { class: "avatar-circle" };
const _hoisted_11 = { class: "profile-name" };
const _hoisted_12 = { class: "profile-id" };
const _hoisted_13 = { class: "tab-bar" };
const _hoisted_14 = { class: "info-card" };
const _hoisted_15 = {
  key: 0,
  class: "inline-error"
};
...
const _hoisted_18 = { class: "material-symbols-outlined field-icon" };
const _hoisted_19 = { class: "field-value" };
const _hoisted_20 = { class: "orientation-blocks" };
const _hoisted_21 = { class: "orientation-head" };
const _hoisted_22 = {
  key: 0,
...
const _hoisted_26 = { class: "info-grid" };
const _hoisted_27 = { class: "field-label" };
const _hoisted_28 = { class: "material-symbols-outlined field-icon" };
const _hoisted_29 = { class: "field-value" };
const _hoisted_30 = { class: "info-grid" };
const _hoisted_31 = { class: "field-label" };
const _hoisted_32 = { class: "material-symbols-outlined field-icon" };
const _hoisted_33 = { class: "field-value" };
const _hoisted_34 = { class: "info-grid" };
const _hoisted_35 = { class: "field-label" };
const _hoisted_36 = { class: "material-symbols-outlined field-icon" };
const _hoisted_37 = { class: "field-value" };
const _hoisted_38 = {
  key: 5,
  class: "orientation-hint"
};
const _hoisted_39 = { class: "info-card" };
const _hoisted_40 = {
  key: 0,
  class: "inline-error"
};
...
const _hoisted_42 = { class: "contact-list" };
const _hoisted_43 = { class: "contact-row" };
const _hoisted_44 = { class: "contact-info" };
const _hoisted_45 = { class: "field-value" };
const _hoisted_46 = { class: "contact-row" };
const _hoisted_47 = { class: "contact-info" };
const _hoisted_48 = { class: "field-value" };
const _hoisted_49 = { class: "login-list" };
const _hoisted_50 = { class: "login-row" };
const _hoisted_51 = { class: "login-value" };
const _hoisted_52 = { class: "login-row" };
const _hoisted_53 = { class: "login-value" };
const _hoisted_54 = { class: "login-row" };
const _hoisted_55 = { class: "login-value" };
const _hoisted_56 = { class: "login-row" };
const _hoisted_57 = { class: "login-value" };
const _hoisted_58 = { class: "info-card" };
const _hoisted_59 = {
  key: 0,
  class: "cache-hint"
};
...
const _hoisted_61 = { class: "access-list" };
const _hoisted_62 = { class: "access-head" };
const _hoisted_63 = { class: "access-app-name" };
const _hoisted_64 = { class: "access-meta" };
const _hoisted_65 = { class: "access-time" };
const _hoisted_66 = { class: "pagination-bar" };
const _hoisted_67 = { class: "total-text" };
const _hoisted_68 = { class: "pager-controls" };
  ...
  setup(__props, { emit: __emit }) {
    ...
    const fetchLoginAccess = async (page = accessPage.value, pageSize = accessPageSize.value, options = {}) => {
      ...
      try {
        ...
        accessError.value = e?.response?.data?.error || (typeof e === "string" ? e : e?.message) || "获取登录访问信息失败";
        return null;
      } finally {
        if (showLoading) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        offline.value ? (openBlock(), createElementBlock("div", _hoisted_4, " 当前显示离线数据，更新于 " + toDisplayString(unref(formatRelativeTime)(syncTime.value)), 1)) : createCommentVNode("", true),
        createBaseVNode("main", _hoisted_5, [
          loading.value ? (openBlock(), createBlock(unref(TEmptyState), {
            ...
            _: 1
          }, 8, ["message"])) : (openBlock(), createElementBlock("div", _hoisted_6, [
            createBaseVNode("section", _hoisted_7, [
              _cache[9] || (_cache[9] = createBaseVNode("div", { class: "profile-gradient-bg" }, null, -1)),
              createBaseVNode("div", _hoisted_8, [
                createBaseVNode("div", _hoisted_9, [
                  createBaseVNode("div", _hoisted_10, toDisplayString(info.value?.name?.charAt(0) || "?"), 1)
                ]),
                createBaseVNode("h2", _hoisted_11, toDisplayString(normalizeString(info.value?.name)), 1),
                createBaseVNode("p", _hoisted_12, toDisplayString(normalizeString(info.value?.student_id)), 1),
                _cache[8] || (_cache[8] = createBaseVNode("span", { class: "profile-badge" }, "本科生", -1))
              ])
            ]),
            ...
            withDirectives(createBaseVNode("section", _hoisted_14, [
              _cache[14] || (_cache[14] = createBaseVNode("h3", { class: "card-section-title" }, "详细信息", -1)),
              infoError.value ? (openBlock(), createElementBlock("div", _hoisted_15, toDisplayString(infoError.value), 1)) : createCommentVNode("", true),
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(basicRows.value, (row) => {
                  return openBlock(), createElementBlock("article", {
                    ...
                    createBaseVNode("span", _hoisted_17, [
                      createBaseVNode("span", _hoisted_18, toDisplayString(getFieldIcon(row.label)), 1),
                      createTextVNode(" " + toDisplayString(row.label), 1)
                    ]),
                    createBaseVNode("span", _hoisted_19, toDisplayString(row.value), 1)
                  ], 2);
                }), 128))
              ]),
              createBaseVNode("div", _hoisted_20, [
                createBaseVNode("div", _hoisted_21, [
                  _cache[10] || (_cache[10] = createBaseVNode("h3", { class: "card-section-title orientation-title" }, "学工附属信息", -1)),
                  orientationSource.value ? (openBlock(), createElementBlock("span", _hoisted_22, toDisplayString(orientationSource.value), 1)) : createCommentVNode("", true),
                  orientationLoading.value ? (openBlock(), createElementBlock("span", _hoisted_23, "同步中")) : createCommentVNode("", true)
                ]),
                orientationNotice.value ? (openBlock(), createElementBlock("p", _hoisted_24, toDisplayString(orientationNotice.value), 1)) : createCommentVNode("", true),
                orientationError.value && !hasOrientationBlocks.value ? (openBlock(), createElementBlock("p", _hoisted_25, toDisplayString(orientationError.value), 1)) : createCommentVNode("", true),
                mentor.value && personKvRows(mentor.value).length ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [
                  _cache[11] || (_cache[11] = createBaseVNode("h4", { class: "orientation-sub" }, "班导师", -1)),
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(personKvRows(mentor.value), (row, i) => {
                      return openBlock(), createElementBlock("article", {
                        ...
                        createBaseVNode("span", _hoisted_27, [
                          createBaseVNode("span", _hoisted_28, toDisplayString(getPersonFieldIcon(row.label)), 1),
                          createTextVNode(" " + toDisplayString(row.label), 1)
                        ]),
                        createBaseVNode("span", _hoisted_29, toDisplayString(row.value), 1)
                      ]);
                    }), 128))
                  ])
                ], 64)) : createCommentVNode("", true),
                counselor.value && personKvRows(counselor.value).length ? (openBlock(), createElementBlock(Fragment, { key: 3 }, [
                  _cache[12] || (_cache[12] = createBaseVNode("h4", { class: "orientation-sub" }, "辅导员", -1)),
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(personKvRows(counselor.value), (row, i) => {
                      return openBlock(), createElementBlock("article", {
                        ...
                        createBaseVNode("span", _hoisted_31, [
                          createBaseVNode("span", _hoisted_32, toDisplayString(getPersonFieldIcon(row.label)), 1),
                          createTextVNode(" " + toDisplayString(row.label), 1)
                        ]),
                ...
                dormKvRows.value.length ? (openBlock(), createElementBlock(Fragment, { key: 4 }, [
                  _cache[13] || (_cache[13] = createBaseVNode("h4", { class: "orientation-sub" }, "宿舍信息", -1)),
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(dormKvRows.value, (row, i) => {
                      return openBlock(), createElementBlock("article", {
                        ...
                        createBaseVNode("span", _hoisted_35, [
                          createBaseVNode("span", _hoisted_36, toDisplayString(getDormFieldIcon(row.label)), 1),
                          createTextVNode(" " + toDisplayString(row.label), 1)
                        ]),
                        createBaseVNode("span", _hoisted_37, toDisplayString(row.value), 1)
                      ]);
                    }), 128))
                  ])
                ], 64)) : createCommentVNode("", true),
                !orientationLoading.value && !hasOrientationBlocks.value && !orientationError.value ? (openBlock(), createElementBlock("p", _hoisted_38, " 暂无班导师/辅导员/宿舍信息（可能不在迎新开放时段） ")) : createCommentVNode("", true)
              ])
            ], 512), [
              [vShow, activeTab.value === "basic"]
            ]),
            withDirectives(createBaseVNode("section", _hoisted_39, [
              _cache[22] || (_cache[22] = createBaseVNode("h3", { class: "card-section-title" }, "联系方式 & 认证", -1)),
              accessError.value ? (openBlock(), createElementBlock("div", _hoisted_40, toDisplayString(accessError.value), 1)) : createCommentVNode("", true),
              accessOffline.value && !accessError.value ? (openBlock(), createElementBlock("div", _hoisted_41, " 登录记录暂不可用，当前显示缓存数据（更新于 " + toDisplayString(unref(formatRelativeTime)(accessSyncTime.value)) + "） ", 1)) : createCommentVNode("", true),
              createBaseVNode("div", _hoisted_42, [
                createBaseVNode("div", _hoisted_43, [
                  createBaseVNode("div", _hoisted_44, [
                    _cache[15] || (_cache[15] = createBaseVNode("span", { class: "field-label" }, [
                      createBaseVNode("span", { class: "material-symbols-outlined field-icon" }, "smartphone"),
                      createTextVNode(" 手机号码 ")
                    ], -1)),
                    createBaseVNode("span", _hoisted_45, toDisplayString(authInfo.value.phone), 1)
                  ]),
                  createBaseVNode("span", {
                ...
                createBaseVNode("div", _hoisted_46, [
                  createBaseVNode("div", _hoisted_47, [
                    _cache[16] || (_cache[16] = createBaseVNode("span", { class: "field-label" }, [
                      createBaseVNode("span", { class: "material-symbols-outlined field-icon" }, "mail"),
                      createTextVNode(" 电子邮箱 ")
                    ], -1)),
                    createBaseVNode("span", _hoisted_48, toDisplayString(authInfo.value.email), 1)
                  ]),
                  createBaseVNode("span", {
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(currentLogins.value, (item, index) => {
                    return openBlock(), createElementBlock("article", {
                      ...
                      createBaseVNode("div", _hoisted_50, [
                        _cache[17] || (_cache[17] = createBaseVNode("span", { class: "login-label" }, "客户端IP", -1)),
                        createBaseVNode("span", _hoisted_51, toDisplayString(item.client_ip), 1)
                      ]),
                      createBaseVNode("div", _hoisted_52, [
                        _cache[18] || (_cache[18] = createBaseVNode("span", { class: "login-label" }, "IP归属地", -1)),
                        createBaseVNode("span", _hoisted_53, toDisplayString(item.ip_location), 1)
                      ]),
                      createBaseVNode("div", _hoisted_54, [
                        _cache[19] || (_cache[19] = createBaseVNode("span", { class: "login-label" }, "登录时间", -1)),
                        createBaseVNode("span", _hoisted_55, toDisplayString(item.login_time), 1)
                      ]),
                      createBaseVNode("div", _hoisted_56, [
                        _cache[20] || (_cache[20] = createBaseVNode("span", { class: "login-label" }, "浏览器", -1)),
                        createBaseVNode("span", _hoisted_57, toDisplayString(item.browser), 1)
                      ])
                    ]);
                  }), 128))
                ])
            ...
            withDirectives(createBaseVNode("section", _hoisted_58, [
              accessOffline.value && !accessLoading.value ? (openBlock(), createElementBlock("div", _hoisted_59, " 登录记录暂不可用，当前显示缓存数据（更新于 " + toDisplayString(unref(formatRelativeTime)(accessSyncTime.value)) + "） ", 1)) : createCommentVNode("", true),
              accessLoading.value ? (openBlock(), createElementBlock("div", _hoisted_60, [..._cache[23] || (_cache[23] = [
              ...
              !accessLoading.value && appAccessRecords.value.length === 0 ? (openBlock(), createBlock(unref(TEmptyState), {
                ...
                type: "empty",
                message: "暂无应用访问记录"
              })) : appAccessRecords.value.length > 0 ? (openBlock(), createElementBlock(Fragment, { key: 3 }, [
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(pagedAppAccessRecords.value, (record) => {
                    return openBlock(), createElementBlock("article", {
                      ...
                      createBaseVNode("div", _hoisted_62, [
                        createBaseVNode("h4", _hoisted_63, toDisplayString(record.app_name), 1),
                        createBaseVNode("span", {
                          class: normalizeClass(["auth-badge", authResultClass(record.auth_result)])
                        }, toDisplayString(record.auth_result), 3)
                      ]),
                      createBaseVNode("div", _hoisted_64, [
                        createBaseVNode("span", _hoisted_65, toDisplayString(record.access_time), 1)
                      ])
                    ]);
                  }), 128))
                ]),
                createBaseVNode("div", _hoisted_66, [
                  createBaseVNode("span", _hoisted_67, "共 " + toDisplayString(accessTotal.value) + " 条", 1),
                  createBaseVNode("div", _hoisted_68, [
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(visiblePageNumbers.value, (page) => {
                      ...
                      }, toDisplayString(page), 11, _hoisted_70);
                    }), 128)),
                    createBaseVNode("button", {
                      class: "pager-btn",
...
const StudentInfoView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d653f800"]]);
export {
