import { r as ref, v as watch, o as onMounted, l as onBeforeUnmount, a as openBlock, c as createElementBlock, b as createBaseVNode, n as normalizeClass, t as toDisplayString, F as Fragment, J as withDirectives, K as vModelText, O as vModelCheckbox, e as createTextVNode, p as createVNode, k as withCtx, d as createCommentVNode, T as Transition, u as unref, h as computed, R as createStaticVNode, j as createBlock, w as withModifiers, G as nextTick } from "./vue-core-C6WYunHF.js";
import { _ as _imports_0 } from "./app_icon-BoqTJkLh.js";
import { _ as _export_sfc, R as loadPortalRememberedPassword, T as loadChaoxingRememberedPassword, Q as fetchRemoteConfig, U as applyOcrRuntimeConfig, V as getStoredOcrConfig, a as axiosInstance, W as syncPortalRememberCredential, s as setCachedData, X as saveRememberedCredential, Y as buildHbutAccountKey, Z as buildChaoxingAccountKey, o as openExternal, h as showToast } from "./app-demo-B5kEWRyP.js";
import { p as pushDebugLog, N as isTestAccountCredentials, s as saveRememberedUsername, a as isTauriRuntime, d as invokeNative, E as markTestAccountSession, T as TEST_ACCOUNT, O as TEST_ACCOUNT_LOGIN_METHOD, A as seedTestAccountCaches, z as getTestAccountGrades, i as isTestAccountSession, C as clearTestAccountSession } from "./runtime-bridge-Ds80RevU.js";
import { N as NON_OFFICIAL_DISCLAIMER_ZH, l as NON_OFFICIAL_DISCLAIMER_EN, P as PRIVACY_POLICY_URL, I as ICP_BEIAN_TEXT, m as isSponsorEntryAllowed, i as isViewAllowed, o as ICP_BEIAN_URL } from "./more-modules-DDZK9iEH.js";
...
const LoginV3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-6afcb25f"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        _cache[42] || (_cache[42] = createStaticVNode('<header class="dashboard-header" data-v-941c255a><div class="header-left" data-v-941c255a><img class="logo-img" src="' + _imports_0 + '" alt="HBUT" data-v-941c255a><span class="header-title" data-v-941c255a>Mini-HBUT</span></div><span class="header-pill" data-v-941c255a>我的</span></header>', 1)),
        ...
        _cache[43] || (_cache[43] = createStaticVNode('<section class="status-card" data-v-941c255a><div class="status-left" data-v-941c255a><div class="status-icon-box" data-v-941c255a><span class="material-symbols-outlined status-icon" data-v-941c255a>verified_user</span></div><div class="status-text" data-v-941c255a><span class="status-title" data-v-941c255a>登录状态</span><span class="status-subtitle" data-v-941c255a>静默登录已开启</span></div></div><span class="status-dot" data-v-941c255a></span></section>', 1)),
        ...
        createBaseVNode("section", _hoisted_8, [
          ...
          createBaseVNode("div", _hoisted_9, [
            ...
            createBaseVNode("button", {
              ...
              createStaticVNode('<span class="privacy-policy-entry__icon" aria-hidden="true" data-v-941c255a><span class="material-symbols-outlined" data-v-941c255a>shield</span></span><span class="privacy-policy-entry__body" data-v-941c255a><span class="privacy-policy-entry__title" data-v-941c255a>隐私政策</span><span class="privacy-policy-entry__desc" data-v-941c255a>在系统浏览器中打开完整政策</span></span><span class="privacy-policy-entry__chev material-symbols-outlined" aria-hidden="true" data-v-941c255a>open_in_new</span>', 3)
            ])])
          ])
        ]),
        createBaseVNode("section", {
          ...
          activeLegalTab.value === "disclaimer" ? (openBlock(), createElementBlock("div", _hoisted_13, [..._cache[30] || (_cache[30] = [
            ...
            createStaticVNode("<p data-v-941c255a>我们仅收集提供服务所必需的数据，并采取合理措施保护数据安全。</p><ul data-v-941c255a><li data-v-941c255a><strong data-v-941c255a>收集内容</strong>：学号、登录会话信息、验证码参数、查询所需的临时授权信息。</li><li data-v-941c255a><strong data-v-941c255a>使用目的</strong>：用于身份验证、成绩/课表/电费等查询与展示。</li><li data-v-941c255a><strong data-v-941c255a>存储方式</strong>：本地会存储加密后的账号凭据与缓存数据；后端仅保存必要的会话与授权信息。</li><li data-v-941c255a><strong data-v-941c255a>数据共享</strong>：不会向无关第三方共享个人信息，除非获得你的明确授权或法律要求。</li><li data-v-941c255a><strong data-v-941c255a>数据保留</strong>：仅在实现功能所需期限内保留，可通过退出登录清理会话。</li></ul><p data-v-941c255a>继续使用即表示你已阅读并同意本隐私政策。</p>", 3)
          ])]))
        ], 512),
          ...
          default: withCtx(() => [
            showOpenSourceModal.value ? (openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", {
                ...
                _cache[37] || (_cache[37] = createBaseVNode("div", { class: "section" }, [
                ...
                _cache[38] || (_cache[38] = createBaseVNode("div", { class: "section thanks" }, [
          ...
          default: withCtx(() => [
            showSponsorModal.value && showSponsorEntry.value ? (openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", {
                ...
                _cache[39] || (_cache[39] = createBaseVNode("h3", null, "❤️ 赞助支持", -1)),
                _cache[40] || (_cache[40] = createBaseVNode("p", { class: "intro" }, "如果 Mini-HBUT 对你有帮助，欢迎请作者喝杯咖啡 ☕", -1)),
                ...
                _cache[41] || (_cache[41] = createBaseVNode("p", { class: "sponsor-hint" }, "长按或截图扫码 · 微信赞赏", -1)),
...
const MeView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-941c255a"]]);
export {
  MeView as default
};
