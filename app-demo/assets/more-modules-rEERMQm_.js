import { i as isTestAccountSession, a as isTauriRuntime, b as isLikelyAndroidUserAgent, _ as __vitePreload, t as toNativeFileSrc, g as getNativeAppVersion, p as pushDebugLog, c as isCapacitorRuntime } from "./runtime-bridge-i9KZPKjs.js";
...
const fetchJsonViaCapacitor = async (url, timeoutMs = DEFAULT_REMOTE_JSON_TIMEOUT_MS) => {
  const core = await __vitePreload(() => import("./runtime-bridge-i9KZPKjs.js").then((n) => n.a3), true ? [] : void 0, import.meta.url);
...
const invokeNativeBridge = async (command, args, label = "") => {
  const core = await __vitePreload(() => import("./runtime-bridge-i9KZPKjs.js").then((n) => n.a9), true ? [] : void 0, import.meta.url);
  try {
...
export {
  ...
  prepareModuleBundle as x,
  isLiveLocationAllowed as y,
  app_store_policy as z
};
