...
import { _ as _export_sfc, u as useLocale, a as useAuthStore, a8 as loadPortalRememberedPassword, a9 as loadChaoxingRememberedPassword, a7 as fetchRemoteConfig, aa as applyOcrRuntimeConfig, ab as getStoredOcrConfig, d as axiosInstance, ac as syncPortalRememberCredential, ad as runExclusiveLogin, s as setCachedData, ae as saveRememberedCredential, af as buildHbutAccountKey, ag as buildChaoxingAccountKey, m as useI18n, o as openExternal, j as showToast, p as tf } from "./app-demo-BO0WKfcf.js";
import { p as pushDebugLog, S as isTestAccountCredentials, z as saveRememberedUsername, a as isTauriRuntime, d as invokeNative, H as markTestAccountSession, T as TEST_ACCOUNT, U as TEST_ACCOUNT_LOGIN_METHOD, D as seedTestAccountCaches, C as getTestAccountGrades, v as isValidStudentId, i as isTestAccountSession, F as clearTestAccountSession } from "./runtime-bridge-BDjl3Bnt.js";
import { N as NON_OFFICIAL_DISCLAIMER_ZH, l as NON_OFFICIAL_DISCLAIMER_EN, P as PRIVACY_POLICY_URL, I as ICP_BEIAN_TEXT, m as isSponsorEntryAllowed, i as isViewAllowed, o as ICP_BEIAN_URL } from "./more-modules-DiLNQOO4.js";
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const resolveChaoxingStudentId = async (payload = null) => {
      ...
      if (isValidStudentId(cachedSid)) return cachedSid;
      if (isTauriRuntime()) {
        try {
...
const LoginV3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-25ac95b0"]]);
              ...
              createBaseVNode("div", {
                ...
                createBaseVNode("div", _hoisted_54, [
                  createBaseVNode("p", null, [
                    createTextVNode(toDisplayString(unref(t)("me.opensource.thanksMiniHuGong.prefix")), 1),
                    createBaseVNode("strong", null, toDisplayString(unref(t)("me.opensource.thanksMiniHuGong.name")), 1),
                    createTextVNode(toDisplayString(unref(t)("me.opensource.thanksMiniHuGong.suffix")), 1)
                  ]),
                  createBaseVNode("p", null, [
                    createTextVNode(toDisplayString(unref(t)("me.opensource.thanksFriends.prefix")), 1),
                    createBaseVNode("strong", null, toDisplayString(unref(t)("me.opensource.thanksFriends.name")), 1),
                    createTextVNode(toDisplayString(unref(t)("me.opensource.thanksFriends.suffix")), 1)
                  ]),
...
const MeView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5d132cc2"]]);
export {
  MeView as default
};
