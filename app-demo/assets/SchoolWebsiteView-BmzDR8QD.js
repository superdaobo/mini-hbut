const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./school_website_embed-Bv3KFakW.js","./runtime-bridge-Dt57BD2i.js","./more-modules-DaLSEgdg.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, F as isAndroidLike } from "./runtime-bridge-Dt57BD2i.js";
import { _ as _export_sfc, m as useI18n, o as openExternal } from "./app-demo-CUOWTnz-.js";
import { forceCloseSchoolWebsiteEmbed, resolveSchoolWebsiteEmbedMode, mountSchoolWebsiteEmbed, SCHOOL_WEBSITE_URL, resolveSchoolWebsiteIframeUrl } from "./school_website_embed-Bv3KFakW.js";
    ...
    const remountAfterResume = async (eventDetail = null) => {
      ...
      try {
        const { recoverSchoolWebsiteBridgeOnResume } = await __vitePreload(async () => {
          const { recoverSchoolWebsiteBridgeOnResume: recoverSchoolWebsiteBridgeOnResume2 } = await import("./school_website_embed-Bv3KFakW.js");
