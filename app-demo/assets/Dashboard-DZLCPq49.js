const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./runtime-bridge-Ds80RevU.js","./more-modules-DDZK9iEH.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, i as isTestAccountSession } from "./runtime-bridge-Ds80RevU.js";
import { _ as _export_sfc, c as cloneWorkspaceLayout, u as useUiSettings, g as getCachedData, f as fetchWithCache, a as axiosInstance, D as DEFAULT_SWR_OPTIONS, s as setCachedData, d as decideHomeNavigate, b as flushUiSettings, e as buildDefaultWorkspaceLayout, r as readScheduleLockDetail, o as openExternal, h as showToast } from "./app-demo-B5kEWRyP.js";
import { a as openBlock, c as createElementBlock, t as toDisplayString, f as normalizeStyle, n as normalizeClass, h as computed, b as createBaseVNode, e as createTextVNode, d as createCommentVNode, F as Fragment, g as renderList, w as withModifiers, j as createBlock, J as withDirectives, K as vModelText, s as Teleport, p as createVNode, k as withCtx, T as Transition, v as watch, r as ref, o as onMounted, l as onBeforeUnmount, G as nextTick } from "./vue-core-C6WYunHF.js";
import { _ as _sfc_main$2, L as LayoutCollisionFxLayer, r as resolveRelativeCollisionPoint, a as resolveCollisionPalette, c as createLayoutCollisionBurst, b as advanceLayoutCollisionFx, d as resolveLayoutSlotTarget, m as moveLayoutItemToIndex, e as captureLayoutSlotAnchors } from "./layout_collision_fx-mgWF9jg8.js";
import { j as isModuleAllowed, k as filterAllowedModules } from "./more-modules-DDZK9iEH.js";
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [
    ...
    createBaseVNode("main", _hoisted_5, [
      ...
      $setup.sessionDetailOpen && $setup.sessionStatusVisual !== "green" ? (openBlock(), createElementBlock("div", _hoisted_18, [
        ...
        createBaseVNode("div", _hoisted_23, toDisplayString($props.jwxtMaintenanceHint || ($setup.sessionStatusVisual === "blink" ? "正在后台恢复登录会话，请稍候…" : "当前可能无法同步最新教务数据，可查看下方详情或重试。")), 1),
...
const _sfc_main = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const fetchWeather = async (force = false) => {
      ...
      try {
        const { invokeNative } = await __vitePreload(async () => {
          const { invokeNative: invokeNative2 } = await import("./runtime-bridge-Ds80RevU.js").then((n) => n.X);
    ...
    const __returned__ = { props, emit, maintenanceTitle, maintenancePhaseLabel, maintenanceNotices, sessionDetailOpen, sessionStatusVisual, sessionStatusAria, onSessionStatusClick, uiSettings, brokenImages, cardListeners, isMobileNoticeSwipe, isTickerInteracting, get tickerResumeTimer() {
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", render], ["__scopeId", "data-v-db59f535"]]);
export {
