...
import { a as isTauriRuntime, c as isCapacitorRuntime, _ as __vitePreload, d as invokeNative } from "./runtime-bridge-Ds80RevU.js";
import { o as onMounted, a as openBlock, c as createElementBlock, b as createBaseVNode, R as createStaticVNode, t as toDisplayString, F as Fragment, g as renderList, n as normalizeClass, J as withDirectives, O as vModelCheckbox, d as createCommentVNode, e as createTextVNode, h as computed, r as ref, G as nextTick } from "./vue-core-C6WYunHF.js";
import { _ as _export_sfc, f as fetchWithCache, a as axiosInstance, n as normalizeSemesterList, i as resolveCurrentSemester } from "./app-demo-B5kEWRyP.js";
  ...
  setup(__props, { emit: __emit }) {
    ...
    const saveByCapacitor = async (fileName, blob) => {
      const { Filesystem, Directory } = await __vitePreload(async () => {
        const { Filesystem: Filesystem2, Directory: Directory2 } = await import("./runtime-bridge-Ds80RevU.js").then((n) => n.a2);
      ...
      const { Share } = await __vitePreload(async () => {
        const { Share: Share2 } = await import("./runtime-bridge-Ds80RevU.js").then((n) => n.a3);
        return { Share: Share2 };
      }, true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
      await Share.share({
        title: fileName,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("main", _hoisted_3, [
          _cache[39] || (_cache[39] = createStaticVNode('<section class="export-hero" data-v-86489fd1><div class="hero-bg-icon" data-v-86489fd1><span class="material-symbols-outlined" data-v-86489fd1>cloud_download</span></div><h2 class="hero-title" data-v-86489fd1>数据自由导出</h2><p class="hero-desc" data-v-86489fd1>选择你需要的模块和时间范围，生成个性化的数据报告或图表。</p></section><section class="intro-card" data-v-86489fd1><h2 data-v-86489fd1>导出模块</h2><p data-v-86489fd1>可按业务分类导出 JSON 或长图片。成绩、课表、排名等模块会按所选学期输出完整明细。</p></section>', 2)),
...
const ExportCenterView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-86489fd1"]]);
export {
