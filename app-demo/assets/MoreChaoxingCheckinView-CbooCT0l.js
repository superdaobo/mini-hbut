import { a as openBlock, c as createElementBlock, t as toDisplayString, d as createCommentVNode, g as createTextVNode, q as renderSlot, n as normalizeClass, b as createBaseVNode, p as createVNode, u as unref, h as computed, j as createBlock, F as Fragment, f as renderList, k as withCtx, K as withDirectives, L as vModelText, r as ref, o as onMounted, l as onBeforeUnmount, e as normalizeStyle, s as Teleport, T as Transition } from "./vue-core-Dzs4fLAU.js";
import { _ as _export_sfc, aU as TModal, u as useLocale } from "./app-demo-DqAlnDLf.js";
import { _ as _sfc_main$a } from "./TPageHeader.vue_vue_type_script_setup_true_lang-Dh0eXg1s.js";
import { T as TEmptyState } from "./TEmptyState-TY5fTjlY.js";
import { T as TStatusBadge } from "./TStatusBadge-B0y4ooE2.js";
import { u as useGeolocation } from "./useGeolocation-BJJ4fYjL.js";
import { P as isMobileLike, a as isTauriRuntime, d as invokeNative } from "./runtime-bridge-i9KZPKjs.js";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createVNode(unref(_sfc_main$a), {
          title: unref(t)("chaoxing.checkin.title"),
          ...
          showTab.value === "active" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            unref(loading) ? (openBlock(), createBlock(unref(TEmptyState), {
              ...
              unref(activeActivities).length ? (openBlock(), createBlock(unref(TSection), {
                key: 0,
                title: unref(t)("chaoxing.checkin.ongoing"),
                icon: "🟢"
              }, {
                default: withCtx(() => [
              ...
              unref(pendingOrExpired).length ? (openBlock(), createBlock(unref(TSection), {
                key: 1,
                title: unref(t)("chaoxing.checkin.ended"),
                icon: "📋"
              }, {
                default: withCtx(() => [
              ...
              !unref(activities).length ? (openBlock(), createBlock(unref(TEmptyState), {
                key: 2,
                type: "empty",
                message: unref(t)("chaoxing.checkin.none"),
                icon: "📭"
...
const MoreChaoxingCheckinView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fc6bcfff"]]);
export {
