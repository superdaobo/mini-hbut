...
import { r as ref, l as onBeforeUnmount, y as defineComponent, v as watch, o as onMounted, C as nextTick, a as openBlock, c as createElementBlock, p as createVNode, k as withCtx, b as createBaseVNode, u as unref, t as toDisplayString, d as createCommentVNode, K as withDirectives, L as vModelText, Y as isRef, n as normalizeClass, F as Fragment, f as renderList } from "./vue-core-Dzs4fLAU.js";
import { H as HBUT_LOCATION, r as resolveTowerGoLocation } from "./towergo_map-Do-Wv4K7.js";
import { C as CAMPUS_MAP_SCHEMA_VERSION, a as CAMPUS_MAP_MANIFEST_URL, b as CAMPUS_MAP_CACHE_KEY, c as CAMPUS_MAP_CACHE_TTL_MS, d as CAMPUS_MAP_FETCH_TIMEOUT_MS, l as loadTencentMap, T as TOWERGO_CONFIG, t as toTencentLatLng, f as formatWalkingDuration, e as formatWalkingDistance, g as fetchWalkingRoute, h as CAMPUS_LOCATION_DRIFT_THRESHOLD_METERS } from "./walking_route_service-D1YkZ5jE.js";
import { s as setCachedData, g as getCachedData, u as useLocale, j as showToast, _ as _export_sfc } from "./app-demo-DqAlnDLf.js";
import { a as isTauriRuntime, d as invokeNative } from "./runtime-bridge-i9KZPKjs.js";
...
const buildings = [{ "id": "library", "name": "图书馆", "aliases": ["湖工图书馆"], "category": "library", "lat": 30.4826, "lng": 114.3128, "tags": ["自习", "借阅"] }, { "id": "j1", "name": "教学1号楼", "aliases": ["一教", "1教"], "category": "teaching", "lat": 30.4812, "lng": 114.3115 }, { "id": "j2", "name": "教学2号楼", "aliases": ["二教", "2教"], "category": "teaching", "lat": 30.4808, "lng": 114.3126 }, { "id": "j3", "name": "教学3号楼", "aliases": ["三教", "3教"], "category": "teaching", "lat": 30.4815, "lng": 114.3142 }, { "id": "j4", "name": "教学4号楼", "aliases": ["四教", "4教"], "category": "teaching", "lat": 30.4821, "lng": 114.3151 }, { "id": "gym", "name": "体育馆", "category": "sports", "lat": 30.4834, "lng": 114.3109 }, { "id": "canteen-n", "name": "北区食堂", "aliases": ["北食堂"], "category": "canteen", "lat": 30.4838, "lng": 114.3136 }, { "id": "canteen-s", "name": "南区食堂", "aliases": ["南食堂"], "category": "canteen", "lat": 30.4796, "lng": 114.3148 }, { "id": "admin", "name": "行政楼", "category": "admin", "lat": 30.4819, "lng": 114.313 }, { "id": "gate-south", "name": "南门", "category": "gate", "lat": 30.4788, "lng": 114.3134 }, { "id": "gate-north", "name": "北门", "category": "gate", "lat": 30.4852, "lng": 114.3122 }, { "id": "dorm-1", "name": "1号学生公寓", "category": "dormitory", "lat": 30.4846, "lng": 114.3158 }, { "id": "dorm-2", "name": "2号学生公寓", "category": "dormitory", "lat": 30.4841, "lng": 114.3168 }];
...
const center = { "lat": 30.4819, "lng": 114.313 };
const default_zoom = 17;
const bounds = { "sw": { "lat": 30.4775, "lng": 114.3075 }, "ne": { "lat": 30.4865, "lng": 114.3185 } };
  ...
  setBuildings(buildings2) {
    ...
    if (!this.buildingLayer) {
      ...
      this.buildingLayer.on?.("click", (event) => {
        const geometry = event && typeof event === "object" ? event.geometry : void 0;
...
const _hoisted_8 = { class: "map-shell" };
const _hoisted_9 = {
  key: 0,
...
const _hoisted_11 = { class: "detail-head" };
const _hoisted_12 = {
  key: 0,
  class: "detail-meta"
};
...
const _hoisted_17 = { class: "results-panel" };
const _hoisted_18 = { class: "results-head" };
const _hoisted_19 = { class: "results-list" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createVNode(unref(_sfc_main$1), {
          ...
          actions: withCtx(() => [
            ...
            }, toDisplayString(unref(loading) ? unref(t)("map.btn.loading") : unref(t)("map.btn.refresh")), 9, _hoisted_2)
          ]),
          _: 1
        }, 8, ["title"]),
        ...
        unref(errorText) ? (openBlock(), createElementBlock("section", _hoisted_4, toDisplayString(unref(errorText)), 1)) : unref(mapReady) && unref(bundle) && !unref(bundle).buildings?.length ? (openBlock(), createElementBlock("section", _hoisted_5, toDisplayString(unref(t)("map.empty.buildings")), 1)) : createCommentVNode("", true),
        createBaseVNode("section", _hoisted_6, [
          withDirectives(createBaseVNode("input", {
            ...
            class: "search-input",
            type: "search",
            placeholder: unref(t)("map.search.placeholder"),
            autocomplete: "off"
          }, null, 8, _hoisted_7), [
          ...
          }, toDisplayString(unref(t)("map.btn.locate")), 1)
        ]),
        createBaseVNode("section", _hoisted_8, [
          ...
          !unref(mapReady) && !unref(errorText) ? (openBlock(), createElementBlock("div", _hoisted_9, toDisplayString(unref(t)("map.loading")), 1)) : createCommentVNode("", true)
        ]),
        unref(selectedBuilding) ? (openBlock(), createElementBlock("section", _hoisted_10, [
          createBaseVNode("div", _hoisted_11, [
            ...
            }, toDisplayString(unref(t)("map.detail.close")), 1)
          ]),
          unref(selectedBuilding).aliases?.length ? (openBlock(), createElementBlock("p", _hoisted_12, toDisplayString(unref(t)("map.detail.aliasesPrefix")) + toDisplayString(unref(selectedBuilding).aliases.join("、")), 1)) : createCommentVNode("", true),
          createBaseVNode("div", _hoisted_13, [
            ...
            }, toDisplayString(unref(routeLoading) ? unref(t)("map.btn.routing") : unref(t)("map.btn.walkNav")), 9, _hoisted_14)
          ]),
          unref(routeError) ? (openBlock(), createElementBlock("p", _hoisted_15, toDisplayString(unref(routeError)), 1)) : unref(routeResult) ? (openBlock(), createElementBlock("p", _hoisted_16, toDisplayString(unref(t)("map.route.approxPrefix")) + toDisplayString(unref(formatWalkingDistance2)(unref(routeResult).distanceMeters)) + " · " + toDisplayString(unref(formatWalkingDuration2)(unref(routeResult).durationSeconds)), 1)) : createCommentVNode("", true)
        ])) : createCommentVNode("", true),
        createBaseVNode("section", _hoisted_17, [
          createBaseVNode("div", _hoisted_18, [
            createBaseVNode("h2", null, toDisplayString(unref(t)("map.results.title")), 1),
            createBaseVNode("span", null, toDisplayString(tr("map.results.count", { n: unref(searchResults).length })), 1)
          ]),
...
const CampusMapView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fc0e1811"]]);
export {
