import { o as onMounted, M as resolveComponent, a as openBlock, c as createElementBlock, p as createVNode, u as unref, n as normalizeClass, F as Fragment, g as createTextVNode, t as toDisplayString, d as createCommentVNode, b as createBaseVNode, k as withCtx, f as renderList, j as createBlock, w as withModifiers, s as Teleport, r as ref, h as computed } from "./vue-core-Dzs4fLAU.js";
import { _ as _export_sfc, u as useLocale, t, f as fetchWithCache, d as axiosInstance } from "./app-demo-BO0WKfcf.js";
...
const _hoisted_6 = { class: "summary-label" };
const _hoisted_7 = { class: "summary-value" };
const _hoisted_8 = {
  key: 1,
  class: "category-section"
};
const _hoisted_9 = { class: "category-header" };
const _hoisted_10 = { class: "category-path" };
const _hoisted_11 = {
  key: 0,
  class: "category-requirement"
};
const _hoisted_12 = { class: "course-count" };
const _hoisted_13 = { class: "course-list" };
const _hoisted_14 = ["onClick"];
const _hoisted_15 = { class: "course-title" };
const _hoisted_16 = { class: "course-meta" };
const _hoisted_17 = {
  key: 2,
  class: "empty"
};
const _hoisted_18 = { class: "modal-top" };
const _hoisted_19 = { class: "modal-tags" };
const _hoisted_20 = { class: "modal-tag" };
const _hoisted_21 = { class: "modal-path" };
const _hoisted_22 = { class: "detail-grid" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        offline.value || sessionExpired.value ? (openBlock(), createElementBlock("div", {
          ...
          sessionExpired.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            createTextVNode(toDisplayString(unref(t)("academic.error.sessionExpiredCached")), 1)
            ...
            default: withCtx(() => [
              (openBlock(), createElementBlock(Fragment, null, renderList(faszOptions, (f) => {
                return createBaseVNode("option", {
                  key: f.value,
                  value: f.value
                }, toDisplayString(unref(t)(f.labelKey)), 9, _hoisted_3);
              }), 64))
            ]),
            _: 1
          }, 8, ["modelValue"])
        ...
        loading.value ? (openBlock(), createBlock(unref(TEmptyState), {
          ...
          progressData.value ? (openBlock(), createElementBlock("div", _hoisted_4, [
            summaryItems.value.length ? (openBlock(), createElementBlock("div", _hoisted_5, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(summaryItems.value, (item) => {
                return openBlock(), createElementBlock("div", {
                  class: "summary-item",
                  key: item.key
                }, [
                  createBaseVNode("span", _hoisted_6, toDisplayString(unref(t)(item.label)), 1),
                  createBaseVNode("span", _hoisted_7, toDisplayString(item.value), 1)
                ]);
              }), 128))
            ])) : createCommentVNode("", true),
            categorySections.value.length ? (openBlock(), createElementBlock("div", _hoisted_8, [
                ...
                return openBlock(), createElementBlock("section", {
                  ...
                  createBaseVNode("div", _hoisted_9, [
                    createBaseVNode("div", null, [
                      ...
                      createBaseVNode("p", _hoisted_10, toDisplayString(section.path), 1),
                      section.requirement ? (openBlock(), createElementBlock("p", _hoisted_11, toDisplayString(section.requirement), 1)) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("div", _hoisted_12, toDisplayString(section.courses.length) + " " + toDisplayString(unref(t)("academic.unit.courses")), 1)
                  ]),
                  createBaseVNode("div", _hoisted_13, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(section.courses, (course) => {
                      return openBlock(), createElementBlock("button", {
                        ...
                        createBaseVNode("div", _hoisted_15, toDisplayString(normalizeValue(course.kcmc) || "-"), 1),
            ...
            ])) : (openBlock(), createElementBlock("div", _hoisted_17, toDisplayString(unref(t)("academic.empty")), 1))
          ])) : createCommentVNode("", true)
        ], 64)),
            ...
            createBaseVNode("div", {
              ...
              createBaseVNode("div", _hoisted_18, [
                ...
                createBaseVNode("div", _hoisted_19, [
                  createBaseVNode("span", _hoisted_20, toDisplayString(unref(t)("academic.creditPrefix")) + " " + toDisplayString(normalizeValue(selectedCourse.value.xf) || "-"), 1),
                  createBaseVNode("span", {
                ...
                createBaseVNode("div", _hoisted_21, toDisplayString(unref(t)("academic.belongCategory")) + "：" + toDisplayString(selectedCourseCategory.value), 1)
              ]),
              createBaseVNode("div", _hoisted_22, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(selectedCourseFields.value, (item) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("span", _hoisted_23, toDisplayString(unref(t)(item.label)), 1),
                    createBaseVNode("span", _hoisted_24, toDisplayString(item.value), 1)
                  ]);
                }), 128))
              ])
            ])
...
const AcademicProgressView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-296eac03"]]);
export {
