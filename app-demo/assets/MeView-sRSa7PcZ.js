import { r as ref, v as watch, o as onMounted, l as onBeforeUnmount, a as openBlock, c as createElementBlock, b as createBaseVNode, n as normalizeClass, t as toDisplayString, F as Fragment, K as withDirectives, L as vModelText, P as vModelCheckbox, e as createTextVNode, p as createVNode, k as withCtx, d as createCommentVNode, T as Transition, u as unref, h as computed, S as createStaticVNode, j as createBlock, g as renderList, w as withModifiers, C as nextTick } from "./vue-core-DPI62iBa.js";
import { _ as _imports_0 } from "./app_icon-BoqTJkLh.js";
import { _ as _export_sfc, u as useAuthStore, X as loadPortalRememberedPassword, Y as loadChaoxingRememberedPassword, W as fetchRemoteConfig, Z as applyOcrRuntimeConfig, $ as getStoredOcrConfig, b as axiosInstance, a0 as syncPortalRememberCredential, a1 as runExclusiveLogin, s as setCachedData, a2 as saveRememberedCredential, a3 as buildHbutAccountKey, a4 as buildChaoxingAccountKey, o as openExternal, i as showToast } from "./app-demo-BxokP0Ga.js";
import { p as pushDebugLog, R as isTestAccountCredentials, y as saveRememberedUsername, a as isTauriRuntime, d as invokeNative, G as markTestAccountSession, T as TEST_ACCOUNT, S as TEST_ACCOUNT_LOGIN_METHOD, C as seedTestAccountCaches, B as getTestAccountGrades, i as isTestAccountSession, E as clearTestAccountSession } from "./runtime-bridge-HjlgKupV.js";
import { N as NON_OFFICIAL_DISCLAIMER_ZH, l as NON_OFFICIAL_DISCLAIMER_EN, P as PRIVACY_POLICY_URL, I as ICP_BEIAN_TEXT, m as isSponsorEntryAllowed, i as isViewAllowed, o as ICP_BEIAN_URL } from "./more-modules-c4l-U-qE.js";
...
const _hoisted_21$1 = { class: "info-text" };
const _hoisted_22$1 = { class: "input-group" };
const _hoisted_23$1 = { class: "input-group" };
const _hoisted_24$1 = { class: "checkbox-group" };
const _hoisted_25$1 = { class: "checkbox-label" };
const _hoisted_26$1 = ["disabled"];
const _hoisted_27$1 = { class: "action-pills" };
const _hoisted_28$1 = {
  key: 0,
  class: "qr-panel"
};
const _hoisted_29$1 = { class: "qr-image-box" };
const _hoisted_30$1 = ["src"];
const _hoisted_31$1 = {
  key: 1,
  class: "qr-placeholder"
};
const _hoisted_32$1 = { class: "qr-status" };
const _hoisted_33$1 = {
  key: 0,
  class: "qr-countdown"
};
const _hoisted_34$1 = ["disabled"];
const _hoisted_35$1 = { class: "checkbox-group agreement" };
const _hoisted_36$1 = { class: "checkbox-label checkbox-label--agreement" };
const _hoisted_37$1 = { class: "non-official-disclaimer" };
        ...
        loading.value ? (openBlock(), createElementBlock("div", _hoisted_4$1, [
          ...
          isPortalMode.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            ...
            createBaseVNode("div", _hoisted_20$1, [
              createBaseVNode("span", _hoisted_21$1, "OCR 配置：" + toDisplayString(ocrConfigMode.value), 1)
            ])
            ...
            createVNode(Transition, { name: "fade-slide" }, {
              default: withCtx(() => [
                chaoxingQrVisible.value ? (openBlock(), createElementBlock("div", _hoisted_28$1, [
                  createBaseVNode("div", { class: "qr-panel-head" }, [
                  ...
                  createBaseVNode("div", _hoisted_29$1, [
                    cxQrImageBase64.value ? (openBlock(), createElementBlock("img", {
                      ...
                      alt: "学习通扫码二维码",
                      class: "qr-image"
                    }, null, 8, _hoisted_30$1)) : (openBlock(), createElementBlock("div", _hoisted_31$1, toDisplayString(cxQrState.value === "error" ? cxQrStateMessage.value || "二维码加载失败" : "正在生成学习通二维码..."), 1))
                  ]),
                  createBaseVNode("p", _hoisted_32$1, toDisplayString(cxQrStateMessage.value || "请使用学习通 App 扫码登录。"), 1),
                  cxQrRemainingSeconds.value > 0 ? (openBlock(), createElementBlock("p", _hoisted_33$1, "二维码剩余 " + toDisplayString(cxQrRemainingSeconds.value) + " 秒", 1)) : createCommentVNode("", true),
                  createBaseVNode("button", {
                    class: "login-btn",
                    disabled: cxQrSubmitting.value,
                    onClick: _cache[11] || (_cache[11] = ($event) => openChaoxingQrPanel(true))
                  }, toDisplayString(cxQrImageBase64.value ? "刷新学习通二维码" : "生成学习通二维码"), 9, _hoisted_34$1)
                ])) : createCommentVNode("", true)
              ]),
              _: 1
            }),
          ...
          createBaseVNode("p", _hoisted_37$1, toDisplayString(unref(NON_OFFICIAL_DISCLAIMER_ZH)), 1),
...
const LoginV3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-9bc0ec7c"]]);
...
const _hoisted_5 = { class: "profile-actions" };
const _hoisted_6 = {
  key: 0,
  class: "demo-actions"
};
...
const _hoisted_8 = { class: "status-card" };
const _hoisted_9 = { class: "status-left" };
const _hoisted_10 = { class: "status-text" };
const _hoisted_11 = { class: "func-grid" };
const _hoisted_12 = { class: "legal-card about-minihbut-card" };
const _hoisted_13 = { class: "legal-content" };
const _hoisted_14 = { class: "muted-en" };
const _hoisted_15 = { key: 0 };
const _hoisted_16 = { class: "legal-tabs" };
const _hoisted_17 = {
  key: 0,
  class: "legal-content"
};
...
const _hoisted_19 = { class: "icp-beian-footer" };
const _hoisted_20 = { class: "modal-actions" };
const _hoisted_21 = { class: "sponsor-qr-container" };
const _hoisted_22 = {
  key: 0,
...
const _hoisted_27 = { class: "account-info" };
const _hoisted_28 = { class: "account-label" };
const _hoisted_29 = { class: "account-id" };
const _hoisted_30 = {
  key: 0,
...
const _hoisted_36 = { class: "modal-actions" };
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        _cache[52] || (_cache[52] = createStaticVNode('<header class="dashboard-header" data-v-def7a11c><div class="header-left" data-v-def7a11c><img class="logo-img" src="' + _imports_0 + '" alt="HBUT" data-v-def7a11c><span class="header-title" data-v-def7a11c>Mini-HBUT</span></div><span class="header-pill" data-v-def7a11c>我的</span></header>', 1)),
        __props.isLoggedIn ? (openBlock(), createElementBlock("section", _hoisted_2, [
          ...
          createBaseVNode("div", _hoisted_5, [
            ...
            }, "切换账号")) : createCommentVNode("", true),
            createBaseVNode("button", {
              class: "btn-logout",
              onClick: handleLogout
            }, "退出登录")
          ]),
          isDemoSession.value ? (openBlock(), createElementBlock("div", _hoisted_6, [
            _cache[15] || (_cache[15] = createBaseVNode("p", { class: "demo-hint" }, "当前为审核演示模式：页面使用虚构数据，不连接真实校园服务。", -1)),
            createBaseVNode("button", {
              type: "button",
              class: "btn-info",
        ...
        createBaseVNode("section", _hoisted_8, [
          createBaseVNode("div", _hoisted_9, [
            _cache[19] || (_cache[19] = createBaseVNode("div", { class: "status-icon-box" }, [
              createBaseVNode("span", { class: "material-symbols-outlined status-icon" }, "verified_user")
            ], -1)),
            createBaseVNode("div", _hoisted_10, [
              _cache[17] || (_cache[17] = createBaseVNode("span", { class: "status-title" }, "登录状态", -1)),
              _cache[18] || (_cache[18] = createBaseVNode("span", { class: "status-subtitle" }, "静默登录已开启", -1)),
        ...
        createBaseVNode("section", _hoisted_11, [
          ...
          createBaseVNode("button", {
            ...
            createBaseVNode("span", { class: "grid-label" }, "授权记录", -1)
          ])]),
          createBaseVNode("button", {
            class: "grid-item",
        ...
        createBaseVNode("section", _hoisted_12, [
          _cache[37] || (_cache[37] = createBaseVNode("h3", { class: "legal-title" }, "关于 Mini-HBUT", -1)),
          createBaseVNode("div", _hoisted_13, [
            createBaseVNode("p", null, toDisplayString(unref(NON_OFFICIAL_DISCLAIMER_ZH)), 1),
            createBaseVNode("p", _hoisted_14, toDisplayString(unref(NON_OFFICIAL_DISCLAIMER_EN)), 1),
            isDemoSession.value ? (openBlock(), createElementBlock("p", _hoisted_15, " 演示模式说明：当前会话使用本地虚构数据，不连接真实校园服务。可在上方重置演示数据或退出演示。 ")) : createCommentVNode("", true),
            createBaseVNode("button", {
              type: "button",
              class: "privacy-policy-entry",
              onClick: _cache[3] || (_cache[3] = ($event) => unref(openExternal)(unref(PRIVACY_POLICY_URL)))
            }, [..._cache[36] || (_cache[36] = [
              createStaticVNode('<span class="privacy-policy-entry__icon" aria-hidden="true" data-v-def7a11c><span class="material-symbols-outlined" data-v-def7a11c>shield</span></span><span class="privacy-policy-entry__body" data-v-def7a11c><span class="privacy-policy-entry__title" data-v-def7a11c>隐私政策</span><span class="privacy-policy-entry__desc" data-v-def7a11c>在系统浏览器中打开完整政策</span></span><span class="privacy-policy-entry__chev material-symbols-outlined" aria-hidden="true" data-v-def7a11c>open_in_new</span>', 3)
            ])])
          ])
        ]),
        createBaseVNode("section", {
          ...
          _cache[40] || (_cache[40] = createBaseVNode("h3", { class: "legal-title" }, "免责声明与隐私政策", -1)),
          ...
          activeLegalTab.value === "disclaimer" ? (openBlock(), createElementBlock("div", _hoisted_17, [..._cache[38] || (_cache[38] = [
          ...
          ])])) : (openBlock(), createElementBlock("div", _hoisted_18, [..._cache[39] || (_cache[39] = [
            createStaticVNode("<p data-v-def7a11c>我们仅收集提供服务所必需的数据，并采取合理措施保护数据安全。</p><ul data-v-def7a11c><li data-v-def7a11c><strong data-v-def7a11c>收集内容</strong>：学号、登录会话信息、验证码参数、查询所需的临时授权信息。</li><li data-v-def7a11c><strong data-v-def7a11c>使用目的</strong>：用于身份验证、成绩/课表/电费等查询与展示。</li><li data-v-def7a11c><strong data-v-def7a11c>存储方式</strong>：本地会存储加密后的账号凭据与缓存数据；后端仅保存必要的会话与授权信息。</li><li data-v-def7a11c><strong data-v-def7a11c>数据共享</strong>：不会向无关第三方共享个人信息，除非获得你的明确授权或法律要求。</li><li data-v-def7a11c><strong data-v-def7a11c>数据保留</strong>：仅在实现功能所需期限内保留，可通过退出登录清理会话。</li></ul><p data-v-def7a11c>继续使用即表示你已阅读并同意本隐私政策。</p>", 3)
          ])]))
        ], 512),
        createBaseVNode("footer", _hoisted_19, [
          createBaseVNode("button", {
            type: "button",
          ...
          default: withCtx(() => [
            showOpenSourceModal.value ? (openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", {
                ...
                _cache[43] || (_cache[43] = createBaseVNode("h3", null, [
                  createBaseVNode("span", { class: "material-symbols-outlined opensource-title-icon" }, "menu_book"),
                  createTextVNode(" 开源说明")
                ], -1)),
                _cache[44] || (_cache[44] = createBaseVNode("p", { class: "intro" }, "Mini-HBUT 是一个开源项目，致力于提供更好的校园信息查询体验。", -1)),
                createBaseVNode("div", { class: "section" }, [
                  _cache[42] || (_cache[42] = createBaseVNode("p", { class: "label" }, "项目地址", -1)),
                  createBaseVNode("a", {
                    class: "github-link",
                    onClick: openGithub
                  }, [..._cache[41] || (_cache[41] = [
                ...
                _cache[45] || (_cache[45] = createBaseVNode("div", { class: "section" }, [
                  createBaseVNode("p", { class: "label" }, "开源技术"),
                  createBaseVNode("ul", { class: "opensource-list" }, [
                    createBaseVNode("li", null, [
                      createBaseVNode("span", { class: "tag" }, "前端"),
                      createTextVNode(" Tauri / Vue 3 / Vite")
                    ]),
                    createBaseVNode("li", null, [
                      createBaseVNode("span", { class: "tag" }, "后端"),
                      createTextVNode(" Rust (reqwest / scraper / serde)")
                    ]),
                    createBaseVNode("li", null, [
                      createBaseVNode("span", { class: "tag" }, "感谢"),
                      createTextVNode(" 所有开源贡献者")
                    ])
                  ])
                ], -1)),
                _cache[46] || (_cache[46] = createBaseVNode("div", { class: "section thanks" }, [
                  createBaseVNode("p", null, [
                    createTextVNode("感谢原 "),
                    createBaseVNode("strong", null, "Mini湖工"),
                    createTextVNode(" 小程序的开发者，为本项目提供了宝贵的灵感")
                  ]),
                  createBaseVNode("p", null, [
                    createTextVNode("感谢开发者的 "),
                    createBaseVNode("strong", null, "朋友们和舍友们"),
                    createTextVNode("，提供了测试和反馈")
                  ]),
                  createBaseVNode("p", { class: "highlight" }, "感谢所有为 Mini-HBUT 做出贡献的人！ 🎉")
                ], -1)),
          ...
          default: withCtx(() => [
            showSponsorModal.value && showSponsorEntry.value ? (openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", {
                ...
                _cache[47] || (_cache[47] = createBaseVNode("h3", null, "❤️ 赞助支持", -1)),
                _cache[48] || (_cache[48] = createBaseVNode("p", { class: "intro" }, "如果 Mini-HBUT 对你有帮助，欢迎请作者喝杯咖啡 ☕", -1)),
                createBaseVNode("div", _hoisted_21, [
                  sponsorImageLoading.value ? (openBlock(), createElementBlock("div", _hoisted_22, "加载中...")) : sponsorImageUrl.value ? (openBlock(), createElementBlock("img", {
                    key: 1,
                ...
                _cache[49] || (_cache[49] = createBaseVNode("p", { class: "sponsor-hint" }, "长按或截图扫码 · 微信赞赏", -1)),
          ...
          default: withCtx(() => [
            showAccountSwitchModal.value ? (openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", {
                ...
                _cache[50] || (_cache[50] = createBaseVNode("h3", null, [
                  createBaseVNode("span", { class: "material-symbols-outlined account-switch-title-icon" }, "swap_account"),
                  createTextVNode(" 切换账号")
                ], -1)),
                _cache[51] || (_cache[51] = createBaseVNode("p", { class: "intro" }, "在本机已登录账号间快速切换（免重新登录，不会发起网络登录）。切换后自动刷新成绩与课表。", -1)),
                savedAccounts.value.length ? (openBlock(), createElementBlock("ul", _hoisted_25, [
                    ...
                    return openBlock(), createElementBlock("li", {
                      ...
                      createBaseVNode("div", {
                        ...
                        createBaseVNode("div", _hoisted_27, [
                          createBaseVNode("span", _hoisted_28, toDisplayString(acc.display_name || acc.masked_id), 1),
                          createBaseVNode("span", _hoisted_29, toDisplayString(acc.masked_id), 1)
                        ]),
                        acc.is_current ? (openBlock(), createElementBlock("span", _hoisted_30, "当前")) : switchingAccount.value === acc.student_id ? (openBlock(), createElementBlock("span", _hoisted_31, "切换中…")) : !acc.has_cookies ? (openBlock(), createElementBlock("span", _hoisted_32, "需重新登录")) : (openBlock(), createElementBlock("span", _hoisted_33, "可切换"))
                      ], 8, _hoisted_26),
                      ...
                      }, "删除", 8, _hoisted_34)) : createCommentVNode("", true)
                    ], 2);
                  }), 128))
                ])) : (openBlock(), createElementBlock("p", _hoisted_35, "暂无其他已保存账号，登录新账号后会出现在这里。")),
...
const MeView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-def7a11c"]]);
export {
  MeView as default
};
