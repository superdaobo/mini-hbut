const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./app-demo-DqAlnDLf.js","./runtime-bridge-i9KZPKjs.js","./more-modules-rEERMQm_.js","./vue-core-Dzs4fLAU.js","./capture-D-zd0oUS.js","./app-demo-DxCFPTvw.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, p as pushDebugLog, a as isTauriRuntime, d as invokeNative } from "./runtime-bridge-i9KZPKjs.js";
...
const syncWidgetThemeMode = (mode) => {
  if (typeof window === "undefined") return;
  __vitePreload(() => import("./app-demo-DqAlnDLf.js").then((n) => n.aY), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0, import.meta.url).then((mod) => {
    const bridge = mod;
...
const initDebugBridgeClient = async () => {
  ...
  const eventApi = await __vitePreload(() => import("./runtime-bridge-i9KZPKjs.js").then((n) => n.aa), true ? __vite__mapDeps([1,2]) : void 0, import.meta.url);
