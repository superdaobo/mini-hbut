...
import { _ as __vitePreload, i as isTestAccountSession } from "./runtime-bridge-HjlgKupV.js";
import { _ as _export_sfc, u as useAuthStore, c as cloneWorkspaceLayout, a as useUiSettings, g as getCachedData, f as fetchWithCache, b as axiosInstance, D as DEFAULT_SWR_OPTIONS, s as setCachedData, d as decideHomeNavigate, e as flushUiSettings, h as buildDefaultWorkspaceLayout, r as readScheduleLockDetail, o as openExternal, i as showToast } from "./app-demo-BxokP0Ga.js";
import { a as openBlock, c as createElementBlock, t as toDisplayString, f as normalizeStyle, n as normalizeClass, h as computed, J as onScopeDispose, r as ref, b as createBaseVNode, e as createTextVNode, d as createCommentVNode, F as Fragment, g as renderList, w as withModifiers, j as createBlock, K as withDirectives, L as vModelText, s as Teleport, p as createVNode, k as withCtx, T as Transition, v as watch, o as onMounted, l as onBeforeUnmount, C as nextTick } from "./vue-core-DPI62iBa.js";
import { _ as _sfc_main$2, L as LayoutCollisionFxLayer, r as resolveRelativeCollisionPoint, a as resolveCollisionPalette, c as createLayoutCollisionBurst, b as advanceLayoutCollisionFx, d as resolveLayoutSlotTarget, m as moveLayoutItemToIndex, e as captureLayoutSlotAnchors } from "./layout_collision_fx-C-O1ZrfZ.js";
import { j as isModuleAllowed, k as filterAllowedModules } from "./more-modules-c4l-U-qE.js";
...
const _hoisted_5 = { class: "dashboard-main px-4 pb-6" };
const _hoisted_6 = { class: "home-area-greet flex justify-between items-end" };
...
const _hoisted_12 = { class: "home-area-user bg-white rounded-2xl p-4 flex items-center justify-between gap-3 card-shadow" };
...
const _hoisted_31 = { class: "home-col-left" };
const _hoisted_32 = { class: "bg-white rounded-2xl p-5 card-shadow relative" };
const _hoisted_33 = { class: "flex justify-between items-center mb-5" };
const _hoisted_34 = {
  key: 0,
...
const _hoisted_39 = { class: "w-12 flex flex-col items-start shrink-0" };
const _hoisted_40 = { class: "text-sm font-medium text-gray-800 leading-tight" };
const _hoisted_41 = { class: "text-xs text-gray-400 mt-0.5" };
const _hoisted_42 = { class: "flex-1 flex justify-between items-start pl-1 pr-1" };
const _hoisted_43 = { class: "min-w-0 flex-1 mr-2" };
const _hoisted_44 = { class: "font-medium text-gray-800 text-base truncate" };
const _hoisted_45 = { class: "text-xs text-gray-500 mt-1 flex items-center" };
const _hoisted_46 = {
  key: 1,
...
const _hoisted_47 = { class: "w-12 flex flex-col items-start shrink-0 text-white relative z-10" };
const _hoisted_48 = { class: "text-sm font-bold leading-tight" };
const _hoisted_49 = { class: "text-xs opacity-80 mt-0.5" };
const _hoisted_50 = { class: "flex-1 text-white relative z-10 pl-1 pr-20" };
const _hoisted_51 = { class: "text-[10px] bg-blue-400 bg-opacity-50 px-2 py-0.5 rounded text-white inline-block mb-1" };
const _hoisted_52 = { class: "font-bold text-xl mb-1" };
const _hoisted_53 = { class: "text-xs opacity-90 flex items-center" };
const _hoisted_54 = { class: "absolute right-0 top-0 bottom-0 flex flex-col justify-center items-end w-36" };
const _hoisted_55 = { class: "relative z-10 text-right mb-2 text-white text-xs pr-3" };
const _hoisted_56 = { class: "w-12 flex flex-col items-start shrink-0" };
const _hoisted_57 = { class: "text-sm font-medium text-gray-800 leading-tight" };
const _hoisted_58 = { class: "text-xs text-gray-400 mt-0.5" };
const _hoisted_59 = { class: "flex-1 flex justify-between items-start pl-1 pr-1" };
const _hoisted_60 = { class: "min-w-0 flex-1 mr-2" };
const _hoisted_61 = { class: "font-medium text-gray-800 text-base truncate" };
const _hoisted_62 = { class: "text-xs text-gray-500 mt-1 flex items-center" };
const _hoisted_63 = {
  key: 5,
...
const _hoisted_65 = { class: "text-sm font-bold text-gray-800" };
const _hoisted_66 = { class: "flex items-center space-x-2" };
const _hoisted_67 = { class: "text-sm font-bold text-gray-800" };
const _hoisted_68 = { class: "flex items-center space-x-2" };
const _hoisted_69 = { class: "text-sm font-bold text-gray-800" };
const _hoisted_70 = { class: "home-col-right" };
const _hoisted_71 = { class: "bg-white rounded-2xl p-5 card-shadow" };
const _hoisted_72 = { class: "grid grid-cols-5 gap-y-4" };
const _hoisted_73 = ["onClick"];
const _hoisted_74 = ["data-module"];
const _hoisted_75 = { class: "text-[11px] text-gray-600" };
const _hoisted_76 = { class: "bg-white rounded-2xl p-5 card-shadow home-all-features" };
const _hoisted_77 = {
...
const _hoisted_80 = { class: "text-xs text-gray-700 text-center" };
const _hoisted_81 = { class: "w-full max-w-md bg-white rounded-[24px] shadow-2xl overflow-hidden animate-scale-in" };
const _hoisted_82 = { class: "px-4 pt-4 pb-3 border-b border-gray-100" };
const _hoisted_83 = { class: "flex items-center gap-2" };
const _hoisted_84 = { class: "relative flex-1" };
const _hoisted_85 = { class: "max-h-[68vh] overflow-y-auto px-4 py-4" };
const _hoisted_86 = {
  key: 0,
  class: "space-y-3"
};
const _hoisted_87 = { class: "grid grid-cols-2 gap-2" };
const _hoisted_88 = ["onClick"];
const _hoisted_89 = { class: "min-w-0" };
const _hoisted_90 = { class: "block text-sm text-gray-800 truncate" };
const _hoisted_91 = { class: "block text-xs text-gray-400 truncate" };
const _hoisted_92 = {
  key: 1,
  class: "space-y-5"
};
const _hoisted_93 = { class: "text-xs font-semibold text-gray-400 px-1" };
const _hoisted_94 = ["onClick"];
const _hoisted_95 = { class: "min-w-0 flex-1" };
const _hoisted_96 = { class: "block text-sm text-gray-800 truncate" };
const _hoisted_97 = { class: "block text-xs text-gray-400 truncate" };
const _hoisted_98 = {
  key: 2,
  class: "py-10 text-center"
};
const _hoisted_99 = { class: "w-[92%] max-w-sm rounded-[28px] overflow-hidden shadow-2xl animate-scale-in bg-white" };
const _hoisted_100 = { class: "flex justify-between items-start relative z-10" };
const _hoisted_101 = { class: "text-center my-6 relative z-10" };
const _hoisted_102 = { class: "flex justify-center gap-3 relative z-10" };
const _hoisted_103 = { class: "bg-black/5 backdrop-blur-sm rounded-full px-3 py-1.5 flex items-center gap-1.5" };
const _hoisted_104 = { class: "bg-black/5 backdrop-blur-sm rounded-full px-3 py-1.5 flex items-center gap-1.5" };
const _hoisted_105 = { class: "bg-black/5 backdrop-blur-sm rounded-full px-3 py-1.5 flex items-center gap-1.5" };
const _hoisted_106 = { class: "bg-white px-5 pt-5 pb-4" };
const _hoisted_107 = { class: "flex gap-4 overflow-x-auto pb-2 scrollbar-hide" };
const _hoisted_108 = { class: "text-[11px] text-gray-500 mb-1.5" };
const _hoisted_109 = { class: "text-sm font-semibold text-gray-800" };
const _hoisted_110 = { class: "bg-white px-5 pt-3 pb-5 border-t border-gray-100/80" };
const _hoisted_111 = { class: "space-y-3" };
const _hoisted_112 = { class: "text-sm text-gray-600 w-10 font-medium" };
const _hoisted_113 = { class: "text-xs text-gray-400 w-10 ml-1" };
const _hoisted_114 = { class: "flex-1 mx-2 h-[6px] rounded-full bg-gray-100 relative overflow-hidden" };
const _hoisted_115 = { class: "quick-entry-editor-panel modal-pop-card w-full max-w-md bg-white rounded-t-3xl p-6 max-h-[80vh] overflow-y-auto" };
const _hoisted_116 = { class: "flex items-center justify-between mb-4" };
const _hoisted_117 = { class: "text-xs text-gray-500 mb-4" };
const _hoisted_118 = { class: "grid grid-cols-4 gap-3 mb-6" };
const _hoisted_119 = ["onClick"];
const _hoisted_120 = ["data-module"];
const _hoisted_121 = { class: "text-[10px] text-gray-600 text-center" };
const _hoisted_122 = {
  key: 0,
    ...
    createBaseVNode("main", _hoisted_5, [
      createBaseVNode("div", _hoisted_6, [
        createBaseVNode("div", null, [
          createBaseVNode("h1", _hoisted_7, toDisplayString($setup.greetingText), 1),
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", _hoisted_8, [
            createBaseVNode("div", _hoisted_9, [
              ...
              createBaseVNode("span", _hoisted_10, toDisplayString($setup.weatherData.temp) + "°C", 1)
            ]),
            createBaseVNode("span", _hoisted_11, toDisplayString($setup.weatherData.condition), 1)
          ])
        ])
      ]),
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", _hoisted_13, [
            createBaseVNode("div", _hoisted_14, [
              createBaseVNode("h2", _hoisted_15, toDisplayString($props.studentId || "未登录"), 1),
              _cache[14] || (_cache[14] = createBaseVNode("span", { class: "bg-gray-100 text-gray-500 text-[10px] px-2 py-0.5 rounded-sm shrink-0" }, "本科生", -1))
            ]),
            createBaseVNode("p", _hoisted_16, toDisplayString($setup.userCollegeInfo), 1)
          ])
        ]),
      ...
      $setup.sessionDetailOpen && $setup.sessionStatusVisual !== "green" ? (openBlock(), createElementBlock("div", _hoisted_18, [
        createBaseVNode("div", _hoisted_19, [
          createBaseVNode("div", _hoisted_20, [
            createBaseVNode("div", _hoisted_21, toDisplayString($setup.maintenanceTitle), 1),
            createBaseVNode("div", _hoisted_22, toDisplayString($setup.maintenancePhaseLabel), 1)
          ]),
          createBaseVNode("button", {
            type: "button",
        ...
        createBaseVNode("div", _hoisted_23, toDisplayString($props.jwxtMaintenanceHint || ($setup.onlineSessionState === "cached_offline" && $props.jwxtRecoveryPhase === "idle" ? "已恢复本地身份，教务在线会话未恢复，正在后台尝试恢复；成绩与课表缓存可正常查看，无需重新登录。" : $setup.sessionStatusVisual === "blink" ? "正在后台恢复登录会话，请稍候…" : "当前可能无法同步最新教务数据，可查看下方详情或重试。")), 1),
        $props.jwxtMaintenanceDetail ? (openBlock(), createElementBlock("div", _hoisted_24, [
        ...
        $props.jwxtLastCheckTime ? (openBlock(), createElementBlock("div", _hoisted_25, " 最近检查：" + toDisplayString($props.jwxtLastCheckTime), 1)) : createCommentVNode("", true),
        $setup.maintenanceNotices.length ? (openBlock(), createElementBlock("div", _hoisted_26, [
        ...
        createBaseVNode("div", _hoisted_29, [
          ...
          }, toDisplayString($props.jwxtRecoveryPhase === "recovering" ? "正在恢复…" : "立即重试"), 9, _hoisted_30)) : createCommentVNode("", true),
      ...
      createBaseVNode("div", _hoisted_31, [
        createBaseVNode("div", _hoisted_32, [
          ...
          !$props.isLoggedIn ? (openBlock(), createElementBlock("div", _hoisted_34, "登录后可查看今日课程")) : $setup.todayLoading ? (openBlock(), createElementBlock("div", _hoisted_35, "正在加载今日课程...")) : $setup.todayError ? (openBlock(), createElementBlock("div", _hoisted_36, toDisplayString($setup.todayError), 1)) : $setup.todayCourses.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_37, [..._cache[21] || (_cache[21] = [
            createBaseVNode("img", {
              src: _imports_1,
              ...
              return openBlock(), createElementBlock("div", {
                ...
                course.endMinutes <= $setup.currentMinutePrecise ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                  ...
                  createBaseVNode("div", _hoisted_39, [
                    createBaseVNode("span", _hoisted_40, toDisplayString(course.start), 1),
                    createBaseVNode("span", _hoisted_41, "~ " + toDisplayString(course.end), 1)
                  ]),
                  createBaseVNode("div", _hoisted_42, [
                    createBaseVNode("div", _hoisted_43, [
                      createBaseVNode("h4", _hoisted_44, toDisplayString(course.name), 1),
                      createBaseVNode("p", _hoisted_45, [
                ...
                ], 64)) : idx === 0 || $setup.todayCourses[idx - 1] && $setup.todayCourses[idx - 1].endMinutes <= $setup.currentMinutePrecise && course.endMinutes > $setup.currentMinutePrecise ? (openBlock(), createElementBlock("div", _hoisted_46, [
                  ...
                  createBaseVNode("div", _hoisted_47, [
                    createBaseVNode("span", _hoisted_48, toDisplayString(course.start), 1),
                    createBaseVNode("span", _hoisted_49, "~ " + toDisplayString(course.end), 1)
                  ]),
                  createBaseVNode("div", _hoisted_50, [
                    createBaseVNode("span", _hoisted_51, toDisplayString(course.startMinutes <= $setup.currentMinutePrecise ? "进行中" : "下一节"), 1),
                    createBaseVNode("h4", _hoisted_52, toDisplayString(course.name), 1),
                  ...
                  createBaseVNode("div", _hoisted_54, [
                    ...
                    createBaseVNode("div", _hoisted_55, toDisplayString($setup.getCourseCountdown(course)), 1),
                    createBaseVNode("button", {
                  ...
                  createBaseVNode("div", _hoisted_56, [
                    createBaseVNode("span", _hoisted_57, toDisplayString(course.start), 1),
                    createBaseVNode("span", _hoisted_58, "~ " + toDisplayString(course.end), 1)
                  ]),
                  createBaseVNode("div", _hoisted_59, [
                    createBaseVNode("div", _hoisted_60, [
                      createBaseVNode("h4", _hoisted_61, toDisplayString(course.name), 1),
          ...
          $setup.todayCourses.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_63, [
          ...
          createBaseVNode("div", _hoisted_72, [
            (openBlock(true), createElementBlock(Fragment, null, renderList($setup.quickEntryItems, (item) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_75, toDisplayString(item.name), 1)
              ], 8, _hoisted_73);
            }), 128))
          ])
        ]),
        createBaseVNode("div", _hoisted_76, [
          ...
          createBaseVNode("div", _hoisted_77, [
            (openBlock(true), createElementBlock(Fragment, null, renderList($setup.moduleCategories, (cat) => {
              ...
              }, toDisplayString(cat.title), 11, _hoisted_78);
            }), 128))
          ]),
          createBaseVNode("div", {
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList($setup.featureTabModules, (mod) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_80, toDisplayString(mod.name), 1)
              ], 8, _hoisted_79);
            }), 128))
          ], 4)
        ])
      ...
      $setup.showHomeSearch ? (openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_81, [
          ...
          createBaseVNode("div", _hoisted_85, [
            !$setup.homeSearchHasQuery ? (openBlock(), createElementBlock("div", _hoisted_86, [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList($setup.homeSearchSuggestions, (item) => {
                  return openBlock(), createElementBlock("button", {
                    ...
                    createBaseVNode("span", _hoisted_89, [
                      createBaseVNode("strong", _hoisted_90, toDisplayString(item.title), 1),
                      createBaseVNode("small", _hoisted_91, toDisplayString(item.subtitle), 1)
                    ])
                  ], 8, _hoisted_88);
                }), 128))
              ])
            ])) : $setup.homeSearchSections.length ? (openBlock(), createElementBlock("div", _hoisted_92, [
              (openBlock(true), createElementBlock(Fragment, null, renderList($setup.homeSearchSections, (section) => {
                return openBlock(), createElementBlock("section", {
                  key: section.title,
                  class: "space-y-2"
                }, [
                  createBaseVNode("p", _hoisted_93, toDisplayString(section.title), 1),
                  (openBlock(true), createElementBlock(Fragment, null, renderList(section.items, (item) => {
                    return openBlock(), createElementBlock("button", {
                      ...
                      createBaseVNode("span", _hoisted_95, [
                        createBaseVNode("strong", _hoisted_96, toDisplayString(item.title), 1),
                        createBaseVNode("small", _hoisted_97, toDisplayString(item.subtitle), 1)
                      ]),
            ...
            ])) : (openBlock(), createElementBlock("div", _hoisted_98, [..._cache[50] || (_cache[50] = [
            ...
            createBaseVNode("div", _hoisted_107, [
              (openBlock(true), createElementBlock(Fragment, null, renderList($setup.hourlyForecast, (h) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("span", _hoisted_108, toDisplayString(h.time), 1),
                  createBaseVNode("i", {
                    class: normalizeClass(["fas mb-1.5", h.icon]),
                    style: normalizeStyle({ color: $setup.getWeatherIconColor(h.condition) })
                  }, null, 6),
                  createBaseVNode("span", _hoisted_109, toDisplayString(h.temp) + "°", 1)
                ]);
              }), 128))
            ])
          ]),
            ...
            createBaseVNode("div", _hoisted_111, [
              (openBlock(true), createElementBlock(Fragment, null, renderList($setup.weatherData.forecast, (f) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("span", _hoisted_112, toDisplayString(f.day), 1),
                  createBaseVNode("i", {
                    class: normalizeClass(["fas w-6 text-center", f.icon]),
                    style: normalizeStyle({ color: $setup.getWeatherIconColor(f.condition) })
                  }, null, 6),
                  createBaseVNode("span", _hoisted_113, toDisplayString(f.condition), 1),
                  createBaseVNode("span", {
        ...
        default: withCtx(() => [
          $setup.showQuickEntryEditor ? (openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", _hoisted_115, [
              ...
              createBaseVNode("p", _hoisted_117, "选择 5 个模块作为快捷入口（已选 " + toDisplayString($setup.draftQuickEntries.length) + "/5）", 1),
              createBaseVNode("div", _hoisted_118, [
                (openBlock(true), createElementBlock(Fragment, null, renderList($setup.editableQuickEntryMeta, (meta, id) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("span", _hoisted_121, toDisplayString(meta.name), 1),
                    $setup.draftQuickEntries.includes(id) ? (openBlock(), createElementBlock("div", _hoisted_122, [..._cache[55] || (_cache[55] = [
...
const _sfc_main = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const fetchWeather = async (force = false) => {
      ...
      try {
        const { invokeNative } = await __vitePreload(async () => {
          const { invokeNative: invokeNative2 } = await import("./runtime-bridge-HjlgKupV.js").then((n) => n.a7);
    ...
    const __returned__ = { props, emit, maintenanceTitle, maintenancePhaseLabel, maintenanceNotices, sessionDetailOpen, authStore, onlineSessionState, sessionStatusVisual, sessionStatusAria, onSessionStatusClick, uiSettings, brokenImages, cardListeners, isMobileNoticeSwipe, isTickerInteracting, get tickerResumeTimer() {
      ...
      clockTimer = v;
    }, CLOCK_TICK_MS, periodTimeMap, toMinutes, currentMinute, greetingText, userCollegeInfo, currentMinutePrecise, currentTimeText, timelineCourses, todayBlockTitle, syncNowTick, handleVisibilityRefresh, getTodayWeekday, getCurrentWeek, getPreferredScheduleSemester, isVacationPreviousMeta, buildScheduleCacheKey, toPositiveInt: toPositiveInt2, normalizeWeeks: normalizeWeeks2, getCoursePeriodRange: getCoursePeriodRange2, getTodayCourseSignature, fetchCustomCoursesForToday, buildTodayCourses, fetchTodayCourses, baseModules, modules, homeWorkspaceRef, isHomeLayoutEditing, showAllModules, draftHomeWidgetsOrder, draftHomeModuleOrder, activeHomeDragSection, hoverLayoutKey, orderedModules, displayModules, homeWidgetOrder, isChaoxingLogin, homeCollisionFx, moduleCategories, handleCategoryModuleClick, get homeLayoutLongPressTimer() {
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", render], ["__scopeId", "data-v-fd8fe249"]]);
export {
