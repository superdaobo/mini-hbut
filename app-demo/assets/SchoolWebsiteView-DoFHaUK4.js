const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./school_website_embed-BlB2_i4v.js","./runtime-bridge-HjlgKupV.js","./more-modules-c4l-U-qE.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, F as isAndroidLike } from "./runtime-bridge-HjlgKupV.js";
import { _ as _export_sfc, o as openExternal } from "./app-demo-BxokP0Ga.js";
import { forceCloseSchoolWebsiteEmbed, resolveSchoolWebsiteEmbedMode, mountSchoolWebsiteEmbed, SCHOOL_WEBSITE_URL, resolveSchoolWebsiteIframeUrl } from "./school_website_embed-BlB2_i4v.js";
import { o as onMounted, C as nextTick, l as onBeforeUnmount, a as openBlock, c as createElementBlock, b as createBaseVNode, d as createCommentVNode, t as toDisplayString, r as ref, h as computed } from "./vue-core-DPI62iBa.js";
    ...
    const remountAfterResume = async (eventDetail = null) => {
      ...
      try {
        const { recoverSchoolWebsiteBridgeOnResume } = await __vitePreload(async () => {
          const { recoverSchoolWebsiteBridgeOnResume: recoverSchoolWebsiteBridgeOnResume2 } = await import("./school_website_embed-BlB2_i4v.js");
