import { i as isTestAccountSession, a as isTauriRuntime, b as isLikelyAndroidUserAgent, _ as __vitePreload, t as toNativeFileSrc, g as getNativeAppVersion, p as pushDebugLog, c as isCapacitorRuntime } from "./runtime-bridge-Ds80RevU.js";
...
const fetchJsonViaCapacitor = async (url, timeoutMs = DEFAULT_REMOTE_JSON_TIMEOUT_MS) => {
  const core = await __vitePreload(() => import("./runtime-bridge-Ds80RevU.js").then((n) => n.V), true ? [] : void 0, import.meta.url);
...
const invokeNativeBridge = async (command, args, label = "") => {
  const core = await __vitePreload(() => import("./runtime-bridge-Ds80RevU.js").then((n) => n.Z), true ? [] : void 0, import.meta.url);
  try {
