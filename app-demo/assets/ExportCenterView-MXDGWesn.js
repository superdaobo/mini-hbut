...
import { a as isTauriRuntime, c as isCapacitorRuntime, _ as __vitePreload, d as invokeNative } from "./runtime-bridge-HjlgKupV.js";
import { o as onMounted, a as openBlock, c as createElementBlock, b as createBaseVNode, S as createStaticVNode, t as toDisplayString, F as Fragment, g as renderList, n as normalizeClass, K as withDirectives, P as vModelCheckbox, d as createCommentVNode, e as createTextVNode, h as computed, r as ref, C as nextTick } from "./vue-core-DPI62iBa.js";
import { _ as _export_sfc, f as fetchWithCache, b as axiosInstance, n as normalizeSemesterList, j as resolveCurrentSemester } from "./app-demo-BxokP0Ga.js";
  ...
  setup(__props, { emit: __emit }) {
    ...
    const saveByCapacitor = async (fileName, blob) => {
      ...
      const { Share } = await __vitePreload(async () => {
        const { Share: Share2 } = await import("./runtime-bridge-HjlgKupV.js").then((n) => n.ad);
        return { Share: Share2 };
      }, true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
      await Share.share({
        title: fileName,
