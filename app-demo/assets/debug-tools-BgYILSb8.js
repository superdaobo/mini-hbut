...
import { p as pushDebugLog, a as isTauriRuntime, _ as __vitePreload, d as invokeNative } from "./runtime-bridge-BU9jeOXP.js";
...
const initDebugBridgeClient = async () => {
  ...
  const eventApi = await __vitePreload(() => import("./runtime-bridge-BU9jeOXP.js").then((n) => n.a9), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
