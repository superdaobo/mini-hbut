...
import { L as getIdentityDeviceDisplayName, W as identityDeviceStatus, X as identityRevokeCurrentDeviceLocal, a as isTauriRuntime, d as invokeNative, Y as parseMiniHbutDeepLink, Z as IDENTITY_REQUEST_ID_PATTERN, $ as IDENTITY_HANDOFF_PATTERN, Q as isMobileLike, s as detectRuntime, V as subscribeDebugLogs, M as getDebugLogs, p as pushDebugLog, N as formatDebugTime, a0 as clearDebugLogs, _ as __vitePreload } from "./runtime-bridge-BDjl3Bnt.js";
import { m as useI18n, al as identityUiState, am as setIdentityDeviceRefreshing, an as setIdentityDeviceError, ao as setIdentityDeviceStatus, j as showToast, ap as setIdentityRevoking, aq as getIdentityCoreBaseUrl, ar as clearIdentityDeviceMeta, _ as _export_sfc, u as useLocale, V as CLOUD_SYNC_UPDATED_EVENT, as as FONT_CDN_OPTIONS, q as useAppSettings, at as getCloudSyncLocalStatus, au as setLocale, av as getCloudSyncRuntimeConfig, ab as getStoredOcrConfig, aa as applyOcrRuntimeConfig, aw as useFontSettings, ax as setFontCdnProvider, ay as prefetchCdnFonts, az as loadDeyiHeiFont, aA as ensureFontLoaded, aB as resetAppSettings, aC as DEFAULT_CLOUD_SYNC_ENDPOINT, aD as DEFAULT_BACKEND_TARGETS, b as useUiSettings, h as flushUiSettings } from "./app-demo-BO0WKfcf.js";
...
import { g as getNightModePreference, i as isNightModeEnabled, a as initNightModeClass, s as setNightModePreference, b as resolveNightModeDark } from "./debug-tools-BCmRTX-T.js";
...
const _sfc_main = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const probeViaCapacitorHttp = async (url, timeoutMs) => {
      ...
      try {
        const core = await __vitePreload(() => import("./runtime-bridge-BDjl3Bnt.js").then((n) => n.a4), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
...
const SettingsView = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", render], ["__scopeId", "data-v-71c29684"]]);
export {
