import { a as isTauriRuntime, p as pushDebugLog, L as isMobileLike, e as platformBridge, d as invokeNative } from "./runtime-bridge-Ds80RevU.js";
import { _ as _export_sfc, ay as getChaoxingClassConfig, Q as fetchRemoteConfig, h as showToast, R as loadPortalRememberedPassword, o as openExternal } from "./app-demo-B5kEWRyP.js";
import { _ as _sfc_main$1 } from "./TPageHeader-DdEaHsvo.js";
import { a as openBlock, c as createElementBlock, p as createVNode, Q as createSlots, k as withCtx, b as createBaseVNode, n as normalizeClass, t as toDisplayString, F as Fragment, d as createCommentVNode, e as createTextVNode, g as renderList, m as withKeys, w as withModifiers, j as createBlock, s as Teleport, r as ref, o as onMounted, h as computed } from "./vue-core-C6WYunHF.js";
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1, [
    ...
    $setup.loadingBoot ? (openBlock(), createElementBlock("div", _hoisted_3, [
      ...
      createBaseVNode("p", _hoisted_4, toDisplayString($setup.bootPhase === "sso" ? "正在连接学习通会话…" : $setup.bootPhase === "preview" ? "正在获取班级信息…" : "首次进入需完成门户 SSO，请稍候…"), 1),
      ...
      !$setup.ssoReady || $setup.ssoHint ? (openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("span", _hoisted_5, toDisplayString($setup.ssoReady ? $setup.ssoHint || "门户已连接" : $setup.ssoHint || "会话异常"), 1),
      ...
      $setup.error ? (openBlock(), createElementBlock("div", _hoisted_6, [
        createBaseVNode("p", _hoisted_7, toDisplayString($setup.error), 1),
      ...
      $setup.isJoined ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [
        createBaseVNode("header", _hoisted_9, [
          createBaseVNode("div", _hoisted_10, [
            createBaseVNode("div", _hoisted_11, [
              ...
              $setup.teacherName ? (openBlock(), createElementBlock("p", _hoisted_13, toDisplayString($setup.teacherName) + " · " + toDisplayString($setup.statusMsg || `${$setup.resourceCount} 项`), 1)) : createCommentVNode("", true)
            ])
          ]),
          createBaseVNode("div", _hoisted_14, [
            (openBlock(), createElementBlock(Fragment, null, renderList($setup.filterChips, (chip) => {
          ...
          createBaseVNode("div", _hoisted_16, [
            createBaseVNode("span", _hoisted_17, [
              createTextVNode(toDisplayString($setup.currentFolder?.name || "智能排序") + " ", 1),
              _cache[10] || (_cache[10] = createBaseVNode("span", { class: "material-symbols-outlined" }, "expand_more", -1))
            ]),
            createBaseVNode("span", _hoisted_18, toDisplayString($setup.filteredResources.length) + " 项", 1)
          ]),
          $setup.folderStack.length ? (openBlock(), createElementBlock("nav", _hoisted_19, [
            (openBlock(true), createElementBlock(Fragment, null, renderList($setup.breadcrumbLabels, (label, idx) => {
              return openBlock(), createElementBlock("button", {
                ...
                idx < $setup.breadcrumbLabels.length - 1 ? (openBlock(), createElementBlock("span", _hoisted_21, "chevron_right")) : createCommentVNode("", true)
              ], 10, _hoisted_20);
            }), 128))
          ])) : createCommentVNode("", true)
        ]),
        createBaseVNode("main", _hoisted_22, [
          $setup.loadingResources ? (openBlock(), createElementBlock("div", _hoisted_23, [
          ...
          ])) : !$setup.filteredResources.length ? (openBlock(), createElementBlock("div", _hoisted_24, [
            ...
            createBaseVNode("p", _hoisted_25, toDisplayString($setup.filterChip !== "all" ? "当前筛选下没有内容" : $setup.currentFolder ? "此文件夹为空" : "教师上传后将显示在这里"), 1),
            ...
            return openBlock(), createElementBlock("article", {
              ...
              createBaseVNode("div", {
                ...
                }, null, 40, _hoisted_28)) : (openBlock(), createElementBlock("span", _hoisted_29, toDisplayString($setup.kindMeta[$setup.fileKind(item)].icon), 1))
              ], 8, _hoisted_27),
              createBaseVNode("div", _hoisted_30, [
                ...
                $setup.metaLine(item) ? (openBlock(), createElementBlock("p", _hoisted_32, [
                  $setup.fileKind(item) === "image" || $setup.fileKind(item) === "video" ? (openBlock(), createElementBlock("span", _hoisted_33, toDisplayString($setup.kindMeta[$setup.fileKind(item)].label), 1)) : createCommentVNode("", true),
                  createTextVNode(" " + toDisplayString($setup.metaLine(item)), 1)
                ])) : item.is_folder ? (openBlock(), createElementBlock("p", _hoisted_34, toDisplayString($setup.kindMeta[$setup.fileKind(item)].label), 1)) : createCommentVNode("", true)
              ]),
              createBaseVNode("div", {
                class: "cx-row-trail",
                ...
                item.is_folder ? (openBlock(), createElementBlock("span", _hoisted_35, "chevron_right")) : (openBlock(), createElementBlock("button", {
                  ...
                  createBaseVNode("span", _hoisted_37, toDisplayString($setup.actingId === `d-${item.data_id}` ? "progress_activity" : "download"), 1)
                ], 8, _hoisted_36))
              ])
            ], 42, _hoisted_26);
          }), 128)),
        ...
        createBaseVNode("div", _hoisted_39, [
          ...
          $setup.coverUrl ? (openBlock(), createElementBlock("div", _hoisted_40, [
            createBaseVNode("img", {
              src: $setup.coverUrl,
              alt: ""
            }, null, 8, _hoisted_41)
          ...
          createBaseVNode("h2", null, toDisplayString($setup.courseTitle || "学习通班级"), 1),
          $setup.teacherName ? (openBlock(), createElementBlock("p", _hoisted_43, "任课教师 · " + toDisplayString($setup.teacherName), 1)) : createCommentVNode("", true),
          ...
          createBaseVNode("div", _hoisted_44, [
            ...
            }, toDisplayString($setup.needsRejoin ? "重新加入班级" : "加入班级并查看资料"), 1)
          ]),
          $setup.needsRejoin ? (openBlock(), createElementBlock("p", _hoisted_45, toDisplayString($setup.statusMsg || "检测到你已不在该班级，可重新加入后查看资料。"), 1)) : $setup.joinDeclined ? (openBlock(), createElementBlock("p", _hoisted_46, "你之前选择了暂不加入，可随时再次加入。")) : createCommentVNode("", true)
        ])
      ]))
    ], 64)),
    (openBlock(), createBlock(Teleport, { to: "body" }, [
      $setup.showPreviewModal ? (openBlock(), createElementBlock("div", {
        ...
        role: "dialog",
        "aria-modal": "true",
        "aria-label": $setup.previewModalTitle || "资料预览"
      }, [
        createBaseVNode("div", {
        ...
        createBaseVNode("div", _hoisted_48, [
          createBaseVNode("header", _hoisted_49, [
            createBaseVNode("div", _hoisted_50, [
              createBaseVNode("p", _hoisted_51, toDisplayString($setup.previewModalOfficial ? "学习通官方预览" : "资料预览"), 1),
              createBaseVNode("h3", _hoisted_52, toDisplayString($setup.previewModalTitle), 1),
              $setup.currentOpenMethod ? (openBlock(), createElementBlock("p", _hoisted_53, " 当前：" + toDisplayString($setup.currentOpenMethod.label), 1)) : createCommentVNode("", true)
            ]),
          ...
          createBaseVNode("div", {
            ...
            $setup.previewModalLoading ? (openBlock(), createElementBlock("div", _hoisted_54, [..._cache[18] || (_cache[18] = [
              createBaseVNode("div", { class: "cx-spinner" }, null, -1),
              createBaseVNode("p", null, "正在获取预览…", -1)
            ])])) : $setup.previewModalError && !$setup.previewModalUrl ? (openBlock(), createElementBlock("div", _hoisted_55, [
              ...
              createBaseVNode("div", _hoisted_56, [
                ...
                }, toDisplayString($setup.previewDownloading ? "下载中…" : "下载"), 9, _hoisted_57)) : createCommentVNode("", true)
              ])
            ])) : (openBlock(), createElementBlock(Fragment, { key: 2 }, [
              $setup.previewModalError ? (openBlock(), createElementBlock("p", _hoisted_58, toDisplayString($setup.previewModalError), 1)) : createCommentVNode("", true),
              $setup.previewModalMode === "image" && $setup.previewModalUrl ? (openBlock(), createElementBlock("div", _hoisted_59, [
                createBaseVNode("img", {
                ...
                controls: "",
                playsinline: ""
              }, null, 8, _hoisted_61)) : $setup.previewModalUrl ? (openBlock(), createElementBlock("iframe", {
                key: 3,
          ...
          !$setup.previewModalLoading ? (openBlock(), createElementBlock("footer", _hoisted_64, [
            createBaseVNode("div", _hoisted_65, [
              createBaseVNode("div", _hoisted_66, [
                createBaseVNode("button", {
                  ...
                  createBaseVNode("span", _hoisted_68, [
                    ...
                    createBaseVNode("span", _hoisted_69, toDisplayString($setup.currentOpenMethod?.label || "选择方式"), 1)
                  ]),
                  createBaseVNode("span", _hoisted_70, toDisplayString($setup.showOpenMethodMenu ? "expand_less" : "expand_more"), 1)
                ], 10, _hoisted_67),
                $setup.showOpenMethodMenu ? (openBlock(), createElementBlock("div", {
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList($setup.previewOpenMethods, (m) => {
                    return openBlock(), createElementBlock("button", {
                      ...
                      m.id === $setup.previewMethodId ? (openBlock(), createElementBlock("span", _hoisted_76, "check")) : createCommentVNode("", true)
                    ], 10, _hoisted_71);
                  }), 128))
                ])) : createCommentVNode("", true)
              ]),
              ...
              createBaseVNode("button", {
                ...
                createBaseVNode("span", _hoisted_79, toDisplayString($setup.previewDownloading ? "progress_activity" : "download"), 1),
                createBaseVNode("span", _hoisted_80, toDisplayString($setup.previewDownloading ? "下载中" : "下载"), 1)
              ], 8, _hoisted_78)
            ])
          ])) : createCommentVNode("", true)
        ])
    ...
    (openBlock(), createBlock(Teleport, { to: "body" }, [
      $setup.showJoinDialog ? (openBlock(), createElementBlock("div", _hoisted_81, [
        createBaseVNode("div", {
        ...
        createBaseVNode("div", _hoisted_82, [
          ...
          createBaseVNode("p", _hoisted_85, toDisplayString($setup.needsRejoin ? "重新加入" : "加入班级"), 1),
          _cache[25] || (_cache[25] = createBaseVNode("h3", { id: "cx-join-title" }, "是否加入班级？", -1)),
          createBaseVNode("p", _hoisted_86, toDisplayString($setup.courseTitle || "班级"), 1),
          $setup.teacherName ? (openBlock(), createElementBlock("p", _hoisted_87, "教师 " + toDisplayString($setup.teacherName), 1)) : createCommentVNode("", true),
          ...
          createBaseVNode("div", _hoisted_88, [
            ...
            }, toDisplayString($setup.loadingJoin ? "加入中…" : "加入班级"), 9, _hoisted_90)
          ])
        ])
      ])) : createCommentVNode("", true)
    ]))
...
const ChaoxingClassView = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", render], ["__scopeId", "data-v-e7af04a9"]]);
export {
