const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./app-demo-CUOWTnz-.js","./runtime-bridge-Dt57BD2i.js","./more-modules-DaLSEgdg.js","./vue-core-Dzs4fLAU.js","./capture-D-zd0oUS.js","./app-demo-BbrPp8Tf.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, p as pushDebugLog, a as isTauriRuntime, d as invokeNative } from "./runtime-bridge-Dt57BD2i.js";
...
const syncWidgetThemeMode = (mode) => {
  if (typeof window === "undefined") return;
  __vitePreload(() => import("./app-demo-CUOWTnz-.js").then((n) => n.aR), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0, import.meta.url).then((mod) => {
    const bridge = mod;
...
const initDebugBridgeClient = async () => {
  ...
  const eventApi = await __vitePreload(() => import("./runtime-bridge-Dt57BD2i.js").then((n) => n.aa), true ? __vite__mapDeps([1,2]) : void 0, import.meta.url);
