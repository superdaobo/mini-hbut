...
import { g as getNightModePreference, i as isNightModeEnabled, a as initNightModeClass, s as setNightModePreference, b as resolveNightModeDark } from "./debug-tools-93yJPXbp.js";
...
const _sfc_main = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const probeViaCapacitorHttp = async (url, timeoutMs) => {
      ...
      try {
        const core = await __vitePreload(() => import("./runtime-bridge-i9KZPKjs.js").then((n) => n.a3), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
