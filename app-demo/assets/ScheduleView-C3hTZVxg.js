...
import { p as pushDebugLog, i as isTestAccountSession, Q as isMobileLike, a as isTauriRuntime, d as invokeNative } from "./runtime-bridge-BDjl3Bnt.js";
...
const useScheduleData = (props, emit, options) => {
  ...
  const removeOfficialCourse = (course, mode = "all", currentWeek = 0) => {
    const sid = String(props.studentId || "").trim();
    ...
    persistScheduleRenderSnapshot(mode === "current_week" ? "official-course-remove-week" : "official-course-remove");
    return true;
  };
  ...
  const managedCourseGroups = computed(() => {
    ...
    for (const record of removedOfficialCourses.value || []) {
      ...
      const removedWeeks = Array.isArray(record?.removed_weeks) ? record.removed_weeks.map((week) => Number(week)).filter((week) => Number.isInteger(week) && week > 0).sort((a, b) => a - b) : [];
    ...
    return Array.from(groups.entries()).sort((a, b) => sortSemesterKeys(a[0], b[0])).map(([semesterKey, group]) => {
      ...
      return {
        ...
        totalCount: officialCourses.length + removedCourses.filter((course) => course.visibility_scope !== "weeks").length + customCourses.length
      };
    });
  });
...
const useScheduleEditor = (options) => {
  ...
  const removeOfficialCourse = async (courseArg = null, mode = "all") => {
    ...
    const confirmed = await askConfirm({
      title: isCurrentWeek ? t("schedule.editor.removeOfficialCurrentWeekTitle") : t("schedule.editor.removeOfficialTitle"),
      lines: [
        isCurrentWeek ? t("schedule.editor.removeOfficialCurrentWeekLine").replace("{name}", name).replace("{w}", String(week)) : t("schedule.editor.removeOfficialLine").replace("{name}", name),
        t("schedule.editor.removeOfficialHint")
      ],
      confirmText: isCurrentWeek ? t("schedule.editor.confirmRemoveOfficialCurrentWeek") : t("schedule.editor.confirmRemoveOfficial"),
      cancelText: t("schedule.confirm.cancel"),
      danger: true
    });
    if (!confirmed) return false;
    ...
    if (!ok) {
      detail.detailActionError.value = isCurrentWeek ? t("schedule.editor.removeOfficialWeekUnavailable") : t("schedule.editor.removeOfficialFailed");
      return false;
    }
    detail.detailActionError.value = "";
    detail.showDetail.value = false;
    ...
    void reconcileLocalReminders({
      studentId: sid,
      semesterHint: sem,
      reason: isCurrentWeek ? "schedule-visibility-remove-week" : "schedule-visibility-remove"
    });
    return true;
  };
...
const _hoisted_38$3 = { class: "drawer-tip" };
const _hoisted_39$2 = {
  key: 0,
  class: "export-result"
};
        ...
        createVNode(Transition, { name: "drawer-slide" }, {
          default: withCtx(() => [
            __props.showMenu ? (openBlock(), createElementBlock("aside", {
              ...
              createBaseVNode("div", _hoisted_38$3, toDisplayString(unref(t2)("schedule.drawer.exportTip")), 1),
              __props.exportUrl ? (openBlock(), createElementBlock("div", _hoisted_39$2, [
                ...
                __props.exportCopied ? (openBlock(), createElementBlock("div", _hoisted_43$2, toDisplayString(unref(t2)("schedule.drawer.copied")), 1)) : createCommentVNode("", true)
              ])) : createCommentVNode("", true),
...
const _hoisted_34$2 = { class: "official-remove-grid" };
const _hoisted_35$2 = ["disabled"];
const _hoisted_36$2 = { class: "official-remove-hint" };
const _hoisted_37$2 = { class: "detail-copy-actions" };
const _hoisted_38$2 = {
  key: 2,
...
const _sfc_main$a = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const canRemoveCurrentWeek = computed(() => {
      ...
      const weeks = Array.isArray(props.selectedCourse?.weeks) ? props.selectedCourse.weeks.map((item) => Number(item)) : [];
                ...
                __props.selectedCourse?.is_custom ? (openBlock(), createElementBlock("div", _hoisted_32$2, [
                  ...
                  createBaseVNode("div", _hoisted_34$2, [
                    createBaseVNode("button", {
                      ...
                      disabled: !canRemoveCurrentWeek.value,
                      onClick: _cache[4] || (_cache[4] = ($event) => emit("remove-official-course", __props.selectedCourse, "current_week"))
                    }, toDisplayString(unref(t2)("schedule.detail.removeOfficialCurrentWeek")), 9, _hoisted_35$2),
                    createBaseVNode("button", {
                      class: "official-remove-btn all",
                      onClick: _cache[5] || (_cache[5] = ($event) => emit("remove-official-course", __props.selectedCourse, "all"))
                    }, toDisplayString(unref(t2)("schedule.detail.removeOfficialAllWeeks")), 1)
                  ]),
                  createBaseVNode("p", _hoisted_36$2, toDisplayString(unref(t2)("schedule.detail.removeOfficialHint")), 1)
                ]))
              ])),
              createBaseVNode("div", _hoisted_37$2, [
                createBaseVNode("button", {
                  class: "detail-copy-btn",
                  onClick: _cache[6] || (_cache[6] = ($event) => emit("copy-detail"))
                }, toDisplayString(unref(t2)("schedule.detail.copyDetail")), 1)
              ]),
              __props.detailActionError ? (openBlock(), createElementBlock("div", _hoisted_38$2, toDisplayString(__props.detailActionError), 1)) : createCommentVNode("", true)
            ])
          ])) : createCommentVNode("", true)
        ]),
        _: 1
...
const ScheduleCourseDetail = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-3a3d03fc"]]);
...
const _hoisted_43$1 = { class: "sci-week-note" };
                ...
                __props.stage === "input" ? (openBlock(), createElementBlock("div", _hoisted_4$2, [
                  ...
                  __props.previewMode === "list" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    ...
                    createBaseVNode("div", _hoisted_38$1, [
                      ...
                      createBaseVNode("span", _hoisted_43$1, toDisplayString(unref(t2)("schedule.import.preview.weekNote")), 1)
                    ]),
...
const _hoisted_28 = { class: "manage-course-card-meta removed-scope" };
const _hoisted_29 = {
  key: 0,
  class: "manage-course-card-meta"
};
const _hoisted_30 = { class: "manage-course-card-actions" };
const _hoisted_31 = ["onClick"];
const _hoisted_32 = {
  key: 2,
  class: "manage-course-category"
};
const _hoisted_33 = { class: "manage-course-category-title" };
const _hoisted_34 = { class: "manage-course-card-main" };
const _hoisted_35 = { class: "manage-course-card-name-row" };
const _hoisted_36 = { class: "manage-course-card-name" };
const _hoisted_37 = { class: "manage-course-tag custom" };
const _hoisted_38 = { class: "manage-course-card-meta" };
const _hoisted_39 = { class: "manage-course-card-meta" };
const _hoisted_40 = {
  key: 0,
  class: "manage-course-card-meta"
};
const _hoisted_41 = { class: "manage-course-card-actions" };
                          ...
                          (openBlock(true), createElementBlock(Fragment, null, renderList(group.removedCourses, (course) => {
                            return openBlock(), createElementBlock("article", {
                              ...
                              createBaseVNode("div", _hoisted_23, [
                                ...
                                createBaseVNode("div", _hoisted_28, toDisplayString(course.visibility_scope === "weeks" ? unref(t2)("schedule.manageCourses.removedScopeWeeks").replace("{weeks}", course.removed_weeks_text || "-") : unref(t2)("schedule.manageCourses.removedScopeAll")), 1),
                                course.teacher || course.room ? (openBlock(), createElementBlock("div", _hoisted_29, toDisplayString([course.teacher, course.room].filter(Boolean).join(" · ")), 1)) : createCommentVNode("", true)
                              ]),
                              createBaseVNode("div", _hoisted_30, [
                                createBaseVNode("button", {
                                  class: "manage-course-btn restore",
                                  onClick: ($event) => emit("restore-official-course", course)
                                }, toDisplayString(unref(t2)("schedule.manageCourses.restore")), 9, _hoisted_31)
                              ])
                            ]);
                          }), 128))
                        ])) : createCommentVNode("", true),
                        group.customCourses?.length || group.courses?.length ? (openBlock(), createElementBlock("section", _hoisted_32, [
                            ...
                            return openBlock(), createElementBlock("article", {
                              ...
                              createBaseVNode("div", _hoisted_34, [
                                createBaseVNode("div", _hoisted_35, [
                                  createBaseVNode("div", _hoisted_36, toDisplayString(course.name), 1),
                                  createBaseVNode("span", _hoisted_37, toDisplayString(unref(t2)("schedule.manageCourses.customTag")), 1)
                                ]),
                                createBaseVNode("div", _hoisted_38, toDisplayString(unref(t2)("schedule.manageCourses.timeMeta").replace("{day}", weekDayLabels.value[(course.weekday || 1) - 1]).replace("{s}", String(course.period)).replace("{e}", String(unref(getCourseEndPeriod)(course)))), 1),
                                createBaseVNode("div", _hoisted_39, toDisplayString(unref(t2)("schedule.manageCourses.weeksMeta").replace("{t}", course.weeks_text)), 1),
                                course.teacher || course.room ? (openBlock(), createElementBlock("div", _hoisted_40, toDisplayString([course.teacher, course.room].filter(Boolean).join(" · ")), 1)) : createCommentVNode("", true)
                              ]),
                              createBaseVNode("div", _hoisted_41, [
                                createBaseVNode("button", {
                                  class: "manage-course-btn edit",
                                  onClick: ($event) => emit("edit-course", course)
                                }, toDisplayString(unref(t2)("schedule.manageCourses.edit")), 9, _hoisted_42),
                                createBaseVNode("button", {
                                  class: "manage-course-btn delete",
                                  onClick: ($event) => emit("delete-course", course)
                                }, toDisplayString(unref(t2)("schedule.manageCourses.delete")), 9, _hoisted_43)
                              ])
                            ]);
                          }), 128))
                        ])) : createCommentVNode("", true)
...
const ScheduleManageCoursesDialog = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-651f50ab"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        }, null, 8, ["show-detail", "selected-course", "selected-week", "detail-action-error", "onOpenConflictCourseDetail", "onOpenEditCourse", "onDeleteCustomCourse", "onRemoveOfficialCourse", "onCopyDetail"]),
...
const ScheduleView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-27bd40c2"]]);
export {
