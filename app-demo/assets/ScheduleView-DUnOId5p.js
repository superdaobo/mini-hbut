import { a as useUiSettings, e as flushUiSettings, i as showToast, m as recordSemesterStartDate, p as readScheduleRenderSnapshot, q as writeScheduleRenderSnapshot, f as fetchWithCache, b as axiosInstance, E as EXTRA_LONG_TTL, D as DEFAULT_SWR_OPTIONS, n as normalizeSemesterList, j as resolveCurrentSemester, t as afterScheduleRefresh, v as writeScheduleLock, x as getCachedScheduleSnapshot, y as runCloudSyncDownload, z as runCloudSyncUpload, A as getCloudSyncCooldownState, r as readScheduleLockDetail, B as isAutoScheduleLockReason, C as semesterIsNewer, F as probeSemesterSchedule, G as readSemesterStartDates, _ as _export_sfc, H as CLOUD_SYNC_UPDATED_EVENT, I as consumeScheduleSwitchPending, J as clearScheduleLock, K as readScheduleLock, M as warmupScheduleForStudent } from "./app-demo-BxokP0Ga.js";
import { p as pushDebugLog, i as isTestAccountSession, P as isMobileLike, a as isTauriRuntime, d as invokeNative } from "./runtime-bridge-HjlgKupV.js";
import { f as formatRelativeTime } from "./time-DFqn0g8e.js";
import { r as ref, v as watch, h as computed, C as nextTick, M as resolveComponent, a as openBlock, c as createElementBlock, b as createBaseVNode, t as toDisplayString, p as createVNode, k as withCtx, F as Fragment, g as renderList, d as createCommentVNode, T as Transition, w as withModifiers, e as createTextVNode, n as normalizeClass, j as createBlock, u as unref, f as normalizeStyle, K as withDirectives, L as vModelText, s as Teleport, y as defineComponent, o as onMounted, l as onBeforeUnmount } from "./vue-core-DPI62iBa.js";
import { h as hasBootMetric, m as markBootMetric } from "./debug-tools-3S6y50wl.js";
...
const _hoisted_4$7 = { class: "topbar-right" };
          ...
          default: withCtx(() => [
            __props.showMenu ? (openBlock(), createElementBlock("aside", {
              ...
              createBaseVNode("div", _hoisted_1$7, [
                ...
                __props.semesterError ? (openBlock(), createElementBlock("div", _hoisted_4$6, toDisplayString(__props.semesterError), 1)) : createCommentVNode("", true)
              ]),
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        __props.termStartNotice ? (openBlock(), createElementBlock("div", _hoisted_3$6, toDisplayString(__props.termStartNotice), 1)) : createCommentVNode("", true),
        __props.errorMsg ? (openBlock(), createElementBlock("div", _hoisted_4$5, toDisplayString(__props.errorMsg), 1)) : createCommentVNode("", true),
...
const ScheduleBanners = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-03a530b3"]]);
...
const ScheduleGrid = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-42d31f46"]]);
...
const ScheduleAddCourseDialog = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-d80e5e9c"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const anyOverlayOpen = computed(() => {
      return menu.showMenu.value || detail.showDetail.value || editor.showAddCourse.value || editor.showManageCourses.value || editor.showWeekPicker.value || confirmDialog.showConfirmDialog.value;
    });
    const {
      semester,
      semesterDraft,
      ...
      if (lockDetail?.semester) {
        ...
        if (shouldClearLock) {
          ...
          if (cleared) {
            pushDebugLog(
              "Schedule",
              lockIsManual ? `#750 手动锁定学期(${lockDetail.semester})为会话内临时，启动不延续，已清理` : `#750 自动锁定学期(${lockDetail.semester})早于时间驱动应选学期(${timeDriven.target})，已清理并重探`,
              "warn"
            );
          }
        }
...
const ScheduleView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-973cc95c"]]);
export {
