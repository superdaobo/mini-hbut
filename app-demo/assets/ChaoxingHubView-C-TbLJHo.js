import { v as watch, G as nextTick, o as onMounted, _ as onUnmounted, a as openBlock, c as createElementBlock, p as createVNode, k as withCtx, t as toDisplayString, d as createCommentVNode, u as unref, b as createBaseVNode, F as Fragment, g as renderList, n as normalizeClass, J as withDirectives, K as vModelText, j as createBlock, f as normalizeStyle, e as createTextVNode, r as ref, h as computed } from "./vue-core-C6WYunHF.js";
import { p as pushDebugLog, x as isIOSLike, a as isTauriRuntime, d as invokeNative } from "./runtime-bridge-Ds80RevU.js";
import { _ as _export_sfc, h as showToast } from "./app-demo-B5kEWRyP.js";
import { _ as _sfc_main$1 } from "./TPageHeader-DdEaHsvo.js";
import { T as TEmptyState } from "./TEmptyState-tL6XUZ4y.js";
import { T as TStatusBadge } from "./TStatusBadge-Cvw6nhu2.js";
...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const resetCourseRenderLimit = () => {
      ...
      courseRenderLimit.value = isIOSLikeDevice ? IOS_PROGRESSIVE_FIRST_BATCH : INITIAL_COURSE_BATCH;
    };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_3, [
          ...
          pageLoading.value ? (openBlock(), createElementBlock("div", _hoisted_7, [..._cache[7] || (_cache[7] = [
          ...
          current.value.level === "list" ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [
            createBaseVNode("section", _hoisted_8, [
              createBaseVNode("div", _hoisted_9, [
                createBaseVNode("div", null, [
                  _cache[8] || (_cache[8] = createBaseVNode("strong", null, "我的课程", -1)),
              ...
              createBaseVNode("div", _hoisted_10, [
                createBaseVNode("div", _hoisted_11, [
                  _cache[9] || (_cache[9] = createBaseVNode("span", null, "课程", -1)),
                  createBaseVNode("b", null, toDisplayString(filteredCourses.value.length), 1)
                ]),
                createBaseVNode("div", _hoisted_12, [
                  _cache[10] || (_cache[10] = createBaseVNode("span", null, "待办", -1)),
              ...
              filteredCourses.value.length > visibleCourses.value.length ? (openBlock(), createElementBlock("p", _hoisted_14, " 已显示 " + toDisplayString(visibleCourses.value.length) + " / " + toDisplayString(filteredCourses.value.length) + " 门课程，下滑自动加载更多。 ", 1)) : createCommentVNode("", true)
            ]),
            semesterTabs.value.length > 1 ? (openBlock(), createElementBlock("div", _hoisted_15, [
            ...
            createBaseVNode("div", _hoisted_17, [
              _cache[11] || (_cache[11] = createBaseVNode("span", { class: "material-symbols-outlined" }, "search", -1)),
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(visibleCourses.value, (c) => {
              return openBlock(), createElementBlock("button", {
                key: c.id,
                type: "button",
                ...
                createBaseVNode("div", _hoisted_19, [
                  shouldRenderRemoteCourseCovers && c.imageUrl ? (openBlock(), createElementBlock("img", {
                    key: 0,
                    src: c.imageUrl,
                    alt: "",
                    loading: "lazy",
                  ...
                  createBaseVNode("div", {
                    class: "cover-fb",
                    style: normalizeStyle(shouldRenderRemoteCourseCovers && c.imageUrl ? { display: "none" } : void 0)
                  }, [..._cache[12] || (_cache[12] = [
                ...
                _cache[13] || (_cache[13] = createBaseVNode("span", { class: "material-symbols-outlined chev" }, "chevron_right", -1))
              ], 8, _hoisted_18);
            }), 128)),
            hasMoreCourses.value ? (openBlock(), createElementBlock("button", {
              key: 3,
              type: "button",
              ...
              createBaseVNode("div", _hoisted_24, [
                _cache[14] || (_cache[14] = createBaseVNode("strong", null, "继续加载更多课程", -1)),
                createBaseVNode("p", null, "剩余 " + toDisplayString(filteredCourses.value.length - visibleCourses.value.length) + " 门未展示", 1)
              ]),
              _cache[15] || (_cache[15] = createBaseVNode("span", { class: "material-symbols-outlined chev" }, "expand_more", -1))
            ])) : createCommentVNode("", true),
            hasMoreCourses.value ? (openBlock(), createElementBlock("div", {
              key: 4,
            ...
            createBaseVNode("section", _hoisted_25, [
              createBaseVNode("div", _hoisted_26, [
                createBaseVNode("div", _hoisted_27, [
                  _cache[16] || (_cache[16] = createBaseVNode("span", { class: "pill" }, "章节目录", -1)),
              ...
              current.value.progress?.progress_text ? (openBlock(), createElementBlock("p", _hoisted_29, toDisplayString(current.value.progress.progress_text), 1)) : createCommentVNode("", true)
            ]),
            createBaseVNode("div", _hoisted_30, [
              _cache[19] || (_cache[19] = createBaseVNode("span", { class: "section-head__title" }, "全部章节", -1)),
              createBaseVNode("span", _hoisted_31, toDisplayString(current.value.sections?.length || 0) + " 章", 1)
            ]),
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(current.value.sections, (sec, sIdx) => {
                return openBlock(), createElementBlock("button", {
                  ...
                  createBaseVNode("div", _hoisted_34, [
                    ...
                    sIdx < (current.value.sections?.length || 0) - 1 ? (openBlock(), createElementBlock("i", _hoisted_36)) : createCommentVNode("", true)
                  ]),
                  createBaseVNode("div", _hoisted_37, [
                    ...
                    createBaseVNode("div", _hoisted_38, [
                      ...
                      _cache[20] || (_cache[20] = createBaseVNode("span", { class: "dot soft" }, "继续学习", -1))
                    ])
                  ]),
                  _cache[21] || (_cache[21] = createBaseVNode("span", { class: "material-symbols-outlined menu-item__chev" }, "chevron_right", -1))
                ], 8, _hoisted_33);
              }), 128))
            ])
          ], 64)) : current.value.level === "section" ? (openBlock(), createElementBlock(Fragment, { key: 4 }, [
            createBaseVNode("section", _hoisted_40, [
              _cache[22] || (_cache[22] = createBaseVNode("span", { class: "pill slate" }, "当前章节", -1)),
              createBaseVNode("strong", _hoisted_41, toDisplayString(current.value.section?.title), 1)
            ]),
            createBaseVNode("div", _hoisted_42, [
              _cache[23] || (_cache[23] = createBaseVNode("span", { class: "section-head__title" }, "小节列表", -1)),
              createBaseVNode("span", _hoisted_43, toDisplayString(current.value.section?.knowledges?.length || 0), 1)
            ]),
            ...
            createBaseVNode("div", _hoisted_44, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(current.value.section.knowledges, (k, kIdx) => {
                return openBlock(), createElementBlock("button", {
                  ...
                  _cache[24] || (_cache[24] = createBaseVNode("span", { class: "material-symbols-outlined menu-item__chev" }, "chevron_right", -1))
                ], 10, _hoisted_45);
              }), 128))
            ])
          ], 64)) : current.value.level === "knowledge" ? (openBlock(), createElementBlock(Fragment, { key: 5 }, [
            createBaseVNode("section", _hoisted_49, [
              _cache[25] || (_cache[25] = createBaseVNode("span", { class: "pill violet" }, "任务点", -1)),
              createBaseVNode("strong", _hoisted_50, toDisplayString(current.value.knowledge?.title), 1),
              createBaseVNode("p", _hoisted_51, toDisplayString(current.value.section?.title), 1)
            ]),
            createBaseVNode("div", _hoisted_52, [
              _cache[26] || (_cache[26] = createBaseVNode("span", { class: "section-head__title" }, "本页内容", -1)),
              createBaseVNode("span", _hoisted_53, toDisplayString(current.value.tasks?.length || 0) + " 项", 1)
            ]),
          ...
          ], 64)) : current.value.level === "score" ? (openBlock(), createElementBlock("section", _hoisted_61, [
            createBaseVNode("div", _hoisted_62, [
              createBaseVNode("div", null, [
                _cache[27] || (_cache[27] = createBaseVNode("span", null, "综合成绩", -1)),
                current.value.score?.user_name ? (openBlock(), createElementBlock("p", _hoisted_63, toDisplayString(current.value.score.user_name), 1)) : createCommentVNode("", true)
              ]),
              createBaseVNode("strong", null, toDisplayString(current.value.score?.total_score ?? current.value.score?.score?.score ?? "—"), 1)
            ]),
            scoreSlices.value.length ? (openBlock(), createElementBlock("div", _hoisted_64, [
              createBaseVNode("div", {
                class: "pie",
            ...
            (current.value.score?.weight_list || []).length ? (openBlock(), createElementBlock("ul", _hoisted_66, [
            ...
            ])) : current.value.score?.weight ? (openBlock(), createElementBlock("div", _hoisted_67, [
              createBaseVNode("div", _hoisted_68, [
                _cache[29] || (_cache[29] = createBaseVNode("span", null, "作业", -1)),
                createBaseVNode("b", null, toDisplayString(current.value.score.weight.work ?? 0) + "%", 1)
              ]),
              createBaseVNode("div", _hoisted_69, [
                _cache[30] || (_cache[30] = createBaseVNode("span", null, "考试", -1)),
                createBaseVNode("b", null, toDisplayString(current.value.score.weight.test ?? 0) + "%", 1)
              ]),
              createBaseVNode("div", _hoisted_70, [
                _cache[31] || (_cache[31] = createBaseVNode("span", null, "视频", -1)),
                createBaseVNode("b", null, toDisplayString(current.value.score.weight.video ?? 0) + "%", 1)
              ]),
              createBaseVNode("div", _hoisted_71, [
                _cache[32] || (_cache[32] = createBaseVNode("span", null, "签到", -1)),
                createBaseVNode("b", null, toDisplayString(current.value.score.weight.attend ?? 0) + "%", 1)
              ])
            ])) : createCommentVNode("", true),
            current.value.score?.job ? (openBlock(), createElementBlock("p", _hoisted_72, " 任务点完成率 " + toDisplayString(current.value.score.job.jobFinishRate ?? "—") + "% ", 1)) : createCommentVNode("", true),
            createBaseVNode("button", {
              type: "button",
              class: "chip-btn",
              onClick: _cache[4] || (_cache[4] = ($event) => openScore(current.value.course))
            }, " 重新同步 ")
          ])) : current.value.level === "video" ? (openBlock(), createElementBlock("section", _hoisted_73, [
            createBaseVNode("p", _hoisted_74, toDisplayString(current.value.knowledge?.title), 1),
            createBaseVNode("h3", _hoisted_75, toDisplayString(current.value.filename || current.value.task?.title), 1),
            current.value.duration ? (openBlock(), createElementBlock("p", _hoisted_76, "时长 " + toDisplayString(formatDuration(current.value.duration)), 1)) : createCommentVNode("", true),
            ...
            videoError.value ? (openBlock(), createElementBlock("p", _hoisted_78, toDisplayString(videoError.value), 1)) : createCommentVNode("", true),
            createBaseVNode("div", _hoisted_79, [
              ...
              (current.value.playUrls || []).length > 1 ? (openBlock(), createElementBlock("button", {
                key: 0,
                type: "button",
                class: "chip-btn ghost light",
            ...
            _cache[34] || (_cache[34] = createBaseVNode("p", { class: "hint" }, "直链经本地代理播放，失败可切换线路或重新加载", -1))
            ...
            _cache[35] || (_cache[35] = createBaseVNode("p", { class: "hint" }, "文档在应用内预览；若空白请确认学习通会话有效", -1))
          ])) : createCommentVNode("", true)
        ])
      ]);
    };
...
const ChaoxingHubView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6135ca3c"]]);
export {
