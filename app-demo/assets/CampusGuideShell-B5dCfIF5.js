...
import { H as HBUT_LOCATION, n as normalizePoint } from "./towergo_map-Do-Wv4K7.js";
import { resolveCampusGuideBaseUrl, CAMPUS_GUIDE_CONFIG, readCampusGuideMode, writeCampusGuideMode } from "./config-C0EgdVZO.js";
import { u as useGeolocation } from "./useGeolocation-BJJ4fYjL.js";
import { y as isLiveLocationAllowed } from "./more-modules-rEERMQm_.js";
import { p as pushDebugLog } from "./runtime-bridge-i9KZPKjs.js";
import { i as reactive, h as computed, y as defineComponent, a as openBlock, c as createElementBlock, p as createVNode, u as unref, b as createBaseVNode, q as renderSlot, j as createBlock, k as withCtx, t as toDisplayString, o as onMounted, F as Fragment, f as renderList, d as createCommentVNode, C as nextTick, l as onBeforeUnmount, n as normalizeClass, r as ref, v as watch, W as onActivated, e as normalizeStyle, K as withDirectives, L as vModelText, g as createTextVNode, P as vModelSelect, w as withModifiers, X as KeepAlive } from "./vue-core-Dzs4fLAU.js";
import { _ as _sfc_main$u } from "./TPageHeader.vue_vue_type_script_setup_true_lang-Dh0eXg1s.js";
import { o as openExternal, j as showToast } from "./app-demo-DqAlnDLf.js";
...
const toOptionalNumberOrString = (value) => {
...
const normalizeTourRoutes = (raw) => {
  ...
  return list.map((item) => {
    ...
    return {
      ...
      spots: Array.isArray(data.spots) ? data.spots.filter(
        (spot) => typeof spot === "string" || typeof spot === "number"
      ) : void 0,
      raw: item
    };
  });
            ...
            createBaseVNode("div", _hoisted_5$6, [
              ...
              createBaseVNode("button", {
                ...
                onClick: _cache[2] || (_cache[2] = ($event) => unref(store).navigateTo(unref(CAMPUS_GUIDE_VIEWS).walkline, {
                  spot: detail.value,
                  endPoint: unref(resolveNavEndPoint)(detail.value) ?? void 0
                }))
              }, " 导航 ")
            ])
          ], 64)) : createCommentVNode("", true)
