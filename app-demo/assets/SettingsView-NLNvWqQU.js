...
import { o as detectRuntime, a as isTauriRuntime, P as subscribeDebugLogs, G as getDebugLogs, p as pushDebugLog, H as formatDebugTime, Q as clearDebugLogs, L as isMobileLike, d as invokeNative, _ as __vitePreload } from "./runtime-bridge-Ds80RevU.js";
import { _ as _export_sfc, C as CLOUD_SYNC_UPDATED_EVENT, a5 as FONT_CDN_OPTIONS, k as useAppSettings, a6 as getCloudSyncLocalStatus, h as showToast, a7 as getCloudSyncRuntimeConfig, V as getStoredOcrConfig, U as applyOcrRuntimeConfig, a8 as useFontSettings, a9 as setFontCdnProvider, aa as prefetchCdnFonts, ab as loadDeyiHeiFont, ac as ensureFontLoaded, ad as resetAppSettings, ae as DEFAULT_CLOUD_SYNC_ENDPOINT, af as DEFAULT_BACKEND_TARGETS, u as useUiSettings, ag as UI_PRESETS, ah as resetUiSettings, b as flushUiSettings, ai as applyPreset } from "./app-demo-B5kEWRyP.js";
import { i as isNightModeEnabled, a as initNightModeClass, b as applyNightModePreference } from "./debug-tools-h9PYDs00.js";
import { a as openBlock, c as createElementBlock, b as createBaseVNode, n as normalizeClass, F as Fragment, g as renderList, f as normalizeStyle, t as toDisplayString, d as createCommentVNode, J as withDirectives, K as vModelText, j as createBlock, s as Teleport, r as ref, v as watch, o as onMounted, l as onBeforeUnmount, h as computed } from "./vue-core-C6WYunHF.js";
    ...
    createBaseVNode("div", _hoisted_1, [
      ...
      createBaseVNode("div", _hoisted_3, [
        ...
        createBaseVNode("button", {
          ...
          onClick: _cache[3] || (_cache[3] = ($event) => $setup.activeTab = "debug")
        }, " 调试 ", 2)
      ]),
          ...
          createBaseVNode("div", _hoisted_10, [
            createBaseVNode("div", {
              ...
              createBaseVNode("div", {
                ...
                !$setup.isDarkMode ? (openBlock(), createElementBlock("div", _hoisted_11, [..._cache[40] || (_cache[40] = [
        ...
        createBaseVNode("section", _hoisted_28, [
          ...
          createBaseVNode("div", _hoisted_34, [
            createBaseVNode("button", {
              ...
              onClick: _cache[14] || (_cache[14] = ($event) => $setup.handleDownloadFont($setup.fontSettings.loaded))
            ...
            createBaseVNode("button", {
              ...
              onClick: _cache[15] || (_cache[15] = ($event) => $setup.handlePrefetchFonts(false))
            }, toDisplayString($setup.cdnPrefetching ? "缓存中..." : $setup.prefetchButtonText), 9, _hoisted_36),
            createBaseVNode("button", {
              class: "mini-btn btn-ripple",
              disabled: $setup.cdnPrefetching,
              onClick: _cache[16] || (_cache[16] = ($event) => $setup.handlePrefetchFonts(false, true))
          ...
          createBaseVNode("div", _hoisted_58, [
            createBaseVNode("label", _hoisted_59, [
              ...
              withDirectives(createBaseVNode("input", {
                ...
                "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => $setup.appSettings.backend.ocrEndpoint = $event)
              }, null, 512), [
                [
                  vModelText,
            ...
            createBaseVNode("label", _hoisted_60, [
              ...
              withDirectives(createBaseVNode("input", {
                ...
                "onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => $setup.appSettings.backend.tempUploadEndpoint = $event)
              }, null, 512), [
                [
                  vModelText,
            ...
            createBaseVNode("label", _hoisted_61, [
              ...
              withDirectives(createBaseVNode("input", {
                ...
                "onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => $setup.appSettings.backend.cloudSyncEndpoint = $event)
              }, null, 8, _hoisted_62), [
                [
                  vModelText,
            ...
            createBaseVNode("label", _hoisted_63, [
              ...
              withDirectives(createBaseVNode("input", {
                ...
                "onUpdate:modelValue": _cache[20] || (_cache[20] = ($event) => $setup.appSettings.backend.cloudSyncSecretRef = $event)
              }, null, 512), [
                [
                  vModelText,
          ...
          createBaseVNode("div", _hoisted_65, [
            createBaseVNode("label", _hoisted_66, [
              ...
              withDirectives(createBaseVNode("input", {
                ...
                min: "0",
                max: "5",
                "onUpdate:modelValue": _cache[21] || (_cache[21] = ($event) => $setup.appSettings.retry.electricity = $event)
              }, null, 512), [
                [
                  vModelText,
            ...
            createBaseVNode("label", _hoisted_67, [
              ...
              withDirectives(createBaseVNode("input", {
                ...
                min: "0",
                max: "5",
                "onUpdate:modelValue": _cache[22] || (_cache[22] = ($event) => $setup.appSettings.retry.classroom = $event)
              }, null, 512), [
                [
                  vModelText,
            ...
            createBaseVNode("label", _hoisted_68, [
              ...
              withDirectives(createBaseVNode("input", {
                ...
                max: "10000",
                step: "100",
                "onUpdate:modelValue": _cache[23] || (_cache[23] = ($event) => $setup.appSettings.retryDelayMs = $event)
              }, null, 512), [
                [
                  vModelText,
            ...
            createBaseVNode("label", _hoisted_69, [
              ...
              withDirectives(createBaseVNode("input", {
                ...
                max: "60000",
                step: "500",
                "onUpdate:modelValue": _cache[24] || (_cache[24] = ($event) => $setup.appSettings.backend.moduleParams.requestTimeoutMs = $event)
              }, null, 512), [
                [
                  vModelText,
            ...
            createBaseVNode("label", _hoisted_70, [
              ...
              withDirectives(createBaseVNode("input", {
                ...
                max: "30000",
                step: "500",
                "onUpdate:modelValue": _cache[25] || (_cache[25] = ($event) => $setup.appSettings.backend.moduleParams.probeTimeoutMs = $event)
              }, null, 512), [
                [
                  vModelText,
            ...
            createBaseVNode("label", _hoisted_71, [
              ...
              withDirectives(createBaseVNode("input", {
                ...
                max: "3600",
                step: "10",
                "onUpdate:modelValue": _cache[26] || (_cache[26] = ($event) => $setup.appSettings.backend.moduleParams.cloudSyncUploadCooldownSec = $event)
              }, null, 512), [
                [
                  vModelText,
            ...
            createBaseVNode("label", _hoisted_72, [
              ...
              withDirectives(createBaseVNode("input", {
                ...
                max: "3600",
                step: "5",
                "onUpdate:modelValue": _cache[27] || (_cache[27] = ($event) => $setup.appSettings.backend.moduleParams.cloudSyncDownloadCooldownSec = $event)
              }, null, 512), [
                [
                  vModelText,
            ...
            createBaseVNode("label", _hoisted_73, [
              ...
              withDirectives(createBaseVNode("input", {
                ...
                max: "8",
                step: "1",
                "onUpdate:modelValue": _cache[28] || (_cache[28] = ($event) => $setup.appSettings.resourceShare.previewThreadsMobile = $event)
              }, null, 512), [
                [
                  vModelText,
            ...
            createBaseVNode("label", _hoisted_74, [
              ...
              withDirectives(createBaseVNode("input", {
                ...
                max: "12",
                step: "1",
                "onUpdate:modelValue": _cache[29] || (_cache[29] = ($event) => $setup.appSettings.resourceShare.previewThreadsDesktop = $event)
              }, null, 512), [
                [
                  vModelText,
            ...
            createBaseVNode("label", _hoisted_75, [
              ...
              withDirectives(createBaseVNode("input", {
                ...
                max: "8",
                step: "1",
                "onUpdate:modelValue": _cache[30] || (_cache[30] = ($event) => $setup.appSettings.resourceShare.downloadThreadsMobile = $event)
              }, null, 512), [
                [
                  vModelText,
            ...
            createBaseVNode("label", _hoisted_76, [
              ...
              withDirectives(createBaseVNode("input", {
                ...
                max: "12",
                step: "1",
                "onUpdate:modelValue": _cache[31] || (_cache[31] = ($event) => $setup.appSettings.resourceShare.downloadThreadsDesktop = $event)
              }, null, 512), [
                [
                  vModelText,
        ...
        createBaseVNode("div", _hoisted_99, [
          ...
          createBaseVNode("div", _hoisted_108, [
            $setup.fontDownloadStatus === "failed" && $setup.fontModalRetryMode === "deyihei" ? (openBlock(), createElementBlock("button", {
              ...
              onClick: _cache[32] || (_cache[32] = ($event) => $setup.handleDownloadFont(true))
            ...
            $setup.fontDownloadStatus === "failed" && $setup.fontModalRetryMode === "prefetch" ? (openBlock(), createElementBlock("button", {
              key: 1,
              class: "btn-secondary btn-ripple",
              onClick: _cache[33] || (_cache[33] = ($event) => $setup.handlePrefetchFonts(true))
            }, " 重试缓存 ")) : createCommentVNode("", true),
            createBaseVNode("button", {
              class: "btn-primary btn-ripple",
              onClick: _cache[34] || (_cache[34] = ($event) => $setup.showFontModal = false)
            }, "关闭")
          ])
        ])
...
const _sfc_main = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const probeViaCapacitorHttp = async (url, timeoutMs) => {
      ...
      try {
        const core = await __vitePreload(() => import("./runtime-bridge-Ds80RevU.js").then((n) => n.V), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
...
const SettingsView = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", render], ["__scopeId", "data-v-427166e8"]]);
export {
