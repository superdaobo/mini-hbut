import { O as decryptData, P as encryptData, _ as _export_sfc, Q as fetchRemoteConfig, h as showToast } from "./app-demo-B5kEWRyP.js";
import { i as isTestAccountSession, M as resolveTestAccountForumResponse } from "./runtime-bridge-Ds80RevU.js";
import { a as openBlock, c as createElementBlock, b as createBaseVNode, t as toDisplayString, F as Fragment, g as renderList, n as normalizeClass, d as createCommentVNode, J as withDirectives, P as vShow, e as createTextVNode, m as withKeys, K as vModelText, w as withModifiers, R as createStaticVNode, S as vModelSelect, f as normalizeStyle, r as ref, o as onMounted, v as watch, h as computed } from "./vue-core-C6WYunHF.js";
...
const saveForumAdminSecret = async (studentId, secret) => {
  ...
  const value = toText$1(secret).trim();
  try {
    if (!value) {
      localStorage.removeItem(key);
      return;
...
const loadForumAdminSecret = async (studentId) => {
  ...
  try {
    ...
    return toText$1(decrypted?.admin_secret || "").trim();
  } catch {
    return "";
  }
};
      ...
      createBaseVNode("div", _hoisted_3, [
        ...
        createBaseVNode("main", _hoisted_8, [
          ...
          withDirectives(createBaseVNode("section", _hoisted_14, [
            ...
            ])) : !$setup.displayThreads.length ? (openBlock(), createElementBlock("div", _hoisted_24, [..._cache[49] || (_cache[49] = [
          ...
          $setup.activeTab === "detail" ? (openBlock(), createElementBlock("section", _hoisted_34, [
            ...
            $setup.detailLoading ? (openBlock(), createElementBlock("div", _hoisted_37, [..._cache[57] || (_cache[57] = [
              createStaticVNode('<article class="skeleton-card detail" aria-hidden="true" data-v-a3d5f6d0><span class="skeleton-pill" data-v-a3d5f6d0></span><span class="skeleton-line wide" data-v-a3d5f6d0></span><span class="skeleton-line" data-v-a3d5f6d0></span><span class="skeleton-line" data-v-a3d5f6d0></span><span class="skeleton-line short" data-v-a3d5f6d0></span></article>', 1)
          ...
          $setup.activeTab === "compose" ? (openBlock(), createElementBlock("section", _hoisted_66, [
            createBaseVNode("div", _hoisted_67, [
              createBaseVNode("button", {
                class: "ghost-pill",
                type: "button",
                onClick: _cache[12] || (_cache[12] = ($event) => $setup.switchTab("feed"))
              }, "Cancel"),
            ...
            createBaseVNode("div", _hoisted_69, [
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => $setup.selectedCategoryId = $event),
              ...
              withDirectives(createBaseVNode("input", {
                ...
                "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => $setup.newThread.title = $event),
              ...
              withDirectives(createBaseVNode("textarea", {
                ...
                "onUpdate:modelValue": _cache[15] || (_cache[15] = ($event) => $setup.newThread.content_md = $event),
            ...
            createBaseVNode("div", _hoisted_71, [
              createBaseVNode("button", {
                ...
                type: "button",
                title: "上传附件",
                onClick: $setup.openThreadFilePicker
              }, [..._cache[69] || (_cache[69] = [
          ...
          $setup.activeTab === "notice" ? (openBlock(), createElementBlock("section", _hoisted_90, [
            ...
            _cache[85] || (_cache[85] = createStaticVNode('<div class="filter-pills" data-v-a3d5f6d0><button type="button" class="active" data-v-a3d5f6d0>All Activity</button><button type="button" data-v-a3d5f6d0>Comments</button><button type="button" data-v-a3d5f6d0>Likes</button><button type="button" data-v-a3d5f6d0>System</button></div>', 1)),
            ...
            createBaseVNode("div", _hoisted_96, [
              createBaseVNode("div", _hoisted_97, [
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => $setup.messageDraft.receiver_student_id = $event),
                  placeholder: "收件人学号"
                }, null, 512), [
                  [vModelText, $setup.messageDraft.receiver_student_id]
                ]),
                withDirectives(createBaseVNode("textarea", {
                  "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => $setup.messageDraft.content = $event),
                  rows: "3",
                  placeholder: "私信内容"
                }, null, 512), [
          ...
          $setup.activeTab === "me" ? (openBlock(), createElementBlock("section", _hoisted_101, [
            createBaseVNode("div", _hoisted_102, [
              ...
              createBaseVNode("div", _hoisted_103, [
                createBaseVNode("button", {
                  ...
                  title: "更换头像",
                  onClick: $setup.openAvatarFilePicker,
                  onKeydown: [
                    withKeys(withModifiers($setup.openAvatarFilePicker, ["prevent"]), ["enter"]),
                    withKeys(withModifiers($setup.openAvatarFilePicker, ["prevent"]), ["space"])
                  ]
                }, [
            ...
            createBaseVNode("div", _hoisted_110, [
              createBaseVNode("label", null, [
                ...
                withDirectives(createBaseVNode("input", {
                  ...
                  "onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => $setup.profile.nickname = $event),
                ...
                createBaseVNode("div", _hoisted_115, [
                  ...
                  createBaseVNode("div", _hoisted_116, [
                    createBaseVNode("input", {
                      ...
                      accept: "image/*",
                      disabled: $setup.isPending("profile:avatar-upload"),
                      onChange: $setup.uploadAvatarImage
                  ...
                  $setup.avatarUploadStatus ? (openBlock(), createElementBlock("p", _hoisted_119, toDisplayString($setup.avatarUploadStatus), 1)) : createCommentVNode("", true),
              ...
              createBaseVNode("label", _hoisted_120, [
                ...
                withDirectives(createBaseVNode("input", {
                  ...
                  "onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => $setup.profile.avatar_url = $event),
              ...
              createBaseVNode("label", null, [
                ...
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[20] || (_cache[20] = ($event) => $setup.profile.bio = $event),
                  maxlength: "300",
                  placeholder: "社区简介"
                }, null, 512), [
              ...
              createBaseVNode("label", _hoisted_121, [
                ...
                withDirectives(createBaseVNode("input", {
                  ...
                  "onUpdate:modelValue": _cache[21] || (_cache[21] = ($event) => $setup.profile.admin_secret = $event),
            ...
            createBaseVNode("div", _hoisted_122, [
              createBaseVNode("div", _hoisted_123, [
                ...
                !$setup.myThreads.length ? (openBlock(), createElementBlock("div", _hoisted_125, "暂无帖子")) : createCommentVNode("", true)
              ]),
              createBaseVNode("div", _hoisted_126, [
                ...
                !$setup.myReplies.length ? (openBlock(), createElementBlock("div", _hoisted_128, "暂无回复")) : createCommentVNode("", true)
              ]),
              createBaseVNode("div", _hoisted_129, [
                ...
                !$setup.myBookmarks.length ? (openBlock(), createElementBlock("div", _hoisted_131, "暂无收藏")) : createCommentVNode("", true)
              ])
            ]),
            createBaseVNode("div", _hoisted_132, [
              ...
              !$setup.badges.length ? (openBlock(), createElementBlock("span", _hoisted_133, "暂无徽章")) : createCommentVNode("", true)
            ])
          ])) : createCommentVNode("", true),
          $setup.activeTab === "user-profile" ? (openBlock(), createElementBlock("section", _hoisted_134, [
            createBaseVNode("div", _hoisted_135, [
              createBaseVNode("button", {
                class: "icon-button",
                type: "button",
                onClick: _cache[22] || (_cache[22] = ($event) => $setup.switchTab("feed"))
              }, [..._cache[106] || (_cache[106] = [
                createBaseVNode("span", { class: "material-symbols-outlined" }, "arrow_back", -1)
              ])]),
              _cache[107] || (_cache[107] = createBaseVNode("h2", null, "用户主页", -1))
            ]),
            $setup.viewedProfileLoading ? (openBlock(), createElementBlock("div", _hoisted_136, [..._cache[108] || (_cache[108] = [
              ...
              createBaseVNode("div", _hoisted_138, [
                createBaseVNode("div", _hoisted_139, [
                  $setup.viewedProfileInfo.avatar_url ? (openBlock(), createElementBlock("img", {
                    ...
                    alt: "用户头像"
                  }, null, 8, _hoisted_140)) : (openBlock(), createElementBlock("span", _hoisted_141, toDisplayString($setup.initials($setup.viewedProfileInfo.nickname || $setup.viewedProfileInfo.student_id)), 1))
                ]),
                createBaseVNode("div", _hoisted_142, [
                  createBaseVNode("button", {
                    ...
                    onClick: _cache[23] || (_cache[23] = ($event) => $setup.followAuthor($setup.viewedProfileInfo.student_id))
                  }, toDisplayString($setup.isPending(`follow:${$setup.viewedProfileInfo.student_id}`) ? "关注中" : "关注"), 9, _hoisted_143)
                ]),
                ...
                createBaseVNode("div", _hoisted_145, [
                  ...
                  !$setup.userProfileBadges.length ? (openBlock(), createElementBlock("span", _hoisted_146, "暂无公开徽章")) : createCommentVNode("", true)
                ])
              ])
            ])),
            createBaseVNode("div", _hoisted_147, [
              createBaseVNode("div", _hoisted_148, [
                ...
                !$setup.userProfileThreads.length ? (openBlock(), createElementBlock("div", _hoisted_150, "这个同学还没有发帖")) : createCommentVNode("", true)
              ])
            ])
          ])) : createCommentVNode("", true),
          $setup.activeTab === "admin" && $setup.isAdmin ? (openBlock(), createElementBlock("section", _hoisted_151, [
            ...
            createBaseVNode("div", _hoisted_155, [
              createBaseVNode("div", _hoisted_156, [
                ...
                !$setup.adminReports.length ? (openBlock(), createElementBlock("div", _hoisted_158, "暂无举报")) : createCommentVNode("", true)
              ]),
              createBaseVNode("div", _hoisted_159, [
                ...
                createBaseVNode("div", _hoisted_161, [
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": _cache[24] || (_cache[24] = ($event) => $setup.adminSearch = $event),
                    placeholder: "搜索学号/昵称",
                    onKeyup: withKeys($setup.searchAdminUsers, ["enter"])
                  }, null, 544), [
                  ...
                  createBaseVNode("button", {
                    class: "ghost-pill",
                    type: "button",
                    onClick: $setup.searchAdminUsers
                  }, "搜索")
                ]),
              ...
              createBaseVNode("div", _hoisted_164, [
                ...
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[25] || (_cache[25] = ($event) => $setup.banDraft.student_id = $event),
                  placeholder: "目标学号"
                }, null, 512), [
                  [vModelText, $setup.banDraft.student_id]
                ]),
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[26] || (_cache[26] = ($event) => $setup.banDraft.reason = $event),
                  placeholder: "原因，可选"
                }, null, 512), [
                ...
                createBaseVNode("div", _hoisted_165, [
                  createBaseVNode("button", {
                    ...
                    onClick: _cache[27] || (_cache[27] = ($event) => $setup.setUserBan(true))
                  }, toDisplayString($setup.isPending(`admin:ban:${$setup.banDraft.student_id.trim()}:true`) ? "封禁中" : "封禁"), 9, _hoisted_166),
                  createBaseVNode("button", {
                    class: "ghost-pill",
                    type: "button",
                    disabled: $setup.isPending(`admin:ban:${$setup.banDraft.student_id.trim()}:false`),
                    onClick: _cache[28] || (_cache[28] = ($event) => $setup.setUserBan(false))
                  }, toDisplayString($setup.isPending(`admin:ban:${$setup.banDraft.student_id.trim()}:false`) ? "解封中" : "解封"), 9, _hoisted_167)
                ])
              ]),
              createBaseVNode("div", _hoisted_168, [
                _cache[127] || (_cache[127] = createBaseVNode("h3", null, "徽章发放", -1)),
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[29] || (_cache[29] = ($event) => $setup.badgeDraft.student_id = $event),
                  placeholder: "目标学号"
                }, null, 512), [
                  [vModelText, $setup.badgeDraft.student_id]
                ]),
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[30] || (_cache[30] = ($event) => $setup.badgeDraft.badge_key = $event),
                  placeholder: "badge_key"
                }, null, 512), [
                  [vModelText, $setup.badgeDraft.badge_key]
                ]),
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[31] || (_cache[31] = ($event) => $setup.badgeDraft.display_name = $event),
                  placeholder: "展示名"
                }, null, 512), [
                ...
                createBaseVNode("button", {
                  ...
                  onClick: $setup.grantBadge
                }, toDisplayString($setup.isPending(`admin:badge:${$setup.badgeDraft.student_id.trim()}:${$setup.badgeDraft.badge_key.trim()}`) ? "发放中" : "发放徽章"), 9, _hoisted_169)
              ]),
              createBaseVNode("div", _hoisted_170, [
                ...
                createBaseVNode("div", _hoisted_172, [
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": _cache[32] || (_cache[32] = ($event) => $setup.pollDraft.title = $event),
                    placeholder: "投票标题"
                  }, null, 512), [
                    [vModelText, $setup.pollDraft.title]
                  ]),
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": _cache[33] || (_cache[33] = ($event) => $setup.pollDraft.description = $event),
                    placeholder: "说明，可选"
                  }, null, 512), [
                    [vModelText, $setup.pollDraft.description]
                  ]),
                  withDirectives(createBaseVNode("textarea", {
                    "onUpdate:modelValue": _cache[34] || (_cache[34] = ($event) => $setup.pollDraft.options = $event),
                    rows: "4",
                  ...
                  createBaseVNode("button", {
                    ...
                    onClick: $setup.createAdminPoll
                  }, toDisplayString($setup.isPending("poll:create") ? "发布中" : "发布投票"), 9, _hoisted_173)
                ]),
              ...
              createBaseVNode("div", _hoisted_176, [
                ...
                !$setup.adminBackups.length ? (openBlock(), createElementBlock("div", _hoisted_182, "暂无备份")) : createCommentVNode("", true)
              ])
            ])
          ])) : createCommentVNode("", true),
          $setup.uploadQueue.length ? (openBlock(), createElementBlock("section", _hoisted_183, [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList($setup.uploadQueue, (item) => {
                return openBlock(), createElementBlock("article", {
                  ...
                  createBaseVNode("div", _hoisted_188, [
                    createBaseVNode("span", _hoisted_189, toDisplayString($setup.uploadStatusText(item.status)), 1),
                    ...
                    }, toDisplayString($setup.isPending(`upload:retry:${item.key}`) ? "重试中" : "上传失败，点击重试"), 9, _hoisted_190)) : createCommentVNode("", true)
                  ])
                ], 2);
              }), 128))
            ])
...
const _sfc_main = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, fallbackCategories, tabs, forumEnabled, apiBase, activeTab, categories, threads, hotThreads, selectedCategoryId, selectedThread, threadDetail, loading, refreshing, detailLoading, errorMessage, searchQuery, replyContent, replyFiles, threadFiles, profile, meSummary, viewedUserProfile, viewedProfileLoading, myThreads, myReplies, myBookmarks, notifications, messages, badges, adminReports, adminUsers, adminBackups, adminPolls, selectedPoll, adminSearch, uploadQueue, threadUploadInput, messageDraft, banDraft, badgeDraft, pollDraft, pendingActions, profileAvatarInput, avatarUploadStatus, newThread, get client() {
      return client;
    }, set client(v) {
      client = v;
    }, get forumCache() {
      ...
      pendingGuard = v;
    }, isLoggedIn, hasRemoteCategories, visibleCategories, selectedCategory, isAdmin, visibleTabs, bookmarkedIds, displayThreads, unreadCount, feedReplyCount, feedAttachmentCount, canPublishThread, composerHint, meStats, viewedProfileInfo, viewedProfileStats, currentThread, threadAttachments, threadPendingKey, replyPendingKey, messagePendingKey, profileCompletion, userProfileThreads, userProfileBadges, adminSummary, latestBackup, pollAdminSummary, toText: toText2, initials, authorName, formatTime, normalizePolls, loadAdminPolls, selectPoll, pollOptionTotal, pollOptionPercent, hasVotedInPoll, parsePollOptions, voteInPoll, createAdminPoll, closeAdminPoll, categoryName, attachmentUrl, threadActionKey, fileLabel, fileSizeLabel, uploadStatusText, uploadScopeLabel, fileQueueKey, attachmentProxyUrl, rememberUploadResult, syncUploadQueueForScope, resolveAvatarAttachmentUrl, syncPendingActions, ensurePendingGuard, isPending, runPending, requireLogin, cached, invalidateForumCache, buildClient, seedDefaultCategories, loadMe, loadAdmin, loadThreads, loadForumData, chooseCategory, runSearch, openThread, closeThread, uploadFiles, setThreadFiles, setReplyFiles, openThreadFilePicker, removeThreadFile, removeReplyFile, retryUploadFile, copyAttachmentUrl, openAvatarFilePicker, uploadAvatarImage, submitThread, submitReply, reactToReply, toggleBookmark, followAuthor, openUserProfile, reportThread, saveProfile, checkIn, sendMessage, runBackup, searchAdminUsers, setUserBan, grantBadge, switchTab, computed, onMounted, ref, watch, get fetchRemoteConfig() {
      return fetchRemoteConfig;
    }, get buildForumApiBase() {
      return buildForumApiBase;
    }, get createForumApiClient() {
      return createForumApiClient;
    }, get loadForumAdminSecret() {
      return loadForumAdminSecret;
    }, get readForumProfile() {
      return readForumProfile;
    }, get saveForumAdminSecret() {
      return saveForumAdminSecret;
    }, get writeForumProfile() {
      return writeForumProfile;
    }, get clearForumCache() {
      return clearForumCache;
    }, get createForumCache() {
      return createForumCache;
    }, get createForumPendingActions() {
      return createForumPendingActions;
    }, get withForumCache() {
...
const ForumView = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", render], ["__scopeId", "data-v-a3d5f6d0"]]);
export {
