...
import { o as detectRuntime, a as isTauriRuntime, _ as __vitePreload, b as isLikelyAndroidUserAgent, R as isLikelyIOSUserAgent, S as isTauriDesktopRuntime } from "./runtime-bridge-Ds80RevU.js";
  ...
  if (canUseTauriEmbeddedWebview()) {
    try {
      const { getCurrentWindow } = await __vitePreload(async () => {
        const { getCurrentWindow: getCurrentWindow2 } = await import("./runtime-bridge-Ds80RevU.js").then((n) => n.a0);
...
const forceCloseSchoolWebsiteEmbed = async () => {
  ...
  try {
    const { pushDebugLog } = await __vitePreload(async () => {
      const { pushDebugLog: pushDebugLog2 } = await import("./runtime-bridge-Ds80RevU.js").then((n) => n.W);
...
const invokeNative = async (command, args) => {
  const core = await __vitePreload(() => import("./runtime-bridge-Ds80RevU.js").then((n) => n.Z), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
