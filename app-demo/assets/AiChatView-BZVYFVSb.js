...
import { i as isTestAccountSession, a as isTauriRuntime$1, d as invokeNative } from "./runtime-bridge-i9KZPKjs.js";
import { _ as _export_sfc, m as useI18n, p as tf } from "./app-demo-DqAlnDLf.js";
import { M as resolveComponent, a as openBlock, c as createElementBlock, b as createBaseVNode, t as toDisplayString, p as createVNode, k as withCtx, F as Fragment, f as renderList, n as normalizeClass, d as createCommentVNode, K as withDirectives, L as vModelText, m as withKeys, w as withModifiers, v as watch, C as nextTick, o as onMounted, l as onBeforeUnmount, r as ref, h as computed$1 } from "./vue-core-Dzs4fLAU.js";
...
const _hoisted_5 = { class: "model-select" };
const _hoisted_6 = ["value"];
const _hoisted_7 = { class: "stream-debug glass-card" };
const _hoisted_8 = {
  key: 0,
  class: "status-msg"
};
...
const _hoisted_12 = { class: "bubble" };
const _hoisted_13 = {
  key: 0,
...
const _hoisted_15 = { class: "thinking-window-header" };
const _hoisted_16 = { class: "thinking-window-title" };
const _hoisted_17 = {
  key: 0,
...
const _hoisted_25 = { class: "stream-label" };
...
const _hoisted_29 = { class: "bubble" };
const _hoisted_30 = {
  key: 0,
  ref: "attachmentBarEl",
...
const _hoisted_33 = ["accept"];
const _hoisted_34 = ["disabled", "placeholder"];
const _hoisted_35 = ["disabled"];
const _hoisted_36 = { class: "history-header" };
const _hoisted_37 = { class: "history-list" };
const _hoisted_38 = ["onClick"];
const _hoisted_39 = { class: "history-title" };
const _hoisted_40 = { class: "history-meta" };
const _hoisted_41 = {
  key: 0,
...
const _hoisted_44 = { class: "confirm-dialog glass-card" };
const _hoisted_45 = {
  key: 0,
  class: "confirm-error"
};
const _hoisted_46 = { class: "confirm-actions" };
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
      ...
      createBaseVNode("div", _hoisted_2, [
        createBaseVNode("div", _hoisted_3, [
          createBaseVNode("button", {
            ...
            _cache[7] || (_cache[7] = createBaseVNode("span", { class: "icon" }, "←", -1)),
            createBaseVNode("span", _hoisted_4, toDisplayString($setup.t("ai.back")), 1)
          ]),
          createBaseVNode("button", {
            class: "history-btn",
            onClick: _cache[1] || (_cache[1] = ($event) => $setup.historyOpen = !$setup.historyOpen)
          }, toDisplayString($setup.t("ai.history")), 1)
        ]),
            ...
            default: withCtx(() => [
              (openBlock(true), createElementBlock(Fragment, null, renderList($setup.normalizedModelOptions, (m) => {
                return openBlock(), createElementBlock("option", {
                  key: m.value,
                  value: m.value
                }, toDisplayString(m.label), 9, _hoisted_6);
              }), 128))
            ]),
            _: 1
    ...
    createBaseVNode("div", _hoisted_7, [
      ...
      }, toDisplayString($setup.streamStats.active ? $setup.t("ai.stream.active") : $setup.t("ai.stream.idle")), 3),
    ...
    createBaseVNode("div", {
      ...
      $setup.initStatus === "loading" ? (openBlock(), createElementBlock("div", _hoisted_8, toDisplayString($setup.t("ai.connecting")), 1)) : $setup.initStatus === "error" ? (openBlock(), createElementBlock("div", _hoisted_9, [
        createBaseVNode("div", null, toDisplayString($setup.tf("ai.connectFailed", { msg: $setup.initError })), 1),
        createBaseVNode("button", {
          class: "retry-btn",
          onClick: $setup.initAiSession
        }, toDisplayString($setup.t("ai.retryConnect")), 1)
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList($setup.messages, (msg) => {
          return openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", _hoisted_11, toDisplayString(msg.role === "user" ? "👤" : "🤖"), 1),
            createBaseVNode("div", _hoisted_12, [
              msg.file ? (openBlock(), createElementBlock("div", _hoisted_13, "📄 " + toDisplayString(msg.file.name), 1)) : createCommentVNode("", true),
              $setup.shouldUseThinkingWindow(msg) && (msg.thinking || msg.isStreaming) ? (openBlock(), createElementBlock("div", _hoisted_14, [
                createBaseVNode("div", _hoisted_15, [
                  createBaseVNode("span", _hoisted_16, toDisplayString($setup.modelDisplayName(msg.modelUsed)) + " " + toDisplayString($setup.t("ai.thinkingStream")), 1),
                  msg.isStreaming ? (openBlock(), createElementBlock("span", _hoisted_17, toDisplayString($setup.t("ai.thinkingStreaming")), 1)) : createCommentVNode("", true)
                ]),
                msg.thinking ? (openBlock(), createElementBlock("div", {
                  key: 0,
                  class: "thinking-content",
                  innerHTML: _ctx.renderMarkdown(msg.thinking)
                }, null, 8, _hoisted_18)) : (openBlock(), createElementBlock("div", _hoisted_19, toDisplayString($setup.t("ai.thinkingPlaceholder")), 1))
              ])) : msg.thinking ? (openBlock(), createElementBlock("div", _hoisted_20, [
                createBaseVNode("button", {
                  class: "thinking-toggle",
                  onClick: ($event) => msg.showThinking = !msg.showThinking
                }, toDisplayString($setup.t("ai.deepThinking")), 9, _hoisted_21),
              ...
              msg.progress && msg.isStreaming ? (openBlock(), createElementBlock("div", _hoisted_23, toDisplayString(msg.progress), 1)) : createCommentVNode("", true),
              msg.role === "assistant" && msg.isStreaming && !msg.content ? (openBlock(), createElementBlock("div", _hoisted_24, [
                _cache[8] || (_cache[8] = createBaseVNode("span", { class: "dot" }, null, -1)),
                _cache[9] || (_cache[9] = createBaseVNode("span", { class: "dot" }, null, -1)),
                _cache[10] || (_cache[10] = createBaseVNode("span", { class: "dot" }, null, -1)),
                createBaseVNode("span", _hoisted_25, toDisplayString($setup.t("ai.generating")), 1)
              ])) : createCommentVNode("", true),
              msg.role === "assistant" ? (openBlock(), createElementBlock("div", {
                key: 5,
                class: "text rich-text",
                innerHTML: $setup.renderMessage(msg)
              }, null, 8, _hoisted_26)) : (openBlock(), createElementBlock("div", {
                key: 6,
        ...
        $setup.showLoadingBubble ? (openBlock(), createElementBlock("div", _hoisted_28, [
          _cache[11] || (_cache[11] = createBaseVNode("div", { class: "avatar" }, "🤖", -1)),
          createBaseVNode("div", _hoisted_29, toDisplayString($setup.t("ai.thinking")), 1)
        ])) : createCommentVNode("", true)
      ]))
    ], 544),
    $setup.attachment ? (openBlock(), createElementBlock("div", _hoisted_30, [
    ...
    createBaseVNode("div", _hoisted_31, [
      ...
      withDirectives(createBaseVNode("input", {
        ...
        disabled: $setup.isLoading || $setup.initStatus !== "success",
        placeholder: $setup.t("ai.inputPlaceholder")
      }, null, 40, _hoisted_34), [
      ...
      }, toDisplayString($setup.t("ai.send")), 9, _hoisted_35)
    ], 512),
    ...
    createBaseVNode("div", {
      ...
      createBaseVNode("div", _hoisted_36, [
        createBaseVNode("h3", null, toDisplayString($setup.t("ai.historyTitle")), 1),
        createBaseVNode("button", {
          class: "history-close",
      ...
      }, toDisplayString($setup.t("ai.newChat")), 1),
      createBaseVNode("div", _hoisted_37, [
        (openBlock(true), createElementBlock(Fragment, null, renderList($setup.sessions, (s) => {
          return openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", _hoisted_39, toDisplayString(s.title || $setup.t("ai.default.title")), 1),
            createBaseVNode("div", _hoisted_40, toDisplayString($setup.formatSessionTime(s.updatedAt)), 1),
            s.preview ? (openBlock(), createElementBlock("div", _hoisted_41, toDisplayString(s.preview), 1)) : createCommentVNode("", true),
            createBaseVNode("button", {
              class: "history-delete",
              onClick: withModifiers(($event) => $setup.requestDeleteSession(s.id), ["stop"])
            }, toDisplayString($setup.t("ai.delete")), 9, _hoisted_42)
          ], 10, _hoisted_38);
        }), 128))
      ])
    ], 2),
    $setup.deleteConfirmVisible ? (openBlock(), createElementBlock("div", _hoisted_43, [
      createBaseVNode("div", _hoisted_44, [
        createBaseVNode("h4", null, toDisplayString($setup.t("ai.deleteTitle")), 1),
        createBaseVNode("p", null, toDisplayString($setup.t("ai.deleteText")), 1),
        $setup.deleteConfirmError ? (openBlock(), createElementBlock("div", _hoisted_45, toDisplayString($setup.deleteConfirmError), 1)) : createCommentVNode("", true),
        createBaseVNode("div", _hoisted_46, [
          createBaseVNode("button", {
            class: "confirm-cancel",
            disabled: $setup.deleteConfirmLoading,
            onClick: $setup.cancelDeleteSession
          }, toDisplayString($setup.t("common.cancel")), 9, _hoisted_47),
          createBaseVNode("button", {
            class: "confirm-danger",
            disabled: $setup.deleteConfirmLoading,
            onClick: $setup.deleteSessionConfirmed
          }, toDisplayString($setup.deleteConfirmLoading ? $setup.t("ai.deleting") : $setup.t("ai.deleteConfirm")), 9, _hoisted_48)
        ])
      ])
    ])) : createCommentVNode("", true)
  ], 2);
...
const AiChatView = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", render], ["__scopeId", "data-v-ca3cd419"]]);
export {
