import { r as ref, o as onMounted, l as onBeforeUnmount, v as watch, a as openBlock, c as createElementBlock, R as createStaticVNode, b as createBaseVNode, t as toDisplayString, F as Fragment, g as renderList, j as createBlock, k as withCtx, w as withModifiers, J as withDirectives, O as vModelCheckbox, d as createCommentVNode, p as createVNode, S as vModelSelect, n as normalizeClass, e as createTextVNode, u as unref, h as computed, C as nextTick } from "./vue-core-DWoFi2CM.js";
import { _ as _imports_0 } from "./app_icon-BoqTJkLh.js";
import { o as getRuntime, e as platformBridge, a as isTauriRuntime, E as isAndroidLike, u as isIOSLike, d as invokeNative } from "./runtime-bridge-BU9jeOXP.js";
import { _ as _export_sfc, c as cloneWorkspaceLayout, a2 as getLastNotifySnapshot, a3 as NOTIFY_SNAPSHOT_EVENT, a as useUiSettings, a4 as getNotificationMonitorSettings, h as buildDefaultWorkspaceLayout, e as flushUiSettings, a5 as runNotificationCheck, a6 as reconcileLocalReminders } from "./app-demo-Bca6_3ab.js";
import { f as fetchDormitoryDataset } from "./static_resource_cache-BcKPBR_J.js";
import { _ as _sfc_main$1, L as LayoutCollisionFxLayer, d as resolveLayoutSlotTarget, e as captureLayoutSlotAnchors, r as resolveRelativeCollisionPoint, c as createLayoutCollisionBurst, m as moveLayoutItemToIndex, a as resolveCollisionPalette, b as advanceLayoutCollisionFx } from "./layout_collision_fx-7Q3nAaTI.js";
...
const _hoisted_26 = { class: "sync-features-block" };
const _hoisted_27 = { class: "sync-feature-row" };
const _hoisted_28 = { class: "sync-feature-status" };
const _hoisted_29 = { class: "sync-feature-row" };
const _hoisted_30 = { class: "sync-feature-status" };
const _hoisted_31 = { class: "sync-feature-row" };
const _hoisted_32 = { class: "sync-feature-status" };
const _hoisted_33 = { class: "sync-feature-hint" };
const _hoisted_34 = { class: "action-buttons" };
const _hoisted_35 = ["disabled"];
const _hoisted_36 = ["disabled"];
const _hoisted_37 = { class: "recent-section" };
const _hoisted_38 = { class: "recent-header" };
const _hoisted_39 = { class: "recent-time" };
const _hoisted_40 = {
  key: 0,
  class: "notify-message-card unread"
};
const _hoisted_41 = { class: "notify-msg-left" };
const _hoisted_42 = { class: "notify-msg-body" };
const _hoisted_43 = { class: "notify-msg-head" };
const _hoisted_44 = { class: "notify-msg-time" };
const _hoisted_45 = { class: "notify-msg-text" };
const _hoisted_46 = {
  key: 0,
  class: "notify-detail-list"
};
const _hoisted_47 = { class: "detail-main" };
const _hoisted_48 = { class: "detail-sub" };
const _hoisted_49 = { class: "detail-score" };
const _hoisted_50 = {
  key: 1,
...
const _hoisted_57 = { class: "kv-item" };
const _hoisted_58 = {
  key: 2,
  class: "notify-message-card"
};
const _hoisted_59 = { class: "notify-msg-left" };
const _hoisted_60 = { class: "notify-msg-body" };
const _hoisted_61 = { class: "notify-msg-head" };
const _hoisted_62 = { class: "notify-msg-time" };
const _hoisted_63 = { class: "notify-msg-text" };
const _hoisted_64 = { class: "notify-detail-list" };
const _hoisted_65 = { class: "detail-main" };
const _hoisted_66 = {
  key: 0,
  class: "tag-urgent"
};
const _hoisted_67 = { class: "detail-sub" };
...
const _hoisted_72 = { class: "notify-msg-left" };
const _hoisted_73 = { class: "notify-msg-body" };
const _hoisted_74 = { class: "notify-msg-head" };
const _hoisted_75 = { class: "notify-msg-time" };
const _hoisted_76 = { class: "notify-msg-text" };
const _hoisted_77 = {
  key: 0,
...
const _hoisted_79 = { class: "notify-msg-left" };
const _hoisted_80 = { class: "notify-msg-body" };
const _hoisted_81 = { class: "notify-msg-head" };
const _hoisted_82 = { class: "notify-msg-time" };
const _hoisted_83 = { class: "notify-msg-text" };
const _hoisted_84 = {
  key: 0,
...
const _hoisted_87 = { class: "status-pill soft" };
const _hoisted_88 = {
  key: 0,
  class: "status-msg"
};
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        _cache[58] || (_cache[58] = createStaticVNode('<header class="dashboard-header" data-v-786ee4b5><div class="header-left" data-v-786ee4b5><img class="logo-img" src="' + _imports_0 + '" alt="HBUT" data-v-786ee4b5><span class="header-title" data-v-786ee4b5>Mini-HBUT</span></div><span class="header-pill" data-v-786ee4b5>通知</span></header>', 1)),
        createBaseVNode("main", _hoisted_2, [
          createBaseVNode("section", _hoisted_3, [
            createBaseVNode("div", _hoisted_4, [
              _cache[18] || (_cache[18] = createBaseVNode("div", { class: "permission-icon-circle" }, [
          ...
          createBaseVNode("section", _hoisted_8, [
            _cache[34] || (_cache[34] = createBaseVNode("h3", { class: "section-heading" }, "通知类型设置", -1)),
            createBaseVNode("div", {
                  ...
                  default: withCtx(() => [
                    card.key === "grades" ? (openBlock(), createElementBlock("div", _hoisted_9, [
                      createBaseVNode("div", _hoisted_10, [
                        _cache[20] || (_cache[20] = createBaseVNode("div", { class: "notify-type-icon icon-accent" }, [
                    ...
                    card.key === "exams" ? (openBlock(), createElementBlock("div", _hoisted_11, [
                      createBaseVNode("div", _hoisted_12, [
                        _cache[23] || (_cache[23] = createBaseVNode("div", { class: "notify-type-icon icon-orange" }, [
                      ...
                      _cache[24] || (_cache[24] = createBaseVNode("div", { class: "notify-type-body" }, [
                    ...
                    card.key === "electricity" ? (openBlock(), createElementBlock("div", _hoisted_13, [
                      createBaseVNode("div", _hoisted_14, [
                        _cache[26] || (_cache[26] = createBaseVNode("div", { class: "notify-type-icon icon-teal" }, [
                    ...
                    card.key === "class_reminder" ? (openBlock(), createElementBlock("div", _hoisted_15, [
                      createBaseVNode("div", _hoisted_16, [
                        _cache[29] || (_cache[29] = createBaseVNode("div", { class: "notify-type-icon icon-sky" }, [
                        ...
                        createBaseVNode("label", {
                          ...
                          _cache[28] || (_cache[28] = createBaseVNode("span", { class: "toggle-track" }, null, -1))
                        ])
                      ]),
                      createBaseVNode("div", _hoisted_17, [
                        _cache[30] || (_cache[30] = createBaseVNode("h4", { class: "notify-type-name" }, "上课提醒", -1)),
                    ...
                    card.key === "school_inbox" ? (openBlock(), createElementBlock("div", _hoisted_19, [
                      createBaseVNode("div", _hoisted_20, [
                        _cache[32] || (_cache[32] = createBaseVNode("div", { class: "notify-type-icon icon-indigo" }, [
                        ...
                        createBaseVNode("label", {
                          ...
                          _cache[31] || (_cache[31] = createBaseVNode("span", { class: "toggle-track" }, null, -1))
                        ])
                      ]),
                      _cache[33] || (_cache[33] = createBaseVNode("div", { class: "notify-type-body" }, [
          ...
          createBaseVNode("section", _hoisted_22, [
            createBaseVNode("div", _hoisted_23, [
              _cache[36] || (_cache[36] = createBaseVNode("div", { class: "sync-header-left" }, [
              ...
              createBaseVNode("label", _hoisted_24, [
                ...
                _cache[35] || (_cache[35] = createBaseVNode("span", { class: "toggle-track" }, null, -1))
              ])
            ]),
            createBaseVNode("div", _hoisted_25, [
              _cache[38] || (_cache[38] = createBaseVNode("span", { class: "sync-interval-label" }, "检查间隔", -1)),
            ...
            createBaseVNode("div", _hoisted_26, [
              createBaseVNode("div", _hoisted_27, [
                _cache[40] || (_cache[40] = createBaseVNode("span", { class: "sync-feature-label" }, "成绩变化检测", -1)),
                createBaseVNode("span", _hoisted_28, toDisplayString(bgNativeState.value ? bgFeatureGrades.value ? "开启" : "关闭" : ""), 1),
                createBaseVNode("label", {
                  class: "toggle-switch",
                  ...
                  withDirectives(createBaseVNode("input", {
                    type: "checkbox",
                    "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => bgFeatureGrades.value = $event),
                    onChange: handleBgFeatureChange
                  }, null, 544), [
                    [vModelCheckbox, bgFeatureGrades.value]
                  ]),
                  _cache[39] || (_cache[39] = createBaseVNode("span", { class: "toggle-track" }, null, -1))
                ])
              ]),
              createBaseVNode("div", _hoisted_29, [
                _cache[42] || (_cache[42] = createBaseVNode("span", { class: "sync-feature-label" }, "考试安排变化检测", -1)),
                createBaseVNode("span", _hoisted_30, toDisplayString(examsFeatureStatusText.value), 1),
                createBaseVNode("label", {
                  class: "toggle-switch",
                  ...
                  withDirectives(createBaseVNode("input", {
                    type: "checkbox",
                    "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => bgFeatureExams.value = $event),
                    onChange: handleBgFeatureChange
                  }, null, 544), [
                    [vModelCheckbox, bgFeatureExams.value]
                  ]),
                  _cache[41] || (_cache[41] = createBaseVNode("span", { class: "toggle-track" }, null, -1))
                ])
              ]),
              createBaseVNode("div", _hoisted_31, [
                _cache[44] || (_cache[44] = createBaseVNode("span", { class: "sync-feature-label" }, "学校消息检测", -1)),
                createBaseVNode("span", _hoisted_32, toDisplayString(schoolFeatureStatusText.value), 1),
                createBaseVNode("label", {
                  class: "toggle-switch",
                  ...
                  withDirectives(createBaseVNode("input", {
                    type: "checkbox",
                    "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => bgFeatureSchool.value = $event),
                    onChange: handleBgFeatureChange
                  }, null, 544), [
                    [vModelCheckbox, bgFeatureSchool.value]
                  ]),
                  _cache[43] || (_cache[43] = createBaseVNode("span", { class: "toggle-track" }, null, -1))
                ])
              ]),
              createBaseVNode("p", _hoisted_33, "后台检测状态：" + toDisplayString(bgFeatureStatusText.value), 1)
            ])
          ]),
          createBaseVNode("section", _hoisted_34, [
            ...
            }, toDisplayString(checking.value ? "检查中..." : "立即检查一次"), 9, _hoisted_35),
            createBaseVNode("button", {
              class: "action-btn secondary",
              disabled: sending.value,
              onClick: handleTestNotification
            }, toDisplayString(sending.value ? "发送中..." : "发送测试通知"), 9, _hoisted_36)
          ]),
          createBaseVNode("section", _hoisted_37, [
            createBaseVNode("div", _hoisted_38, [
              _cache[45] || (_cache[45] = createBaseVNode("h3", { class: "section-heading" }, "近期消息", -1)),
              createBaseVNode("span", _hoisted_39, toDisplayString(lastCheckText.value), 1)
            ]),
            gradeItems.value.length ? (openBlock(), createElementBlock("div", _hoisted_40, [
              createBaseVNode("div", _hoisted_41, [
                _cache[46] || (_cache[46] = createBaseVNode("div", { class: "notify-msg-icon icon-accent" }, [
                  createBaseVNode("span", { class: "material-symbols-outlined fill" }, "school")
                ], -1)),
                createBaseVNode("div", _hoisted_42, [
                  createBaseVNode("div", _hoisted_43, [
                    ...
                    createBaseVNode("span", _hoisted_44, toDisplayString(lastCheckText.value), 1)
                  ]),
                  createBaseVNode("p", _hoisted_45, "总成绩 " + toDisplayString(gradeSummary.value?.total || 0) + " 条 · 本次" + toDisplayString(gradeSummary.value?.changed ? "有变化" : "无变化"), 1),
                  gradeItems.value.length ? (openBlock(), createElementBlock("ul", _hoisted_46, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(gradeItems.value.slice(0, 3), (item, idx) => {
                      return openBlock(), createElementBlock("li", {
                        key: `grade-${idx}`,
                        class: "detail-row"
                      }, [
                        createBaseVNode("span", _hoisted_47, toDisplayString(item.course_name || "-"), 1),
                        createBaseVNode("span", _hoisted_48, [
                          createBaseVNode("span", null, toDisplayString(item.term || "未知学期"), 1),
                          createBaseVNode("span", _hoisted_49, toDisplayString(item.final_score || "-"), 1)
                        ])
                      ]);
                    }), 128))
                  ])) : createCommentVNode("", true)
            ...
            classSummary.value?.enabled ? (openBlock(), createElementBlock("div", _hoisted_50, [
              createBaseVNode("div", _hoisted_51, [
                _cache[49] || (_cache[49] = createBaseVNode("div", { class: "notify-msg-icon icon-sky" }, [
                  createBaseVNode("span", { class: "material-symbols-outlined fill" }, "schedule")
                ], -1)),
                createBaseVNode("div", _hoisted_52, [
                  createBaseVNode("div", _hoisted_53, [
                    _cache[47] || (_cache[47] = createBaseVNode("h4", { class: "notify-msg-title" }, "上课提醒", -1)),
                    createBaseVNode("span", _hoisted_54, toDisplayString(classReminderText.value), 1)
                  ]),
                  createBaseVNode("p", _hoisted_55, toDisplayString(nextClassText.value), 1),
                  classSummary.value?.nextCourse?.name ? (openBlock(), createElementBlock("div", _hoisted_56, [
                    createBaseVNode("span", _hoisted_57, [
                      _cache[48] || (_cache[48] = createBaseVNode("span", { class: "material-symbols-outlined mini-icon" }, "alarm", -1)),
            ...
            examItems.value.length ? (openBlock(), createElementBlock("div", _hoisted_58, [
              createBaseVNode("div", _hoisted_59, [
                _cache[51] || (_cache[51] = createBaseVNode("div", { class: "notify-msg-icon icon-orange" }, [
                  createBaseVNode("span", { class: "material-symbols-outlined fill" }, "edit_document")
                ], -1)),
                createBaseVNode("div", _hoisted_60, [
                  createBaseVNode("div", _hoisted_61, [
                    _cache[50] || (_cache[50] = createBaseVNode("h4", { class: "notify-msg-title" }, "考试安排", -1)),
                    createBaseVNode("span", _hoisted_62, toDisplayString(examSummary.value?.tomorrowCount ? "明日有考试" : ""), 1)
                  ]),
                  createBaseVNode("p", _hoisted_63, "近期 " + toDisplayString(examItems.value.length) + " 门 · 明日 " + toDisplayString(examSummary.value?.tomorrowCount || 0) + " 门", 1),
                  createBaseVNode("ul", _hoisted_64, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(examItems.value.slice(0, 3), (item, idx) => {
                      return openBlock(), createElementBlock("li", {
                        ...
                        createBaseVNode("span", _hoisted_65, [
                          ...
                          item.is_tomorrow ? (openBlock(), createElementBlock("small", _hoisted_66, "明日")) : createCommentVNode("", true)
                        ]),
                        createBaseVNode("span", _hoisted_67, [
                          item.exam_date ? (openBlock(), createElementBlock("span", _hoisted_68, toDisplayString(item.exam_date), 1)) : createCommentVNode("", true),
                          item.exam_time ? (openBlock(), createElementBlock("span", _hoisted_69, toDisplayString(formatNotifyExamTime(item.exam_time)), 1)) : createCommentVNode("", true),
                          item.location ? (openBlock(), createElementBlock("span", _hoisted_70, toDisplayString(item.location), 1)) : createCommentVNode("", true)
                        ])
                      ]);
                    }), 128))
                  ])
            ...
            schoolInboxSummary.value?.enabled ? (openBlock(), createElementBlock("div", _hoisted_71, [
              createBaseVNode("div", _hoisted_72, [
                _cache[52] || (_cache[52] = createBaseVNode("div", { class: "notify-msg-icon icon-indigo" }, [
                  createBaseVNode("span", { class: "material-symbols-outlined fill" }, "mail")
                ], -1)),
                createBaseVNode("div", _hoisted_73, [
                  createBaseVNode("div", _hoisted_74, [
                    ...
                    createBaseVNode("span", _hoisted_75, toDisplayString(lastCheckText.value), 1)
                  ]),
                  ...
                  schoolInboxSummary.value?.error ? (openBlock(), createElementBlock("p", _hoisted_77, toDisplayString(schoolInboxSummary.value.error), 1)) : createCommentVNode("", true)
                ])
              ])
            ])) : createCommentVNode("", true),
            powerSummary.value?.quantity != null ? (openBlock(), createElementBlock("div", _hoisted_78, [
              createBaseVNode("div", _hoisted_79, [
                _cache[54] || (_cache[54] = createBaseVNode("div", { class: "notify-msg-icon icon-teal" }, [
                  createBaseVNode("span", { class: "material-symbols-outlined fill" }, "bolt")
                ], -1)),
                createBaseVNode("div", _hoisted_80, [
                  createBaseVNode("div", _hoisted_81, [
                    _cache[53] || (_cache[53] = createBaseVNode("h4", { class: "notify-msg-title" }, "电费监控", -1)),
                    createBaseVNode("span", _hoisted_82, toDisplayString(powerStatusText.value), 1)
                  ]),
                  createBaseVNode("p", _hoisted_83, "剩余电量：" + toDisplayString(powerQuantityText.value), 1),
                  powerSummary.value?.isDual ? (openBlock(), createElementBlock("p", _hoisted_84, "空调电量：" + toDisplayString(acPowerQuantityText.value), 1)) : createCommentVNode("", true)
                ])
              ])
            ])) : createCommentVNode("", true),
            _cache[55] || (_cache[55] = createBaseVNode("div", { class: "notify-end-hint" }, "长按卡片进入管理模式", -1))
          ]),
          enableBackground.value ? (openBlock(), createElementBlock("div", _hoisted_85, [
            currentRuntime.value === "tauri" && !unref(isAndroidLike)() && !unref(isIOSLike)() ? (openBlock(), createElementBlock("span", _hoisted_86, "保活：" + toDisplayString(backgroundLockStatusText.value), 1)) : createCommentVNode("", true),
            createBaseVNode("span", _hoisted_87, "调度：" + toDisplayString(bgFeatureStatusText.value), 1)
          ])) : createCommentVNode("", true)
        ]),
        statusMessage.value ? (openBlock(), createElementBlock("p", _hoisted_88, toDisplayString(statusMessage.value), 1)) : createCommentVNode("", true),
        lastError.value ? (openBlock(), createElementBlock("p", _hoisted_89, "错误详情：" + toDisplayString(lastError.value), 1)) : createCommentVNode("", true),
        showBatteryPrompt.value ? (openBlock(), createElementBlock("div", _hoisted_90, [
          createBaseVNode("div", { class: "modal-card" }, [
            _cache[56] || (_cache[56] = createBaseVNode("h3", null, "电池优化提示", -1)),
            _cache[57] || (_cache[57] = createBaseVNode("p", null, "Android 建议将本应用加入后台白名单，避免系统回收后无法按时通知。", -1)),
...
const NotificationView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-786ee4b5"]]);
export {
