...
import { _ as __vitePreload, i as isTestAccountSession } from "./runtime-bridge-Dt57BD2i.js";
import { _ as _export_sfc, u as useLocale, a as useAuthStore, c as cloneWorkspaceLayout, b as useUiSettings, g as getCachedData, f as fetchWithCache, d as axiosInstance, D as DEFAULT_SWR_OPTIONS, s as setCachedData, e as decideHomeNavigate, h as flushUiSettings, i as buildDefaultWorkspaceLayout, r as readScheduleLockDetail, o as openExternal, j as showToast } from "./app-demo-CUOWTnz-.js";
...
import { _ as _sfc_main$2, L as LayoutCollisionFxLayer, r as resolveRelativeCollisionPoint, a as resolveCollisionPalette, c as createLayoutCollisionBurst, b as advanceLayoutCollisionFx, d as resolveLayoutSlotTarget, m as moveLayoutItemToIndex, e as captureLayoutSlotAnchors } from "./layout_collision_fx-BIrknfsm.js";
import { j as isModuleAllowed, k as filterAllowedModules } from "./more-modules-DaLSEgdg.js";
...
const _hoisted_52 = { class: "text-xs text-gray-500 mt-1 flex items-center" };
...
const _hoisted_61 = { class: "text-xs opacity-90 flex items-center" };
...
const _hoisted_70 = { class: "text-xs text-gray-500 mt-1 flex items-center" };
                ...
                course.endMinutes <= $setup.currentMinutePrecise ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                  ...
                  createBaseVNode("div", _hoisted_62, [
                    ...
                    createBaseVNode("button", {
                      ...
                      createTextVNode(toDisplayString($setup.t("home.today.goToClass")) + " ", 1),
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const fetchTodayCourses = async () => {
      ...
      try {
        ...
        todayCourses.value = [];
        homeSearchCourses.value = [];
        todayError.value = t("home.today.loadFailed");
      } finally {
        todayLoading.value = false;
      }
    };
    ...
    const fetchWeather = async (force = false) => {
      ...
      try {
        const { invokeNative } = await __vitePreload(async () => {
          const { invokeNative: invokeNative2 } = await import("./runtime-bridge-Dt57BD2i.js").then((n) => n.a7);
    ...
    }, API_BASE, LOGIN_METHOD_KEY, JWXT_MODULE_ALLOWLIST, loginMethod, isChaoxingMethod, HOME_LAYOUT_LONG_PRESS_MS, HOME_LAYOUT_LONG_PRESS_DISTANCE, refreshLoginMethod, todayCourses, homeSearchCourses, todayLoading, todayError, nowTick, get clockTimer() {
      return clockTimer;
    }, set clockTimer(v) {
      clockTimer = v;
    }, CLOCK_TICK_MS, periodTimeMap, toMinutes, currentMinute, greetingText, userCollegeInfo, currentMinutePrecise, currentTimeText, timelineCourses, todayBlockTitle, syncNowTick, handleVisibilityRefresh, getTodayWeekday, getCurrentWeek, getPreferredScheduleSemester, isVacationPreviousMeta, buildScheduleCacheKey, toPositiveInt: toPositiveInt2, normalizeWeeks: normalizeWeeks2, getCoursePeriodRange: getCoursePeriodRange2, getTodayCourseSignature, fetchCustomCoursesForToday, buildTodayCourses, fetchTodayCourses, baseModules, moduleLabel, moduleDesc, modules, homeWorkspaceRef, isHomeLayoutEditing, showAllModules, draftHomeWidgetsOrder, draftHomeModuleOrder, activeHomeDragSection, hoverLayoutKey, orderedModules, displayModules, homeWidgetOrder, isChaoxingLogin, homeCollisionFx, categoryLabel, moduleCategories, handleCategoryModuleClick, get homeLayoutLongPressTimer() {
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", render], ["__scopeId", "data-v-569530e5"]]);
export {
