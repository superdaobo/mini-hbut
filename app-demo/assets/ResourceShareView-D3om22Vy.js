import { _ as _export_sfc, m as useI18n, a7 as fetchRemoteConfig, p as tf, o as openExternal } from "./app-demo-DqAlnDLf.js";
import { s as detectRuntime, a as isTauriRuntime, i as isTestAccountSession, d as invokeNative } from "./runtime-bridge-i9KZPKjs.js";
import { _ as _sfc_main$1 } from "./TPageHeader.vue_vue_type_script_setup_true_lang-Dh0eXg1s.js";
import { a as openBlock, c as createElementBlock, p as createVNode, k as withCtx, b as createBaseVNode, t as toDisplayString, F as Fragment, f as renderList, n as normalizeClass, d as createCommentVNode, w as withModifiers, r as ref, o as onMounted, l as onBeforeUnmount, v as watch, Z as markRaw, _ as shallowRef, C as nextTick, h as computed } from "./vue-core-Dzs4fLAU.js";
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [
    createVNode($setup["TPageHeader"], {
      ...
      actions: withCtx(() => [
        ...
        }, toDisplayString($setup.t("resource.refresh")), 9, _hoisted_2)
      ]),
      _: 1
    }, 8, ["title"]),
    createBaseVNode("section", _hoisted_3, [
      ...
      }, toDisplayString($setup.t("resource.parent")), 9, _hoisted_4),
    ...
    createBaseVNode("section", _hoisted_7, [
      createBaseVNode("div", _hoisted_8, [
        createBaseVNode("span", _hoisted_9, toDisplayString($setup.tf("resource.totalCount", { n: $setup.totalCount })), 1),
      ...
      !$setup.items.length && !$setup.loadingList ? (openBlock(), createElementBlock("div", _hoisted_11, toDisplayString($setup.t("resource.emptyDir")), 1)) : createCommentVNode("", true),
    ...
    $setup.showPreview ? (openBlock(), createElementBlock("div", {
      ...
      createBaseVNode("div", _hoisted_19, [
        ...
        createBaseVNode("div", _hoisted_22, [
          ...
          }, toDisplayString($setup.isViewerFullscreen ? $setup.t("resource.exitFullscreen") : $setup.t("resource.enterFullscreen")), 1),
          createBaseVNode("button", {
            class: "action-btn primary",
            onClick: $setup.openDownload
          }, toDisplayString($setup.t("resource.download")), 1),
          createBaseVNode("button", {
            class: "action-btn",
            onClick: $setup.closePreview
          }, toDisplayString($setup.t("resource.close")), 1)
        ]),
        createBaseVNode("div", {
          ...
          }, toDisplayString($setup.t("resource.viewerExitFullscreen")), 1)) : createCommentVNode("", true),
          $setup.loadingPreview ? (openBlock(), createElementBlock("div", _hoisted_23, toDisplayString($setup.t("resource.previewLoading")), 1)) : $setup.previewKind === "video" || $setup.previewKind === "audio" ? (openBlock(), createElementBlock("div", {
            key: 2,
            ...
            createBaseVNode("div", _hoisted_28, [
              ...
              }, toDisplayString($setup.t("resource.pdf.prevPage")), 9, _hoisted_29),
              createBaseVNode("span", _hoisted_30, toDisplayString($setup.tf("resource.pdf.pageIndicator", { current: $setup.pdfCurrentPage, total: $setup.pdfPageCount })), 1),
              createBaseVNode("button", {
                class: "pdf-tool-btn",
                disabled: $setup.pdfCurrentPage >= $setup.pdfPageCount,
                onClick: $setup.nextPdfPage
              }, toDisplayString($setup.t("resource.pdf.nextPage")), 9, _hoisted_31),
              createBaseVNode("button", {
                class: "pdf-tool-btn",
                disabled: $setup.pdfZoom <= $setup.PDF_ZOOM_MIN + 1e-3,
                onClick: $setup.zoomOutPdf
              }, toDisplayString($setup.t("resource.pdf.zoomOut")), 9, _hoisted_32),
              createBaseVNode("button", {
                class: "pdf-page-chip",
              ...
              }, toDisplayString($setup.t("resource.pdf.zoomIn")), 9, _hoisted_33)
            ]),
            createBaseVNode("div", {
          ...
          }, null, 40, _hoisted_35)) : $setup.previewKind === "text" ? (openBlock(), createElementBlock("pre", _hoisted_36, toDisplayString($setup.previewText), 1)) : (openBlock(), createElementBlock("div", _hoisted_37, toDisplayString($setup.previewHint || $setup.t("resource.previewUnsupported")), 1))
        ], 2),
    ...
    $setup.loadingConfig || $setup.loadingList ? (openBlock(), createElementBlock("div", _hoisted_39, [
      createBaseVNode("div", _hoisted_40, [
        ...
        createBaseVNode("p", null, toDisplayString($setup.loadingConfig ? $setup.t("resource.configLoading") : $setup.t("resource.dirLoading")), 1)
      ])
    ])) : createCommentVNode("", true)
  ]);
}
    ...
    const preparePreview = async (item) => {
      ...
      try {
        ...
        if (ext === "pdf") {
          ...
          previewHint.value = runtimeIsCapacitor ? t("resource.hint.pdfMobileCompatible") : t("resource.hint.pdfChannelReady");
          return;
        }
...
const ResourceShareView = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", render], ["__scopeId", "data-v-b848326f"]]);
export {
