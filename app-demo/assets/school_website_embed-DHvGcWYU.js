...
import { s as detectRuntime, a as isTauriRuntime, _ as __vitePreload, b as isLikelyAndroidUserAgent, a1 as isLikelyIOSUserAgent, a2 as isTauriDesktopRuntime } from "./runtime-bridge-BDjl3Bnt.js";
  ...
  if (canUseTauriEmbeddedWebview()) {
    try {
      const { getCurrentWindow } = await __vitePreload(async () => {
        const { getCurrentWindow: getCurrentWindow2 } = await import("./runtime-bridge-BDjl3Bnt.js").then((n) => n.ac);
...
const forceCloseSchoolWebsiteEmbed = async () => {
  ...
  try {
    const { pushDebugLog } = await __vitePreload(async () => {
      const { pushDebugLog: pushDebugLog2 } = await import("./runtime-bridge-BDjl3Bnt.js").then((n) => n.a7);
...
const invokeNative = async (command, args) => {
  const core = await __vitePreload(() => import("./runtime-bridge-BDjl3Bnt.js").then((n) => n.aa), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
