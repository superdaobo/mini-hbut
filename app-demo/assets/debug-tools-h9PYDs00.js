...
import { p as pushDebugLog, a as isTauriRuntime, _ as __vitePreload, d as invokeNative } from "./runtime-bridge-Ds80RevU.js";
...
const initDebugBridgeClient = async () => {
  ...
  const eventApi = await __vitePreload(() => import("./runtime-bridge-Ds80RevU.js").then((n) => n.$), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
