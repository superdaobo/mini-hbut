        ...
        <section className="space-y-4">
            ...
            <div className="grid gap-3 md:grid-cols-2">
                {docsLinks.map(([to, title, desc]) => (
                    <Link key={to} className="rounded-xl border border-white/10 bg-white/[0.03] p-5 transition-colors hover:border-cyan/50" href={to}>
        ...
        <section className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
                {userDocsIndex.map(([file, to, description]) => (
                    <Link key={file} href={to} className="rounded-xl border border-white/10 bg-white/[0.03] p-5 transition-colors hover:border-cyan/50">
                ...
                {crossReadingMatrix.map(([scene, primary, secondary, description]) => (
                    <article key={scene} className="rounded-xl border border-white/10 bg-white/[0.03] p-5">
                        ...
                        <div className="mt-3 flex flex-wrap gap-2 text-sm">
                            <Link className="rounded-lg border border-cyan/25 px-3 py-1.5 text-cyan transition-colors hover:bg-cyan/10" href={primary}>
                                {primary}
                            </Link>
                            <Link className="rounded-lg border border-purple/25 px-3 py-1.5 text-purple-200 transition-colors hover:bg-purple/10" href={secondary}>
                                {secondary}
                            </Link>
                        </div>
                        <p className="mt-3 text-sm leading-7 text-gray-300">{description}</p>
