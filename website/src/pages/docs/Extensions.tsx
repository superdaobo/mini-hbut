...
const Extensions = () => (
    <div className="space-y-10">
        ...
        <section className="grid gap-4 md:grid-cols-2">
            <Link to="/docs/user-guide" className="rounded-lg border border-white/10 bg-white/[0.03] p-5 transition-colors hover:border-cyan/50">
            ...
            <Link to="/docs/module-system" className="rounded-lg border border-white/10 bg-white/[0.03] p-5 transition-colors hover:border-cyan/50">
