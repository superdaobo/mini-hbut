...
expectRepoPathsExist('ReferenceIndex', [
  ...
  'apps/client/src/components/Dashboard.vue',
  'apps/client/src/components/ScheduleView.vue',
  'apps/client/src/components/GradeView.vue',
  'apps/client/src/components/MoreView.vue',
  'apps/client/src/components/MoreModuleHostView.vue',
  'apps/client/src/components/SettingsView.vue',
  'apps/client/src/components/FeedbackView.vue',
  'apps/client/src/utils/api.ts',
  'apps/client/src/utils/cloud_sync.ts',
  'apps/client/src/utils/module_center.js',
  'apps/client/src/utils/more_modules.js',
  'apps/client/src/utils/notify_center.ts',
  'apps/client/src/platform/runtime.ts',
  'apps/client/src/platform/types.ts',
  'apps/client/src-tauri/src/lib.rs',
  'apps/client/src-tauri/src/http_client/mod.rs',
  'apps/client/src-tauri/src/db.rs',
  'apps/client/src-tauri/src/modules/module_bundle.rs',
  'scripts/build_website_modules.mjs',
  'apps/client/scripts/build_hot_bundle.mjs',
  'apps/client/scripts/check_dist_boundary.mjs',
  'scripts/guard_sensitive_uploads.mjs',
  'apps/client/scripts/test_more_module_bridge.mjs',
  'website/scripts/test-docs-ia.mjs',
  'website/scripts/test-docs-user-content.mjs',
  'website/scripts/test-docs-developer-content.mjs',
  'website/modules-src',
